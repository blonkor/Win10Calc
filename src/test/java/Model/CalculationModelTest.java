...
class CalculationModelTest {
    ...
    void subtractOperationTests() {
        //integers only
        {
            ...
            checkBinaryOperation(MIN_VALUE_ON_SCREEN_MINUS_ONE, HALF_MIN_VALUE_ON_SCREEN, SUBTRACT, "-5000000000000000");
            checkBinaryOperation(MIN_VALUE_ON_SCREEN_MINUS_ONE, NEG_HUNDRED, SUBTRACT, "-9999999999999900");
            checkBinaryOperation(MIN_VALUE_ON_SCREEN_MINUS_ONE, NEG_TEN, SUBTRACT, "-9999999999999990");
            ...
            checkBinaryOperation(MIN_VALUE_ON_SCREEN_MINUS_ONE, BigDecimal.TEN, SUBTRACT, "-10000000000000010");
            checkBinaryOperation(MIN_VALUE_ON_SCREEN_MINUS_ONE, HUNDRED, SUBTRACT, "-10000000000000100");
            checkBinaryOperation(MIN_VALUE_ON_SCREEN_MINUS_ONE, HALF_MAX_VALUE_ON_SCREEN, SUBTRACT, "-15000000000000000");
            ...
            checkBinaryOperation(MIN_VALUE_ON_SCREEN_MINUS_ONE, MAX_VALUE_ON_SCREEN_PLUS_ONE, SUBTRACT, "-20000000000000000");
            ...
            checkBinaryOperation(MIN_VALUE_ON_SCREEN, BigDecimal.ONE, SUBTRACT, "-10000000000000000");
            ...
            //first is -5000000000000000
            checkBinaryOperation(HALF_MIN_VALUE_ON_SCREEN, MIN_VALUE_ON_SCREEN_MINUS_ONE, SUBTRACT, "5000000000000000");
            ...
            checkBinaryOperation(HALF_MIN_VALUE_ON_SCREEN, NEG_HUNDRED, SUBTRACT, "-4999999999999900");
            checkBinaryOperation(HALF_MIN_VALUE_ON_SCREEN, NEG_TEN, SUBTRACT, "-4999999999999990");
            ...
            checkBinaryOperation(HALF_MIN_VALUE_ON_SCREEN, BigDecimal.TEN, SUBTRACT, "-5000000000000010");
            checkBinaryOperation(HALF_MIN_VALUE_ON_SCREEN, HUNDRED, SUBTRACT, "-5000000000000100");
            checkBinaryOperation(HALF_MIN_VALUE_ON_SCREEN, HALF_MAX_VALUE_ON_SCREEN, SUBTRACT, "-10000000000000000");
            ...
            checkBinaryOperation(HALF_MIN_VALUE_ON_SCREEN, MAX_VALUE_ON_SCREEN_PLUS_ONE, SUBTRACT, "-15000000000000000");

            //first is -100
            checkBinaryOperation(NEG_HUNDRED, MIN_VALUE_ON_SCREEN_MINUS_ONE, SUBTRACT, "9999999999999900");
            ...
            checkBinaryOperation(NEG_HUNDRED, HALF_MIN_VALUE_ON_SCREEN, SUBTRACT, "4999999999999900");
            checkBinaryOperation(NEG_HUNDRED, NEG_HUNDRED, SUBTRACT, "0");
            checkBinaryOperation(NEG_HUNDRED, NEG_TEN, SUBTRACT, "-90");
            ...
            checkBinaryOperation(NEG_HUNDRED, BigDecimal.TEN, SUBTRACT, "-110");
            checkBinaryOperation(NEG_HUNDRED, HUNDRED, SUBTRACT, "-200");
            checkBinaryOperation(NEG_HUNDRED, HALF_MAX_VALUE_ON_SCREEN, SUBTRACT, "-5000000000000100");
            ...
            checkBinaryOperation(NEG_HUNDRED, MAX_VALUE_ON_SCREEN_PLUS_ONE, SUBTRACT, "-10000000000000100");

            //first is -10
            checkBinaryOperation(NEG_TEN, MIN_VALUE_ON_SCREEN_MINUS_ONE, SUBTRACT, "9999999999999990");
            ...
            checkBinaryOperation(NEG_TEN, HALF_MIN_VALUE_ON_SCREEN, SUBTRACT, "4999999999999990");
            checkBinaryOperation(NEG_TEN, NEG_HUNDRED, SUBTRACT, "90");
            ...
            checkBinaryOperation(NEG_TEN, BigDecimal.TEN, SUBTRACT, "-20");
            checkBinaryOperation(NEG_TEN, HUNDRED, SUBTRACT, "-110");
            checkBinaryOperation(NEG_TEN, HALF_MAX_VALUE_ON_SCREEN, SUBTRACT, "-5000000000000010");
            ...
            checkBinaryOperation(NEG_TEN, MAX_VALUE_ON_SCREEN_PLUS_ONE, SUBTRACT, "-10000000000000010");
            ...
            checkBinaryOperation(NEG_ONE, MAX_VALUE_ON_SCREEN, SUBTRACT, "-10000000000000000");
            checkBinaryOperation(NEG_ONE, MAX_VALUE_ON_SCREEN_PLUS_ONE, SUBTRACT, "-10000000000000001");

            //first is 0
            checkBinaryOperation(BigDecimal.ZERO, MIN_VALUE_ON_SCREEN_MINUS_ONE, SUBTRACT, "10000000000000000");
            ...
            checkBinaryOperation(BigDecimal.ZERO, HALF_MIN_VALUE_ON_SCREEN, SUBTRACT, "5000000000000000");
            checkBinaryOperation(BigDecimal.ZERO, NEG_HUNDRED, SUBTRACT, "100");
            checkBinaryOperation(BigDecimal.ZERO, NEG_TEN, SUBTRACT, "10");
            ...
            checkBinaryOperation(BigDecimal.ONE, MIN_VALUE_ON_SCREEN, SUBTRACT, "10000000000000000");
            ...
            //first is 10
            checkBinaryOperation(BigDecimal.TEN, MIN_VALUE_ON_SCREEN_MINUS_ONE, SUBTRACT, "10000000000000010");
            ...
            checkBinaryOperation(BigDecimal.TEN, HALF_MIN_VALUE_ON_SCREEN, SUBTRACT, "5000000000000010");
            checkBinaryOperation(BigDecimal.TEN, NEG_HUNDRED, SUBTRACT, "110");
            checkBinaryOperation(BigDecimal.TEN, NEG_TEN, SUBTRACT, "20");
            checkBinaryOperation(BigDecimal.TEN, NEG_ONE, SUBTRACT, "11");

            checkBinaryOperation(BigDecimal.TEN, BigDecimal.ZERO, SUBTRACT, "10");
            ...
            checkBinaryOperation(BigDecimal.TEN, HUNDRED, SUBTRACT, "-90");
            checkBinaryOperation(BigDecimal.TEN, HALF_MAX_VALUE_ON_SCREEN, SUBTRACT, "-4999999999999990");
            ...
            checkBinaryOperation(BigDecimal.TEN, MAX_VALUE_ON_SCREEN_PLUS_ONE, SUBTRACT, "-9999999999999990");

            //first is 100
            checkBinaryOperation(HUNDRED, MIN_VALUE_ON_SCREEN_MINUS_ONE, SUBTRACT, "10000000000000100");
            ...
            checkBinaryOperation(HUNDRED, HALF_MIN_VALUE_ON_SCREEN, SUBTRACT, "5000000000000100");
            checkBinaryOperation(HUNDRED, NEG_HUNDRED, SUBTRACT, "200");
            checkBinaryOperation(HUNDRED, NEG_TEN, SUBTRACT, "110");
            checkBinaryOperation(HUNDRED, NEG_ONE, SUBTRACT, "101");

            checkBinaryOperation(HUNDRED, BigDecimal.ZERO, SUBTRACT, "100");

            checkBinaryOperation(HUNDRED, BigDecimal.ONE, SUBTRACT, "99");
            checkBinaryOperation(HUNDRED, BigDecimal.TEN, SUBTRACT, "90");
            checkBinaryOperation(HUNDRED, HUNDRED, SUBTRACT, "0");
            checkBinaryOperation(HUNDRED, HALF_MAX_VALUE_ON_SCREEN, SUBTRACT, "-4999999999999900");
            ...
            checkBinaryOperation(HUNDRED, MAX_VALUE_ON_SCREEN_PLUS_ONE, SUBTRACT, "-9999999999999900");

            //first is 5000000000000000
            checkBinaryOperation(HALF_MAX_VALUE_ON_SCREEN, MIN_VALUE_ON_SCREEN_MINUS_ONE, SUBTRACT, "15000000000000000");
            ...
            checkBinaryOperation(HALF_MAX_VALUE_ON_SCREEN, NEG_HUNDRED, SUBTRACT, "5000000000000100");
            checkBinaryOperation(HALF_MAX_VALUE_ON_SCREEN, NEG_TEN, SUBTRACT, "5000000000000010");
            checkBinaryOperation(HALF_MAX_VALUE_ON_SCREEN, NEG_ONE, SUBTRACT, "5000000000000001");

            checkBinaryOperation(HALF_MAX_VALUE_ON_SCREEN, BigDecimal.ZERO, SUBTRACT, "5000000000000000");

            checkBinaryOperation(HALF_MAX_VALUE_ON_SCREEN, BigDecimal.ONE, SUBTRACT, "4999999999999999");
            checkBinaryOperation(HALF_MAX_VALUE_ON_SCREEN, BigDecimal.TEN, SUBTRACT, "4999999999999990");
            checkBinaryOperation(HALF_MAX_VALUE_ON_SCREEN, HUNDRED, SUBTRACT, "4999999999999900");
            ...
            checkBinaryOperation(HALF_MAX_VALUE_ON_SCREEN, MAX_VALUE_ON_SCREEN_PLUS_ONE, SUBTRACT, "-5000000000000000");
            ...
            checkBinaryOperation(MAX_VALUE_ON_SCREEN, NEG_ONE, SUBTRACT, "10000000000000000");
            ...
            checkBinaryOperation(MAX_VALUE_ON_SCREEN_PLUS_ONE, HALF_MIN_VALUE_ON_SCREEN, SUBTRACT, "15000000000000000");
            checkBinaryOperation(MAX_VALUE_ON_SCREEN_PLUS_ONE, NEG_HUNDRED, SUBTRACT, "10000000000000100");
            checkBinaryOperation(MAX_VALUE_ON_SCREEN_PLUS_ONE, NEG_TEN, SUBTRACT, "10000000000000010");
            checkBinaryOperation(MAX_VALUE_ON_SCREEN_PLUS_ONE, NEG_ONE, SUBTRACT, "10000000000000001");

            checkBinaryOperation(MAX_VALUE_ON_SCREEN_PLUS_ONE, BigDecimal.ZERO, SUBTRACT, "10000000000000000");

            checkBinaryOperation(MAX_VALUE_ON_SCREEN_PLUS_ONE, BigDecimal.ONE, SUBTRACT, "9999999999999999");
            checkBinaryOperation(MAX_VALUE_ON_SCREEN_PLUS_ONE, BigDecimal.TEN, SUBTRACT, "9999999999999990");
            checkBinaryOperation(MAX_VALUE_ON_SCREEN_PLUS_ONE, HUNDRED, SUBTRACT, "9999999999999900");
            checkBinaryOperation(MAX_VALUE_ON_SCREEN_PLUS_ONE, HALF_MAX_VALUE_ON_SCREEN, SUBTRACT, "5000000000000000");
        ...
        {
            //first is -1.E+9999 (and vice versa)
            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9999, NEG_ZERO_DOT_17_NINES, SUBTRACT, "-100000000000000000.99999999999999999");
            checkBinaryOperation(NEG_ZERO_DOT_17_NINES, NEG_ONE_DOT_E_PLUS_9999, SUBTRACT, "-100000000000000000.99999999999999999");

            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9999, NEG_ZERO_DOT_16_NINES, SUBTRACT, "-100000000000000000.9999999999999999");
            checkBinaryOperation(NEG_ZERO_DOT_16_NINES, NEG_ONE_DOT_E_PLUS_9999, SUBTRACT, "-100000000000000000.9999999999999999");

            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9999, NEG_NINETY_NINE_HUNDREDTH, SUBTRACT, "-100000000000000000.99");
            checkBinaryOperation(NEG_NINETY_NINE_HUNDREDTH, NEG_ONE_DOT_E_PLUS_9999, SUBTRACT, "-100000000000000000.99");

            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9999, NEG_NINE_TENTH, SUBTRACT, "-100000000000000000.9");
            checkBinaryOperation(NEG_NINE_TENTH, NEG_ONE_DOT_E_PLUS_9999, SUBTRACT, "-100000000000000000.9");

            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9999, NEG_ONE_TENTH, SUBTRACT, "-100000000000000000.1");
            checkBinaryOperation(NEG_ONE_TENTH, NEG_ONE_DOT_E_PLUS_9999, SUBTRACT, "-100000000000000000.1");

            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9999, NEG_NINE_HUNDREDTH, SUBTRACT, "-100000000000000000.09");
            checkBinaryOperation(NEG_NINE_HUNDREDTH, NEG_ONE_DOT_E_PLUS_9999, SUBTRACT, "-100000000000000000.09");

            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9999, NEG_ONE_HUNDREDTH, SUBTRACT, "-100000000000000000.01");
            checkBinaryOperation(NEG_ONE_HUNDREDTH, NEG_ONE_DOT_E_PLUS_9999, SUBTRACT, "-100000000000000000.01");


            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9999, ONE_HUNDREDTH, SUBTRACT, "-99999999999999999.99");
            checkBinaryOperation(ONE_HUNDREDTH, NEG_ONE_DOT_E_PLUS_9999, SUBTRACT, "-99999999999999999.99");

            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9999, NINE_HUNDREDTH, SUBTRACT, "-99999999999999999.91");
            checkBinaryOperation(NINE_HUNDREDTH, NEG_ONE_DOT_E_PLUS_9999, SUBTRACT, "-99999999999999999.91");

            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9999, ONE_TENTH, SUBTRACT, "-99999999999999999.9");
            checkBinaryOperation(ONE_TENTH, NEG_ONE_DOT_E_PLUS_9999, SUBTRACT, "-99999999999999999.9");

            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9999, NINE_TENTH, SUBTRACT, "-99999999999999999.1");
            checkBinaryOperation(NINE_TENTH, NEG_ONE_DOT_E_PLUS_9999, SUBTRACT, "-99999999999999999.1");

            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9999, NINETY_NINE_HUNDREDTH, SUBTRACT, "-99999999999999999.01");
            checkBinaryOperation(NINETY_NINE_HUNDREDTH, NEG_ONE_DOT_E_PLUS_9999, SUBTRACT, "-99999999999999999.01");

            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9999, ZERO_DOT_16_NINES, SUBTRACT, "-99999999999999999.0000000000000001");
            checkBinaryOperation(ZERO_DOT_16_NINES, NEG_ONE_DOT_E_PLUS_9999, SUBTRACT, "-99999999999999999.0000000000000001");

            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9999, ZERO_DOT_17_NINES, SUBTRACT, "-99999999999999999.00000000000000001");
            checkBinaryOperation(ZERO_DOT_17_NINES, NEG_ONE_DOT_E_PLUS_9999, SUBTRACT, "-99999999999999999.00000000000000001");

            //first is -1.E+9998 (and vice versa)
            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9998, NEG_ZERO_DOT_17_NINES, SUBTRACT, "-10000000000000000.99999999999999999");
            checkBinaryOperation(NEG_ZERO_DOT_17_NINES, NEG_ONE_DOT_E_PLUS_9998, SUBTRACT, "-10000000000000000.99999999999999999");

            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9998, NEG_ZERO_DOT_16_NINES, SUBTRACT, "-10000000000000000.9999999999999999");
            checkBinaryOperation(NEG_ZERO_DOT_16_NINES, NEG_ONE_DOT_E_PLUS_9998, SUBTRACT, "-10000000000000000.9999999999999999");

            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9998, NEG_NINETY_NINE_HUNDREDTH, SUBTRACT, "-10000000000000000.99");
            checkBinaryOperation(NEG_NINETY_NINE_HUNDREDTH, NEG_ONE_DOT_E_PLUS_9998, SUBTRACT, "-10000000000000000.99");

            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9998, NEG_NINE_TENTH, SUBTRACT, "-10000000000000000.9");
            checkBinaryOperation(NEG_NINE_TENTH, NEG_ONE_DOT_E_PLUS_9998, SUBTRACT, "-10000000000000000.9");

            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9998, NEG_ONE_TENTH, SUBTRACT, "-10000000000000000.1");
            checkBinaryOperation(NEG_ONE_TENTH, NEG_ONE_DOT_E_PLUS_9998, SUBTRACT, "-10000000000000000.1");

            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9998, NEG_NINE_HUNDREDTH, SUBTRACT, "-10000000000000000.09");
            checkBinaryOperation(NEG_NINE_HUNDREDTH, NEG_ONE_DOT_E_PLUS_9998, SUBTRACT, "-10000000000000000.09");

            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9998, NEG_ONE_HUNDREDTH, SUBTRACT, "-10000000000000000.01");
            checkBinaryOperation(NEG_ONE_HUNDREDTH, NEG_ONE_DOT_E_PLUS_9998, SUBTRACT, "-10000000000000000.01");


            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9998, ONE_HUNDREDTH, SUBTRACT, "-9999999999999999.99");
            checkBinaryOperation(ONE_HUNDREDTH, NEG_ONE_DOT_E_PLUS_9998, SUBTRACT, "-9999999999999999.99");

            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9998, NINE_HUNDREDTH, SUBTRACT, "-9999999999999999.91");
            checkBinaryOperation(NINE_HUNDREDTH, NEG_ONE_DOT_E_PLUS_9998, SUBTRACT, "-9999999999999999.91");

            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9998, ONE_TENTH, SUBTRACT, "-9999999999999999.9");
            checkBinaryOperation(ONE_TENTH, NEG_ONE_DOT_E_PLUS_9998, SUBTRACT, "-9999999999999999.9");

            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9998, NINE_TENTH, SUBTRACT, "-9999999999999999.1");
            checkBinaryOperation(NINE_TENTH, NEG_ONE_DOT_E_PLUS_9998, SUBTRACT, "-9999999999999999.1");

            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9998, NINETY_NINE_HUNDREDTH, SUBTRACT, "-9999999999999999.01");
            checkBinaryOperation(NINETY_NINE_HUNDREDTH, NEG_ONE_DOT_E_PLUS_9998, SUBTRACT, "-9999999999999999.01");

            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9998, ZERO_DOT_16_NINES, SUBTRACT, "-9999999999999999.0000000000000001");
            checkBinaryOperation(ZERO_DOT_16_NINES, NEG_ONE_DOT_E_PLUS_9998, SUBTRACT, "-9999999999999999.0000000000000001");

            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9998, ZERO_DOT_17_NINES, SUBTRACT, "-9999999999999999.00000000000000001");
            checkBinaryOperation(ZERO_DOT_17_NINES, NEG_ONE_DOT_E_PLUS_9998, SUBTRACT, "-9999999999999999.00000000000000001");

            //first is 1.E+9998 (and vice versa)
            checkBinaryOperation(ONE_DOT_E_PLUS_9998, NEG_ZERO_DOT_17_NINES, SUBTRACT, "9999999999999999.00000000000000001");
            checkBinaryOperation(NEG_ZERO_DOT_17_NINES, ONE_DOT_E_PLUS_9998, SUBTRACT, "9999999999999999.00000000000000001");

            checkBinaryOperation(ONE_DOT_E_PLUS_9998, NEG_ZERO_DOT_16_NINES, SUBTRACT, "9999999999999999.0000000000000001");
            checkBinaryOperation(NEG_ZERO_DOT_16_NINES, ONE_DOT_E_PLUS_9998, SUBTRACT, "9999999999999999.0000000000000001");

            checkBinaryOperation(ONE_DOT_E_PLUS_9998, NEG_NINETY_NINE_HUNDREDTH, SUBTRACT, "9999999999999999.01");
            checkBinaryOperation(NEG_NINETY_NINE_HUNDREDTH, ONE_DOT_E_PLUS_9998, SUBTRACT, "9999999999999999.01");

            checkBinaryOperation(ONE_DOT_E_PLUS_9998, NEG_NINE_TENTH, SUBTRACT, "9999999999999999.1");
            checkBinaryOperation(NEG_NINE_TENTH, ONE_DOT_E_PLUS_9998, SUBTRACT, "9999999999999999.1");

            checkBinaryOperation(ONE_DOT_E_PLUS_9998, NEG_ONE_TENTH, SUBTRACT, "9999999999999999.9");
            checkBinaryOperation(NEG_ONE_TENTH, ONE_DOT_E_PLUS_9998, SUBTRACT, "9999999999999999.9");

            checkBinaryOperation(ONE_DOT_E_PLUS_9998, NEG_NINE_HUNDREDTH, SUBTRACT, "9999999999999999.91");
            checkBinaryOperation(NEG_NINE_HUNDREDTH, ONE_DOT_E_PLUS_9998, SUBTRACT, "9999999999999999.91");

            checkBinaryOperation(ONE_DOT_E_PLUS_9998, NEG_ONE_HUNDREDTH, SUBTRACT, "9999999999999999.99");
            checkBinaryOperation(NEG_ONE_HUNDREDTH, ONE_DOT_E_PLUS_9998, SUBTRACT, "9999999999999999.99");


            checkBinaryOperation(ONE_DOT_E_PLUS_9998, ONE_HUNDREDTH, SUBTRACT, "10000000000000000.01");
            checkBinaryOperation(ONE_HUNDREDTH, ONE_DOT_E_PLUS_9998, SUBTRACT, "10000000000000000.01");

            checkBinaryOperation(ONE_DOT_E_PLUS_9998, NINE_HUNDREDTH, SUBTRACT, "10000000000000000.09");
            checkBinaryOperation(NINE_HUNDREDTH, ONE_DOT_E_PLUS_9998, SUBTRACT, "10000000000000000.09");

            checkBinaryOperation(ONE_DOT_E_PLUS_9998, ONE_TENTH, SUBTRACT, "10000000000000000.1");
            checkBinaryOperation(ONE_TENTH, ONE_DOT_E_PLUS_9998, SUBTRACT, "10000000000000000.1");

            checkBinaryOperation(ONE_DOT_E_PLUS_9998, NINE_TENTH, SUBTRACT, "10000000000000000.9");
            checkBinaryOperation(NINE_TENTH, ONE_DOT_E_PLUS_9998, SUBTRACT, "10000000000000000.9");

            checkBinaryOperation(ONE_DOT_E_PLUS_9998, NINETY_NINE_HUNDREDTH, SUBTRACT, "10000000000000000.99");
            checkBinaryOperation(NINETY_NINE_HUNDREDTH, ONE_DOT_E_PLUS_9998, SUBTRACT, "10000000000000000.99");

            checkBinaryOperation(ONE_DOT_E_PLUS_9998, ZERO_DOT_16_NINES, SUBTRACT, "10000000000000000.9999999999999999");
            checkBinaryOperation(ZERO_DOT_16_NINES, ONE_DOT_E_PLUS_9998, SUBTRACT, "10000000000000000.9999999999999999");

            checkBinaryOperation(ONE_DOT_E_PLUS_9998, ZERO_DOT_17_NINES, SUBTRACT, "10000000000000000.99999999999999999");
            checkBinaryOperation(ZERO_DOT_17_NINES, ONE_DOT_E_PLUS_9998, SUBTRACT, "10000000000000000.99999999999999999");


            //first is 1.E+9999 (and vice versa)
            checkBinaryOperation(ONE_DOT_E_PLUS_9999, NEG_ZERO_DOT_17_NINES, SUBTRACT, "99999999999999999.00000000000000001");
            checkBinaryOperation(NEG_ZERO_DOT_17_NINES, ONE_DOT_E_PLUS_9999, SUBTRACT, "99999999999999999.00000000000000001");

            checkBinaryOperation(ONE_DOT_E_PLUS_9999, NEG_ZERO_DOT_16_NINES, SUBTRACT, "99999999999999999.0000000000000001");
            checkBinaryOperation(NEG_ZERO_DOT_16_NINES, ONE_DOT_E_PLUS_9999, SUBTRACT, "99999999999999999.0000000000000001");

            checkBinaryOperation(ONE_DOT_E_PLUS_9999, NEG_NINETY_NINE_HUNDREDTH, SUBTRACT, "99999999999999999.01");
            checkBinaryOperation(NEG_NINETY_NINE_HUNDREDTH, ONE_DOT_E_PLUS_9999, SUBTRACT, "99999999999999999.01");

            checkBinaryOperation(ONE_DOT_E_PLUS_9999, NEG_NINE_TENTH, SUBTRACT, "99999999999999999.1");
            checkBinaryOperation(NEG_NINE_TENTH, ONE_DOT_E_PLUS_9999, SUBTRACT, "99999999999999999.1");

            checkBinaryOperation(ONE_DOT_E_PLUS_9999, NEG_ONE_TENTH, SUBTRACT, "99999999999999999.9");
            checkBinaryOperation(NEG_ONE_TENTH, ONE_DOT_E_PLUS_9999, SUBTRACT, "99999999999999999.9");

            checkBinaryOperation(ONE_DOT_E_PLUS_9999, NEG_NINE_HUNDREDTH, SUBTRACT, "99999999999999999.91");
            checkBinaryOperation(NEG_NINE_HUNDREDTH, ONE_DOT_E_PLUS_9999, SUBTRACT, "99999999999999999.91");

            checkBinaryOperation(ONE_DOT_E_PLUS_9999, NEG_ONE_HUNDREDTH, SUBTRACT, "99999999999999999.99");
            checkBinaryOperation(NEG_ONE_HUNDREDTH, ONE_DOT_E_PLUS_9999, SUBTRACT, "99999999999999999.99");


            checkBinaryOperation(ONE_DOT_E_PLUS_9999, ONE_HUNDREDTH, SUBTRACT, "100000000000000000.01");
            checkBinaryOperation(ONE_HUNDREDTH, ONE_DOT_E_PLUS_9999, SUBTRACT, "100000000000000000.01");

            checkBinaryOperation(ONE_DOT_E_PLUS_9999, NINE_HUNDREDTH, SUBTRACT, "100000000000000000.09");
            checkBinaryOperation(NINE_HUNDREDTH, ONE_DOT_E_PLUS_9999, SUBTRACT, "100000000000000000.09");

            checkBinaryOperation(ONE_DOT_E_PLUS_9999, ONE_TENTH, SUBTRACT, "100000000000000000.1");
            checkBinaryOperation(ONE_TENTH, ONE_DOT_E_PLUS_9999, SUBTRACT, "100000000000000000.1");

            checkBinaryOperation(ONE_DOT_E_PLUS_9999, NINE_TENTH, SUBTRACT, "100000000000000000.9");
            checkBinaryOperation(NINE_TENTH, ONE_DOT_E_PLUS_9999, SUBTRACT, "100000000000000000.9");

            checkBinaryOperation(ONE_DOT_E_PLUS_9999, NINETY_NINE_HUNDREDTH, SUBTRACT, "100000000000000000.99");
            checkBinaryOperation(NINETY_NINE_HUNDREDTH, ONE_DOT_E_PLUS_9999, SUBTRACT, "100000000000000000.99");

            checkBinaryOperation(ONE_DOT_E_PLUS_9999, ZERO_DOT_16_NINES, SUBTRACT, "100000000000000000.9999999999999999");
            checkBinaryOperation(ZERO_DOT_16_NINES, ONE_DOT_E_PLUS_9999, SUBTRACT, "100000000000000000.9999999999999999");

            checkBinaryOperation(ONE_DOT_E_PLUS_9999, ZERO_DOT_17_NINES, SUBTRACT, "100000000000000000.99999999999999999");
            checkBinaryOperation(ZERO_DOT_17_NINES, ONE_DOT_E_PLUS_9999, SUBTRACT, "100000000000000000.99999999999999999");

            //first is -1.E-9999 (and vice versa)
            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9999, NEG_ZERO_DOT_17_NINES, SUBTRACT, "-1.00000000000000000");
            checkBinaryOperation(NEG_ZERO_DOT_17_NINES, NEG_ONE_DOT_E_MINUS_9999, SUBTRACT, "-1.00000000000000000");

            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9999, NEG_ZERO_DOT_16_NINES, SUBTRACT, "-0.99999999999999991");
            checkBinaryOperation(NEG_ZERO_DOT_16_NINES, NEG_ONE_DOT_E_MINUS_9999, SUBTRACT, "-0.99999999999999991");

            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9999, NEG_NINETY_NINE_HUNDREDTH, SUBTRACT, "-0.99000000000000001");
            checkBinaryOperation(NEG_NINETY_NINE_HUNDREDTH, NEG_ONE_DOT_E_MINUS_9999, SUBTRACT, "-0.99000000000000001");

            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9999, NEG_NINE_TENTH, SUBTRACT, "-0.90000000000000001");
            checkBinaryOperation(NEG_NINE_TENTH, NEG_ONE_DOT_E_MINUS_9999, SUBTRACT, "-0.90000000000000001");

            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9999, NEG_ONE_TENTH, SUBTRACT, "-0.10000000000000001");
            checkBinaryOperation(NEG_ONE_TENTH, NEG_ONE_DOT_E_MINUS_9999, SUBTRACT, "-0.10000000000000001");

            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9999, NEG_NINE_HUNDREDTH, SUBTRACT, "-0.09000000000000001");
            checkBinaryOperation(NEG_NINE_HUNDREDTH, NEG_ONE_DOT_E_MINUS_9999, SUBTRACT, "-0.09000000000000001");

            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9999, NEG_ONE_HUNDREDTH, SUBTRACT, "-0.01000000000000001");
            checkBinaryOperation(NEG_ONE_HUNDREDTH, NEG_ONE_DOT_E_MINUS_9999, SUBTRACT, "-0.01000000000000001");


            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9999, ONE_HUNDREDTH, SUBTRACT, "0.00999999999999999");
            checkBinaryOperation(ONE_HUNDREDTH, NEG_ONE_DOT_E_MINUS_9999, SUBTRACT, "0.00999999999999999");

            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9999, NINE_HUNDREDTH, SUBTRACT, "0.08999999999999999");
            checkBinaryOperation(NINE_HUNDREDTH, NEG_ONE_DOT_E_MINUS_9999, SUBTRACT, "0.08999999999999999");

            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9999, ONE_TENTH, SUBTRACT, "0.09999999999999999");
            checkBinaryOperation(ONE_TENTH, NEG_ONE_DOT_E_MINUS_9999, SUBTRACT, "0.09999999999999999");

            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9999, NINE_TENTH, SUBTRACT, "0.89999999999999999");
            checkBinaryOperation(NINE_TENTH, NEG_ONE_DOT_E_MINUS_9999, SUBTRACT, "0.89999999999999999");

            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9999, NINETY_NINE_HUNDREDTH, SUBTRACT, "0.98999999999999999");
            checkBinaryOperation(NINETY_NINE_HUNDREDTH, NEG_ONE_DOT_E_MINUS_9999, SUBTRACT, "0.98999999999999999");

            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9999, ZERO_DOT_16_NINES, SUBTRACT, "0.99999999999999989");
            checkBinaryOperation(ZERO_DOT_16_NINES, NEG_ONE_DOT_E_MINUS_9999, SUBTRACT, "0.99999999999999989");

            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9999, ZERO_DOT_17_NINES, SUBTRACT, "0.99999999999999998");
            checkBinaryOperation(ZERO_DOT_17_NINES, NEG_ONE_DOT_E_MINUS_9999, SUBTRACT, "0.99999999999999998");

            //first is -1.E-9998 (and vice versa)
            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9998, NEG_ZERO_DOT_17_NINES, SUBTRACT, "-1.00000000000000009");
            checkBinaryOperation(NEG_ZERO_DOT_17_NINES, NEG_ONE_DOT_E_MINUS_9998, SUBTRACT, "-1.00000000000000009");

            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9998, NEG_ZERO_DOT_16_NINES, SUBTRACT, "-1.0000000000000000");
            checkBinaryOperation(NEG_ZERO_DOT_16_NINES, NEG_ONE_DOT_E_MINUS_9998, SUBTRACT, "-1.0000000000000000");

            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9998, NEG_NINETY_NINE_HUNDREDTH, SUBTRACT, "-0.9900000000000001");
            checkBinaryOperation(NEG_NINETY_NINE_HUNDREDTH, NEG_ONE_DOT_E_MINUS_9998, SUBTRACT, "-0.9900000000000001");

            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9998, NEG_NINE_TENTH, SUBTRACT, "-0.9000000000000001");
            checkBinaryOperation(NEG_NINE_TENTH, NEG_ONE_DOT_E_MINUS_9998, SUBTRACT, "-0.9000000000000001");

            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9998, NEG_ONE_TENTH, SUBTRACT, "-0.1000000000000001");
            checkBinaryOperation(NEG_ONE_TENTH, NEG_ONE_DOT_E_MINUS_9998, SUBTRACT, "-0.1000000000000001");

            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9998, NEG_NINE_HUNDREDTH, SUBTRACT, "-0.0900000000000001");
            checkBinaryOperation(NEG_NINE_HUNDREDTH, NEG_ONE_DOT_E_MINUS_9998, SUBTRACT, "-0.0900000000000001");

            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9998, NEG_ONE_HUNDREDTH, SUBTRACT, "-0.0100000000000001");
            checkBinaryOperation(NEG_ONE_HUNDREDTH, NEG_ONE_DOT_E_MINUS_9998, SUBTRACT, "-0.0100000000000001");


            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9998, ONE_HUNDREDTH, SUBTRACT, "0.0099999999999999");
            checkBinaryOperation(ONE_HUNDREDTH, NEG_ONE_DOT_E_MINUS_9998, SUBTRACT, "0.0099999999999999");

            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9998, NINE_HUNDREDTH, SUBTRACT, "0.0899999999999999");
            checkBinaryOperation(NINE_HUNDREDTH, NEG_ONE_DOT_E_MINUS_9998, SUBTRACT, "0.0899999999999999");

            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9998, ONE_TENTH, SUBTRACT, "0.0999999999999999");
            checkBinaryOperation(ONE_TENTH, NEG_ONE_DOT_E_MINUS_9998, SUBTRACT, "0.0999999999999999");

            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9998, NINE_TENTH, SUBTRACT, "0.8999999999999999");
            checkBinaryOperation(NINE_TENTH, NEG_ONE_DOT_E_MINUS_9998, SUBTRACT, "0.8999999999999999");

            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9998, NINETY_NINE_HUNDREDTH, SUBTRACT, "0.9899999999999999");
            checkBinaryOperation(NINETY_NINE_HUNDREDTH, NEG_ONE_DOT_E_MINUS_9998, SUBTRACT, "0.9899999999999999");

            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9998, ZERO_DOT_16_NINES, SUBTRACT, "0.9999999999999998");
            checkBinaryOperation(ZERO_DOT_16_NINES, NEG_ONE_DOT_E_MINUS_9998, SUBTRACT, "0.9999999999999998");

            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9998, ZERO_DOT_17_NINES, SUBTRACT, "0.99999999999999989");
            checkBinaryOperation(ZERO_DOT_17_NINES, NEG_ONE_DOT_E_MINUS_9998, SUBTRACT, "0.99999999999999989");

            //first is 1.E-9998 (and vice versa)
            checkBinaryOperation(ONE_DOT_E_MINUS_9998, NEG_ZERO_DOT_17_NINES, SUBTRACT, "-0.99999999999999989");
            checkBinaryOperation(NEG_ZERO_DOT_17_NINES, ONE_DOT_E_MINUS_9998, SUBTRACT, "-0.99999999999999989");

            checkBinaryOperation(ONE_DOT_E_MINUS_9998, NEG_ZERO_DOT_16_NINES, SUBTRACT, "-0.9999999999999998");
            checkBinaryOperation(NEG_ZERO_DOT_16_NINES, ONE_DOT_E_MINUS_9998, SUBTRACT, "-0.9999999999999998");

            checkBinaryOperation(ONE_DOT_E_MINUS_9998, NEG_NINETY_NINE_HUNDREDTH, SUBTRACT, "-0.9899999999999999");
            checkBinaryOperation(NEG_NINETY_NINE_HUNDREDTH, ONE_DOT_E_MINUS_9998, SUBTRACT, "-0.9899999999999999");

            checkBinaryOperation(ONE_DOT_E_MINUS_9998, NEG_NINE_TENTH, SUBTRACT, "-0.8999999999999999");
            checkBinaryOperation(NEG_NINE_TENTH, ONE_DOT_E_MINUS_9998, SUBTRACT, "-0.8999999999999999");

            checkBinaryOperation(ONE_DOT_E_MINUS_9998, NEG_ONE_TENTH, SUBTRACT, "-0.0999999999999999");
            checkBinaryOperation(NEG_ONE_TENTH, ONE_DOT_E_MINUS_9998, SUBTRACT, "-0.0999999999999999");

            checkBinaryOperation(ONE_DOT_E_MINUS_9998, NEG_NINE_HUNDREDTH, SUBTRACT, "-0.0899999999999999");
            checkBinaryOperation(NEG_NINE_HUNDREDTH, ONE_DOT_E_MINUS_9998, SUBTRACT, "-0.0899999999999999");

            checkBinaryOperation(ONE_DOT_E_MINUS_9998, NEG_ONE_HUNDREDTH, SUBTRACT, "-0.0099999999999999");
            checkBinaryOperation(NEG_ONE_HUNDREDTH, ONE_DOT_E_MINUS_9998, SUBTRACT, "-0.0099999999999999");


            checkBinaryOperation(ONE_DOT_E_MINUS_9998, ONE_HUNDREDTH, SUBTRACT, "0.0100000000000001");
            checkBinaryOperation(ONE_HUNDREDTH, ONE_DOT_E_MINUS_9998, SUBTRACT, "0.0100000000000001");

            checkBinaryOperation(ONE_DOT_E_MINUS_9998, NINE_HUNDREDTH, SUBTRACT, "0.0900000000000001");
            checkBinaryOperation(NINE_HUNDREDTH, ONE_DOT_E_MINUS_9998, SUBTRACT, "0.0900000000000001");

            checkBinaryOperation(ONE_DOT_E_MINUS_9998, ONE_TENTH, SUBTRACT, "0.1000000000000001");
            checkBinaryOperation(ONE_TENTH, ONE_DOT_E_MINUS_9998, SUBTRACT, "0.1000000000000001");

            checkBinaryOperation(ONE_DOT_E_MINUS_9998, NINE_TENTH, SUBTRACT, "0.9000000000000001");
            checkBinaryOperation(NINE_TENTH, ONE_DOT_E_MINUS_9998, SUBTRACT, "0.9000000000000001");

            checkBinaryOperation(ONE_DOT_E_MINUS_9998, NINETY_NINE_HUNDREDTH, SUBTRACT, "0.9900000000000001");
            checkBinaryOperation(NINETY_NINE_HUNDREDTH, ONE_DOT_E_MINUS_9998, SUBTRACT, "0.9900000000000001");

            checkBinaryOperation(ONE_DOT_E_MINUS_9998, ZERO_DOT_16_NINES, SUBTRACT, "1.0000000000000000");
            checkBinaryOperation(ZERO_DOT_16_NINES, ONE_DOT_E_MINUS_9998, SUBTRACT, "1.0000000000000000");

            checkBinaryOperation(ONE_DOT_E_MINUS_9998, ZERO_DOT_17_NINES, SUBTRACT, "1.00000000000000009");
            checkBinaryOperation(ZERO_DOT_17_NINES, ONE_DOT_E_MINUS_9998, SUBTRACT, "1.00000000000000009");

            //first is 1.E-9999 (and vice versa)
            checkBinaryOperation(ONE_DOT_E_MINUS_9999, NEG_ZERO_DOT_17_NINES, SUBTRACT, "-0.99999999999999998");
            checkBinaryOperation(NEG_ZERO_DOT_17_NINES, ONE_DOT_E_MINUS_9999, SUBTRACT, "-0.99999999999999998");

            checkBinaryOperation(ONE_DOT_E_MINUS_9999, NEG_ZERO_DOT_16_NINES, SUBTRACT, "-0.99999999999999989");
            checkBinaryOperation(NEG_ZERO_DOT_16_NINES, ONE_DOT_E_MINUS_9999, SUBTRACT, "-0.99999999999999989");

            checkBinaryOperation(ONE_DOT_E_MINUS_9999, NEG_NINETY_NINE_HUNDREDTH, SUBTRACT, "-0.98999999999999999");
            checkBinaryOperation(NEG_NINETY_NINE_HUNDREDTH, ONE_DOT_E_MINUS_9999, SUBTRACT, "-0.98999999999999999");

            checkBinaryOperation(ONE_DOT_E_MINUS_9999, NEG_NINE_TENTH, SUBTRACT, "-0.89999999999999999");
            checkBinaryOperation(NEG_NINE_TENTH, ONE_DOT_E_MINUS_9999, SUBTRACT, "-0.89999999999999999");

            checkBinaryOperation(ONE_DOT_E_MINUS_9999, NEG_ONE_TENTH, SUBTRACT, "-0.09999999999999999");
            checkBinaryOperation(NEG_ONE_TENTH, ONE_DOT_E_MINUS_9999, SUBTRACT, "-0.09999999999999999");

            checkBinaryOperation(ONE_DOT_E_MINUS_9999, NEG_NINE_HUNDREDTH, SUBTRACT, "-0.08999999999999999");
            checkBinaryOperation(NEG_NINE_HUNDREDTH, ONE_DOT_E_MINUS_9999, SUBTRACT, "-0.08999999999999999");

            checkBinaryOperation(ONE_DOT_E_MINUS_9999, NEG_ONE_HUNDREDTH, SUBTRACT, "-0.00999999999999999");
            checkBinaryOperation(NEG_ONE_HUNDREDTH, ONE_DOT_E_MINUS_9999, SUBTRACT, "-0.00999999999999999");


            checkBinaryOperation(ONE_DOT_E_MINUS_9999, ONE_HUNDREDTH, SUBTRACT, "0.01000000000000001");
            checkBinaryOperation(ONE_HUNDREDTH, ONE_DOT_E_MINUS_9999, SUBTRACT, "0.01000000000000001");

            checkBinaryOperation(ONE_DOT_E_MINUS_9999, NINE_HUNDREDTH, SUBTRACT, "0.09000000000000001");
            checkBinaryOperation(NINE_HUNDREDTH, ONE_DOT_E_MINUS_9999, SUBTRACT, "0.09000000000000001");

            checkBinaryOperation(ONE_DOT_E_MINUS_9999, ONE_TENTH, SUBTRACT, "0.10000000000000001");
            checkBinaryOperation(ONE_TENTH, ONE_DOT_E_MINUS_9999, SUBTRACT, "0.10000000000000001");

            checkBinaryOperation(ONE_DOT_E_MINUS_9999, NINE_TENTH, SUBTRACT, "0.90000000000000001");
            checkBinaryOperation(NINE_TENTH, ONE_DOT_E_MINUS_9999, SUBTRACT, "0.90000000000000001");

            checkBinaryOperation(ONE_DOT_E_MINUS_9999, NINETY_NINE_HUNDREDTH, SUBTRACT, "0.99000000000000001");
            checkBinaryOperation(NINETY_NINE_HUNDREDTH, ONE_DOT_E_MINUS_9999, SUBTRACT, "0.99000000000000001");

            checkBinaryOperation(ONE_DOT_E_MINUS_9999, ZERO_DOT_16_NINES, SUBTRACT, "0.99999999999999991");
            checkBinaryOperation(ZERO_DOT_16_NINES, ONE_DOT_E_MINUS_9999, SUBTRACT, "0.99999999999999991");

            checkBinaryOperation(ONE_DOT_E_MINUS_9999, ZERO_DOT_17_NINES, SUBTRACT, "1.00000000000000000");
            checkBinaryOperation(ZERO_DOT_17_NINES, ONE_DOT_E_MINUS_9999, SUBTRACT, "1.00000000000000000");

            //first is -1.E+17 (and vice versa)
            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_17, NEG_ZERO_DOT_17_NINES, SUBTRACT, "-100000000000000000.99999999999999999");
            checkBinaryOperation(NEG_ZERO_DOT_17_NINES, NEG_ONE_DOT_E_PLUS_17, SUBTRACT, "-100000000000000000.99999999999999999");

            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_17, NEG_ZERO_DOT_16_NINES, SUBTRACT, "-100000000000000000.9999999999999999");
            checkBinaryOperation(NEG_ZERO_DOT_16_NINES, NEG_ONE_DOT_E_PLUS_17, SUBTRACT, "-100000000000000000.9999999999999999");

            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_17, NEG_NINETY_NINE_HUNDREDTH, SUBTRACT, "-100000000000000000.99");
            checkBinaryOperation(NEG_NINETY_NINE_HUNDREDTH, NEG_ONE_DOT_E_PLUS_17, SUBTRACT, "-100000000000000000.99");

            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_17, NEG_NINE_TENTH, SUBTRACT, "-100000000000000000.9");
            checkBinaryOperation(NEG_NINE_TENTH, NEG_ONE_DOT_E_PLUS_17, SUBTRACT, "-100000000000000000.9");

            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_17, NEG_ONE_TENTH, SUBTRACT, "-100000000000000000.1");
            checkBinaryOperation(NEG_ONE_TENTH, NEG_ONE_DOT_E_PLUS_17, SUBTRACT, "-100000000000000000.1");

            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_17, NEG_NINE_HUNDREDTH, SUBTRACT, "-100000000000000000.09");
            checkBinaryOperation(NEG_NINE_HUNDREDTH, NEG_ONE_DOT_E_PLUS_17, SUBTRACT, "-100000000000000000.09");

            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_17, NEG_ONE_HUNDREDTH, SUBTRACT, "-100000000000000000.01");
            checkBinaryOperation(NEG_ONE_HUNDREDTH, NEG_ONE_DOT_E_PLUS_17, SUBTRACT, "-100000000000000000.01");


            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_17, ONE_HUNDREDTH, SUBTRACT, "-99999999999999999.99");
            checkBinaryOperation(ONE_HUNDREDTH, NEG_ONE_DOT_E_PLUS_17, SUBTRACT, "-99999999999999999.99");

            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_17, NINE_HUNDREDTH, SUBTRACT, "-99999999999999999.91");
            checkBinaryOperation(NINE_HUNDREDTH, NEG_ONE_DOT_E_PLUS_17, SUBTRACT, "-99999999999999999.91");

            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_17, ONE_TENTH, SUBTRACT, "-99999999999999999.9");
            checkBinaryOperation(ONE_TENTH, NEG_ONE_DOT_E_PLUS_17, SUBTRACT, "-99999999999999999.9");

            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_17, NINE_TENTH, SUBTRACT, "-99999999999999999.1");
            checkBinaryOperation(NINE_TENTH, NEG_ONE_DOT_E_PLUS_17, SUBTRACT, "-99999999999999999.1");

            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_17, NINETY_NINE_HUNDREDTH, SUBTRACT, "-99999999999999999.01");
            checkBinaryOperation(NINETY_NINE_HUNDREDTH, NEG_ONE_DOT_E_PLUS_17, SUBTRACT, "-99999999999999999.01");

            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_17, ZERO_DOT_16_NINES, SUBTRACT, "-99999999999999999.0000000000000001");
            checkBinaryOperation(ZERO_DOT_16_NINES, NEG_ONE_DOT_E_PLUS_17, SUBTRACT, "-99999999999999999.0000000000000001");

            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_17, ZERO_DOT_17_NINES, SUBTRACT, "-99999999999999999.00000000000000001");
            checkBinaryOperation(ZERO_DOT_17_NINES, NEG_ONE_DOT_E_PLUS_17, SUBTRACT, "-99999999999999999.00000000000000001");

            //first is -1.E+16 (and vice versa)
            checkBinaryOperation(NEG_ZERO_DOT_17_NINES, NEG_ONE_DOT_E_PLUS_16, SUBTRACT, "-10000000000000000.99999999999999999");
            checkBinaryOperation(NEG_ZERO_DOT_17_NINES, NEG_ONE_DOT_E_PLUS_16, SUBTRACT, "-10000000000000000.99999999999999999");

            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_16, NEG_ZERO_DOT_16_NINES, SUBTRACT, "-10000000000000000.9999999999999999");
            checkBinaryOperation(NEG_ZERO_DOT_16_NINES, NEG_ONE_DOT_E_PLUS_16, SUBTRACT, "-10000000000000000.9999999999999999");

            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_16, NEG_NINETY_NINE_HUNDREDTH, SUBTRACT, "-10000000000000000.99");
            checkBinaryOperation(NEG_NINETY_NINE_HUNDREDTH, NEG_ONE_DOT_E_PLUS_16, SUBTRACT, "-10000000000000000.99");

            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_16, NEG_NINE_TENTH, SUBTRACT, "-10000000000000000.9");
            checkBinaryOperation(NEG_NINE_TENTH, NEG_ONE_DOT_E_PLUS_16, SUBTRACT, "-10000000000000000.9");

            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_16, NEG_ONE_TENTH, SUBTRACT, "-10000000000000000.1");
            checkBinaryOperation(NEG_ONE_TENTH, NEG_ONE_DOT_E_PLUS_16, SUBTRACT, "-10000000000000000.1");

            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_16, NEG_NINE_HUNDREDTH, SUBTRACT, "-10000000000000000.09");
            checkBinaryOperation(NEG_NINE_HUNDREDTH, NEG_ONE_DOT_E_PLUS_16, SUBTRACT, "-10000000000000000.09");

            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_16, NEG_ONE_HUNDREDTH, SUBTRACT, "-10000000000000000.01");
            checkBinaryOperation(NEG_ONE_HUNDREDTH, NEG_ONE_DOT_E_PLUS_16, SUBTRACT, "-10000000000000000.01");


            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_16, ONE_HUNDREDTH, SUBTRACT, "-9999999999999999.99");
            checkBinaryOperation(ONE_HUNDREDTH, NEG_ONE_DOT_E_PLUS_16, SUBTRACT, "-9999999999999999.99");

            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_16, NINE_HUNDREDTH, SUBTRACT, "-9999999999999999.91");
            checkBinaryOperation(NINE_HUNDREDTH, NEG_ONE_DOT_E_PLUS_16, SUBTRACT, "-9999999999999999.91");

            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_16, ONE_TENTH, SUBTRACT, "-9999999999999999.9");
            checkBinaryOperation(ONE_TENTH, NEG_ONE_DOT_E_PLUS_16, SUBTRACT, "-9999999999999999.9");

            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_16, NINE_TENTH, SUBTRACT, "-9999999999999999.1");
            checkBinaryOperation(NINE_TENTH, NEG_ONE_DOT_E_PLUS_16, SUBTRACT, "-9999999999999999.1");

            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_16, NINETY_NINE_HUNDREDTH, SUBTRACT, "-9999999999999999.01");
            checkBinaryOperation(NINETY_NINE_HUNDREDTH, NEG_ONE_DOT_E_PLUS_16, SUBTRACT, "-9999999999999999.01");

            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_16, ZERO_DOT_16_NINES, SUBTRACT, "-9999999999999999.0000000000000001");
            checkBinaryOperation(ZERO_DOT_16_NINES, NEG_ONE_DOT_E_PLUS_16, SUBTRACT, "-9999999999999999.0000000000000001");

            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_16, ZERO_DOT_17_NINES, SUBTRACT, "-9999999999999999.00000000000000001");
            checkBinaryOperation(ZERO_DOT_17_NINES, NEG_ONE_DOT_E_PLUS_16, SUBTRACT, "-9999999999999999.00000000000000001");

            //first is 1.E+16 (and vice versa)
            checkBinaryOperation(ONE_DOT_E_PLUS_16, NEG_ZERO_DOT_17_NINES, SUBTRACT, "9999999999999999.00000000000000001");
            checkBinaryOperation(NEG_ZERO_DOT_17_NINES, ONE_DOT_E_PLUS_16, SUBTRACT, "9999999999999999.00000000000000001");

            checkBinaryOperation(ONE_DOT_E_PLUS_16, NEG_ZERO_DOT_16_NINES, SUBTRACT, "9999999999999999.0000000000000001");
            checkBinaryOperation(NEG_ZERO_DOT_16_NINES, ONE_DOT_E_PLUS_16, SUBTRACT, "9999999999999999.0000000000000001");

            checkBinaryOperation(ONE_DOT_E_PLUS_16, NEG_NINETY_NINE_HUNDREDTH, SUBTRACT, "9999999999999999.01");
            checkBinaryOperation(NEG_NINETY_NINE_HUNDREDTH, ONE_DOT_E_PLUS_16, SUBTRACT, "9999999999999999.01");

            checkBinaryOperation(ONE_DOT_E_PLUS_16, NEG_NINE_TENTH, SUBTRACT, "9999999999999999.1");
            checkBinaryOperation(NEG_NINE_TENTH, ONE_DOT_E_PLUS_16, SUBTRACT, "9999999999999999.1");

            checkBinaryOperation(ONE_DOT_E_PLUS_16, NEG_ONE_TENTH, SUBTRACT, "9999999999999999.9");
            checkBinaryOperation(NEG_ONE_TENTH, ONE_DOT_E_PLUS_16, SUBTRACT, "9999999999999999.9");

            checkBinaryOperation(ONE_DOT_E_PLUS_16, NEG_NINE_HUNDREDTH, SUBTRACT, "9999999999999999.91");
            checkBinaryOperation(NEG_NINE_HUNDREDTH, ONE_DOT_E_PLUS_16, SUBTRACT, "9999999999999999.91");

            checkBinaryOperation(ONE_DOT_E_PLUS_16, NEG_ONE_HUNDREDTH, SUBTRACT, "9999999999999999.99");
            checkBinaryOperation(NEG_ONE_HUNDREDTH, ONE_DOT_E_PLUS_16, SUBTRACT, "9999999999999999.99");


            checkBinaryOperation(ONE_DOT_E_PLUS_16, ONE_HUNDREDTH, SUBTRACT, "10000000000000000.01");
            checkBinaryOperation(ONE_HUNDREDTH, ONE_DOT_E_PLUS_16, SUBTRACT, "10000000000000000.01");

            checkBinaryOperation(ONE_DOT_E_PLUS_16, NINE_HUNDREDTH, SUBTRACT, "10000000000000000.09");
            checkBinaryOperation(NINE_HUNDREDTH, ONE_DOT_E_PLUS_16, SUBTRACT, "10000000000000000.09");

            checkBinaryOperation(ONE_DOT_E_PLUS_16, ONE_TENTH, SUBTRACT, "10000000000000000.1");
            checkBinaryOperation(ONE_TENTH, ONE_DOT_E_PLUS_16, SUBTRACT, "10000000000000000.1");

            checkBinaryOperation(ONE_DOT_E_PLUS_16, NINE_TENTH, SUBTRACT, "10000000000000000.9");
            checkBinaryOperation(NINE_TENTH, ONE_DOT_E_PLUS_16, SUBTRACT, "10000000000000000.9");

            checkBinaryOperation(ONE_DOT_E_PLUS_16, NINETY_NINE_HUNDREDTH, SUBTRACT, "10000000000000000.99");
            checkBinaryOperation(NINETY_NINE_HUNDREDTH, ONE_DOT_E_PLUS_16, SUBTRACT, "10000000000000000.99");

            checkBinaryOperation(ONE_DOT_E_PLUS_16, ZERO_DOT_16_NINES, SUBTRACT, "10000000000000000.9999999999999999");
            checkBinaryOperation(ZERO_DOT_16_NINES, ONE_DOT_E_PLUS_16, SUBTRACT, "10000000000000000.9999999999999999");

            checkBinaryOperation(ONE_DOT_E_PLUS_16, ZERO_DOT_17_NINES, SUBTRACT, "10000000000000000.99999999999999999");
            checkBinaryOperation(ZERO_DOT_17_NINES, ONE_DOT_E_PLUS_16, SUBTRACT, "10000000000000000.99999999999999999");

            //first is 1.E+17 (and vice versa)
            checkBinaryOperation(ONE_DOT_E_PLUS_17, NEG_ZERO_DOT_17_NINES, SUBTRACT, "99999999999999999.00000000000000001");
            checkBinaryOperation(NEG_ZERO_DOT_17_NINES, ONE_DOT_E_PLUS_17, SUBTRACT, "99999999999999999.00000000000000001");

            checkBinaryOperation(ONE_DOT_E_PLUS_17, NEG_ZERO_DOT_16_NINES, SUBTRACT, "99999999999999999.0000000000000001");
            checkBinaryOperation(NEG_ZERO_DOT_16_NINES, ONE_DOT_E_PLUS_17, SUBTRACT, "99999999999999999.0000000000000001");

            checkBinaryOperation(ONE_DOT_E_PLUS_17, NEG_NINETY_NINE_HUNDREDTH, SUBTRACT, "99999999999999999.01");
            checkBinaryOperation(NEG_NINETY_NINE_HUNDREDTH, ONE_DOT_E_PLUS_17, SUBTRACT, "99999999999999999.01");

            checkBinaryOperation(ONE_DOT_E_PLUS_17, NEG_NINE_TENTH, SUBTRACT, "99999999999999999.1");
            checkBinaryOperation(NEG_NINE_TENTH, ONE_DOT_E_PLUS_17, SUBTRACT, "99999999999999999.1");

            checkBinaryOperation(ONE_DOT_E_PLUS_17, NEG_ONE_TENTH, SUBTRACT, "99999999999999999.9");
            checkBinaryOperation(NEG_ONE_TENTH, ONE_DOT_E_PLUS_17, SUBTRACT, "99999999999999999.9");

            checkBinaryOperation(ONE_DOT_E_PLUS_17, NEG_NINE_HUNDREDTH, SUBTRACT, "99999999999999999.91");
            checkBinaryOperation(NEG_NINE_HUNDREDTH, ONE_DOT_E_PLUS_17, SUBTRACT, "99999999999999999.91");

            checkBinaryOperation(ONE_DOT_E_PLUS_17, NEG_ONE_HUNDREDTH, SUBTRACT, "99999999999999999.99");
            checkBinaryOperation(NEG_ONE_HUNDREDTH, ONE_DOT_E_PLUS_17, SUBTRACT, "99999999999999999.99");


            checkBinaryOperation(ONE_DOT_E_PLUS_17, ONE_HUNDREDTH, SUBTRACT, "100000000000000000.01");
            checkBinaryOperation(ONE_HUNDREDTH, ONE_DOT_E_PLUS_17, SUBTRACT, "100000000000000000.01");

            checkBinaryOperation(ONE_DOT_E_PLUS_17, NINE_HUNDREDTH, SUBTRACT, "100000000000000000.09");
            checkBinaryOperation(NINE_HUNDREDTH, ONE_DOT_E_PLUS_17, SUBTRACT, "100000000000000000.09");

            checkBinaryOperation(ONE_DOT_E_PLUS_17, ONE_TENTH, SUBTRACT, "100000000000000000.1");
            checkBinaryOperation(ONE_TENTH, ONE_DOT_E_PLUS_17, SUBTRACT, "100000000000000000.1");

            checkBinaryOperation(ONE_DOT_E_PLUS_17, NINE_TENTH, SUBTRACT, "100000000000000000.9");
            checkBinaryOperation(NINE_TENTH, ONE_DOT_E_PLUS_17, SUBTRACT, "100000000000000000.9");

            checkBinaryOperation(ONE_DOT_E_PLUS_17, NINETY_NINE_HUNDREDTH, SUBTRACT, "100000000000000000.99");
            checkBinaryOperation(NINETY_NINE_HUNDREDTH, ONE_DOT_E_PLUS_17, SUBTRACT, "100000000000000000.99");

            checkBinaryOperation(ONE_DOT_E_PLUS_17, ZERO_DOT_16_NINES, SUBTRACT, "100000000000000000.9999999999999999");
            checkBinaryOperation(ZERO_DOT_16_NINES, ONE_DOT_E_PLUS_17, SUBTRACT, "100000000000000000.9999999999999999");

            checkBinaryOperation(ONE_DOT_E_PLUS_17, ZERO_DOT_17_NINES, SUBTRACT, "100000000000000000.99999999999999999");
            checkBinaryOperation(ZERO_DOT_17_NINES, ONE_DOT_E_PLUS_17, SUBTRACT, "100000000000000000.99999999999999999");

            //first is -1.E-17 (and vice versa)
            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_17, NEG_ZERO_DOT_17_NINES, SUBTRACT, "-1.00000000000000000");
            checkBinaryOperation(NEG_ZERO_DOT_17_NINES, NEG_ONE_DOT_E_MINUS_17, SUBTRACT, "-1.00000000000000000");

            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_17, NEG_ZERO_DOT_16_NINES, SUBTRACT, "-0.99999999999999991");
            checkBinaryOperation(NEG_ZERO_DOT_16_NINES, NEG_ONE_DOT_E_MINUS_17, SUBTRACT, "-0.99999999999999991");

            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_17, NEG_NINETY_NINE_HUNDREDTH, SUBTRACT, "-0.99000000000000001");
            checkBinaryOperation(NEG_NINETY_NINE_HUNDREDTH, NEG_ONE_DOT_E_MINUS_17, SUBTRACT, "-0.99000000000000001");

            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_17, NEG_NINE_TENTH, SUBTRACT, "-0.90000000000000001");
            checkBinaryOperation(NEG_NINE_TENTH, NEG_ONE_DOT_E_MINUS_17, SUBTRACT, "-0.90000000000000001");

            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_17, NEG_ONE_TENTH, SUBTRACT, "-0.10000000000000001");
            checkBinaryOperation(NEG_ONE_TENTH, NEG_ONE_DOT_E_MINUS_17, SUBTRACT, "-0.10000000000000001");

            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_17, NEG_NINE_HUNDREDTH, SUBTRACT, "-0.09000000000000001");
            checkBinaryOperation(NEG_NINE_HUNDREDTH, NEG_ONE_DOT_E_MINUS_17, SUBTRACT, "-0.09000000000000001");

            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_17, NEG_ONE_HUNDREDTH, SUBTRACT, "-0.01000000000000001");
            checkBinaryOperation(NEG_ONE_HUNDREDTH, NEG_ONE_DOT_E_MINUS_17, SUBTRACT, "-0.01000000000000001");


            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_17, ONE_HUNDREDTH, SUBTRACT, "0.00999999999999999");
            checkBinaryOperation(ONE_HUNDREDTH, NEG_ONE_DOT_E_MINUS_17, SUBTRACT, "0.00999999999999999");

            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_17, NINE_HUNDREDTH, SUBTRACT, "0.08999999999999999");
            checkBinaryOperation(NINE_HUNDREDTH, NEG_ONE_DOT_E_MINUS_17, SUBTRACT, "0.08999999999999999");

            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_17, ONE_TENTH, SUBTRACT, "0.09999999999999999");
            checkBinaryOperation(ONE_TENTH, NEG_ONE_DOT_E_MINUS_17, SUBTRACT, "0.09999999999999999");

            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_17, NINE_TENTH, SUBTRACT, "0.89999999999999999");
            checkBinaryOperation(NINE_TENTH, NEG_ONE_DOT_E_MINUS_17, SUBTRACT, "0.89999999999999999");

            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_17, NINETY_NINE_HUNDREDTH, SUBTRACT, "0.98999999999999999");
            checkBinaryOperation(NINETY_NINE_HUNDREDTH, NEG_ONE_DOT_E_MINUS_17, SUBTRACT, "0.98999999999999999");

            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_17, ZERO_DOT_16_NINES, SUBTRACT, "0.99999999999999989");
            checkBinaryOperation(ZERO_DOT_16_NINES, NEG_ONE_DOT_E_MINUS_17, SUBTRACT, "0.99999999999999989");

            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_17, ZERO_DOT_17_NINES, SUBTRACT, "0.99999999999999998");
            checkBinaryOperation(ZERO_DOT_17_NINES, NEG_ONE_DOT_E_MINUS_17, SUBTRACT, "0.99999999999999998");

            //first is -1.E-16 (and vice versa)
            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_16, NEG_ZERO_DOT_17_NINES, SUBTRACT, "-1.00000000000000009");
            checkBinaryOperation(NEG_ZERO_DOT_17_NINES, NEG_ONE_DOT_E_MINUS_16, SUBTRACT, "-1.00000000000000009");

            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_16, NEG_ZERO_DOT_16_NINES, SUBTRACT, "-1.0000000000000000");
            checkBinaryOperation(NEG_ZERO_DOT_16_NINES, NEG_ONE_DOT_E_MINUS_16, SUBTRACT, "-1.0000000000000000");

            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_16, NEG_NINETY_NINE_HUNDREDTH, SUBTRACT, "-0.9900000000000001");
            checkBinaryOperation(NEG_NINETY_NINE_HUNDREDTH, NEG_ONE_DOT_E_MINUS_16, SUBTRACT, "-0.9900000000000001");

            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_16, NEG_NINE_TENTH, SUBTRACT, "-0.9000000000000001");
            checkBinaryOperation(NEG_NINE_TENTH, NEG_ONE_DOT_E_MINUS_16, SUBTRACT, "-0.9000000000000001");

            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_16, NEG_ONE_TENTH, SUBTRACT, "-0.1000000000000001");
            checkBinaryOperation(NEG_ONE_TENTH, NEG_ONE_DOT_E_MINUS_16, SUBTRACT, "-0.1000000000000001");

            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_16, NEG_NINE_HUNDREDTH, SUBTRACT, "-0.0900000000000001");
            checkBinaryOperation(NEG_NINE_HUNDREDTH, NEG_ONE_DOT_E_MINUS_16, SUBTRACT, "-0.0900000000000001");

            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_16, NEG_ONE_HUNDREDTH, SUBTRACT, "-0.0100000000000001");
            checkBinaryOperation(NEG_ONE_HUNDREDTH, NEG_ONE_DOT_E_MINUS_16, SUBTRACT, "-0.0100000000000001");


            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_16, ONE_HUNDREDTH, SUBTRACT, "0.0099999999999999");
            checkBinaryOperation(ONE_HUNDREDTH, NEG_ONE_DOT_E_MINUS_16, SUBTRACT, "0.0099999999999999");

            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_16, NINE_HUNDREDTH, SUBTRACT, "0.0899999999999999");
            checkBinaryOperation(NINE_HUNDREDTH, NEG_ONE_DOT_E_MINUS_16, SUBTRACT, "0.0899999999999999");

            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_16, ONE_TENTH, SUBTRACT, "0.0999999999999999");
            checkBinaryOperation(ONE_TENTH, NEG_ONE_DOT_E_MINUS_16, SUBTRACT, "0.0999999999999999");

            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_16, NINE_TENTH, SUBTRACT, "0.8999999999999999");
            checkBinaryOperation(NINE_TENTH, NEG_ONE_DOT_E_MINUS_16, SUBTRACT, "0.8999999999999999");

            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_16, NINETY_NINE_HUNDREDTH, SUBTRACT, "0.9899999999999999");
            checkBinaryOperation(NINETY_NINE_HUNDREDTH, NEG_ONE_DOT_E_MINUS_16, SUBTRACT, "0.9899999999999999");

            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_16, ZERO_DOT_16_NINES, SUBTRACT, "0.9999999999999998");
            checkBinaryOperation(ZERO_DOT_16_NINES, NEG_ONE_DOT_E_MINUS_16, SUBTRACT, "0.9999999999999998");

            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_16, ZERO_DOT_17_NINES, SUBTRACT, "0.99999999999999989");
            checkBinaryOperation(ZERO_DOT_17_NINES, NEG_ONE_DOT_E_MINUS_16, SUBTRACT, "0.99999999999999989");

            //first is 1.E-16 (and vice versa)
            checkBinaryOperation(ONE_DOT_E_MINUS_16, NEG_ZERO_DOT_17_NINES, SUBTRACT, "-0.99999999999999989");
            checkBinaryOperation(NEG_ZERO_DOT_17_NINES, ONE_DOT_E_MINUS_16, SUBTRACT, "-0.99999999999999989");

            checkBinaryOperation(ONE_DOT_E_MINUS_16, NEG_ZERO_DOT_16_NINES, SUBTRACT, "-0.9999999999999998");
            checkBinaryOperation(NEG_ZERO_DOT_16_NINES, ONE_DOT_E_MINUS_16, SUBTRACT, "-0.9999999999999998");

            checkBinaryOperation(ONE_DOT_E_MINUS_16, NEG_NINETY_NINE_HUNDREDTH, SUBTRACT, "-0.9899999999999999");
            checkBinaryOperation(NEG_NINETY_NINE_HUNDREDTH, ONE_DOT_E_MINUS_16, SUBTRACT, "-0.9899999999999999");

            checkBinaryOperation(ONE_DOT_E_MINUS_16, NEG_NINE_TENTH, SUBTRACT, "-0.8999999999999999");
            checkBinaryOperation(NEG_NINE_TENTH, ONE_DOT_E_MINUS_16, SUBTRACT, "-0.8999999999999999");

            checkBinaryOperation(ONE_DOT_E_MINUS_16, NEG_ONE_TENTH, SUBTRACT, "-0.0999999999999999");
            checkBinaryOperation(NEG_ONE_TENTH, ONE_DOT_E_MINUS_16, SUBTRACT, "-0.0999999999999999");

            checkBinaryOperation(ONE_DOT_E_MINUS_16, NEG_NINE_HUNDREDTH, SUBTRACT, "-0.0899999999999999");
            checkBinaryOperation(NEG_NINE_HUNDREDTH, ONE_DOT_E_MINUS_16, SUBTRACT, "-0.0899999999999999");

            checkBinaryOperation(ONE_DOT_E_MINUS_16, NEG_ONE_HUNDREDTH, SUBTRACT, "-0.0099999999999999");
            checkBinaryOperation(NEG_ONE_HUNDREDTH, ONE_DOT_E_MINUS_16, SUBTRACT, "-0.0099999999999999");


            checkBinaryOperation(ONE_DOT_E_MINUS_16, ONE_HUNDREDTH, SUBTRACT, "0.0100000000000001");
            checkBinaryOperation(ONE_HUNDREDTH, ONE_DOT_E_MINUS_16, SUBTRACT, "0.0100000000000001");

            checkBinaryOperation(ONE_DOT_E_MINUS_16, NINE_HUNDREDTH, SUBTRACT, "0.0900000000000001");
            checkBinaryOperation(NINE_HUNDREDTH, ONE_DOT_E_MINUS_16, SUBTRACT, "0.0900000000000001");

            checkBinaryOperation(ONE_DOT_E_MINUS_16, ONE_TENTH, SUBTRACT, "0.1000000000000001");
            checkBinaryOperation(ONE_TENTH, ONE_DOT_E_MINUS_16, SUBTRACT, "0.1000000000000001");

            checkBinaryOperation(ONE_DOT_E_MINUS_16, NINE_TENTH, SUBTRACT, "0.9000000000000001");
            checkBinaryOperation(NINE_TENTH, ONE_DOT_E_MINUS_16, SUBTRACT, "0.9000000000000001");

            checkBinaryOperation(ONE_DOT_E_MINUS_16, NINETY_NINE_HUNDREDTH, SUBTRACT, "0.9900000000000001");
            checkBinaryOperation(NINETY_NINE_HUNDREDTH, ONE_DOT_E_MINUS_16, SUBTRACT, "0.9900000000000001");

            checkBinaryOperation(ONE_DOT_E_MINUS_16, ZERO_DOT_16_NINES, SUBTRACT, "1.0000000000000000");
            checkBinaryOperation(ZERO_DOT_16_NINES, ONE_DOT_E_MINUS_16, SUBTRACT, "1.0000000000000000");

            checkBinaryOperation(ONE_DOT_E_MINUS_16, ZERO_DOT_17_NINES, SUBTRACT, "1.00000000000000009");
            checkBinaryOperation(ZERO_DOT_17_NINES, ONE_DOT_E_MINUS_16, SUBTRACT, "1.00000000000000009");


            //first is 1.E-17 (and vice versa)
            checkBinaryOperation(ONE_DOT_E_MINUS_17, NEG_ZERO_DOT_17_NINES, SUBTRACT, "-0.99999999999999998");
            checkBinaryOperation(NEG_ZERO_DOT_17_NINES, ONE_DOT_E_MINUS_17, SUBTRACT, "-0.99999999999999998");

            checkBinaryOperation(ONE_DOT_E_MINUS_17, NEG_ZERO_DOT_16_NINES, SUBTRACT, "-0.99999999999999989");
            checkBinaryOperation(NEG_ZERO_DOT_16_NINES, ONE_DOT_E_MINUS_17, SUBTRACT, "-0.99999999999999989");

            checkBinaryOperation(ONE_DOT_E_MINUS_17, NEG_NINETY_NINE_HUNDREDTH, SUBTRACT, "-0.98999999999999999");
            checkBinaryOperation(NEG_NINETY_NINE_HUNDREDTH, ONE_DOT_E_MINUS_17, SUBTRACT, "-0.98999999999999999");

            checkBinaryOperation(ONE_DOT_E_MINUS_17, NEG_NINE_TENTH, SUBTRACT, "-0.89999999999999999");
            checkBinaryOperation(NEG_NINE_TENTH, ONE_DOT_E_MINUS_17, SUBTRACT, "-0.89999999999999999");

            checkBinaryOperation(ONE_DOT_E_MINUS_17, NEG_ONE_TENTH, SUBTRACT, "-0.09999999999999999");
            checkBinaryOperation(NEG_ONE_TENTH, ONE_DOT_E_MINUS_17, SUBTRACT, "-0.09999999999999999");

            checkBinaryOperation(ONE_DOT_E_MINUS_17, NEG_NINE_HUNDREDTH, SUBTRACT, "-0.08999999999999999");
            checkBinaryOperation(NEG_NINE_HUNDREDTH, ONE_DOT_E_MINUS_17, SUBTRACT, "-0.08999999999999999");

            checkBinaryOperation(ONE_DOT_E_MINUS_17, NEG_ONE_HUNDREDTH, SUBTRACT, "-0.00999999999999999");
            checkBinaryOperation(NEG_ONE_HUNDREDTH, ONE_DOT_E_MINUS_17, SUBTRACT, "-0.00999999999999999");


            checkBinaryOperation(ONE_DOT_E_MINUS_17, ONE_HUNDREDTH, SUBTRACT, "0.01000000000000001");
            checkBinaryOperation(ONE_HUNDREDTH, ONE_DOT_E_MINUS_17, SUBTRACT, "0.01000000000000001");

            checkBinaryOperation(ONE_DOT_E_MINUS_17, NINE_HUNDREDTH, SUBTRACT, "0.09000000000000001");
            checkBinaryOperation(NINE_HUNDREDTH, ONE_DOT_E_MINUS_17, SUBTRACT, "0.09000000000000001");

            checkBinaryOperation(ONE_DOT_E_MINUS_17, ONE_TENTH, SUBTRACT, "0.10000000000000001");
            checkBinaryOperation(ONE_TENTH, ONE_DOT_E_MINUS_17, SUBTRACT, "0.10000000000000001");

            checkBinaryOperation(ONE_DOT_E_MINUS_17, NINE_TENTH, SUBTRACT, "0.90000000000000001");
            checkBinaryOperation(NINE_TENTH, ONE_DOT_E_MINUS_17, SUBTRACT, "0.90000000000000001");

            checkBinaryOperation(ONE_DOT_E_MINUS_17, NINETY_NINE_HUNDREDTH, SUBTRACT, "0.99000000000000001");
            checkBinaryOperation(NINETY_NINE_HUNDREDTH, ONE_DOT_E_MINUS_17, SUBTRACT, "0.99000000000000001");

            checkBinaryOperation(ONE_DOT_E_MINUS_17, ZERO_DOT_16_NINES, SUBTRACT, "0.99999999999999991");
            checkBinaryOperation(ZERO_DOT_16_NINES, ONE_DOT_E_MINUS_17, SUBTRACT, "0.99999999999999991");

            checkBinaryOperation(ONE_DOT_E_MINUS_17, ZERO_DOT_17_NINES, SUBTRACT, "1.00000000000000000");
            checkBinaryOperation(ZERO_DOT_17_NINES, ONE_DOT_E_MINUS_17, SUBTRACT, "1.00000000000000000");
        }
...
//        {
//            //first is -10000000000000000
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_MINUS_ONE, MIN_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "-20000000000000000");
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_MINUS_ONE, MIN_VALUE_ON_SCREEN, DIVIDE, "-19999999999999999");
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_MINUS_ONE, MIN_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "-19999999999999998");
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_MINUS_ONE, HALF_MIN_VALUE_ON_SCREEN, DIVIDE, "-15000000000000000");
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_MINUS_ONE, NEG_HUNDRED, DIVIDE, "-10000000000000100");
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_MINUS_ONE, NEG_TEN, DIVIDE, "-10000000000000010");
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_MINUS_ONE, NEG_ONE, DIVIDE, "-10000000000000001");
//
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_MINUS_ONE, BigDecimal.ZERO, DIVIDE, "-10000000000000000");
//
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_MINUS_ONE, BigDecimal.ONE, DIVIDE, "-9999999999999999");
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_MINUS_ONE, BigDecimal.TEN, DIVIDE, "-9999999999999990");
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_MINUS_ONE, HUNDRED, DIVIDE, "-9999999999999900");
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_MINUS_ONE, HALF_MAX_VALUE_ON_SCREEN, DIVIDE, "-5000000000000000");
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_MINUS_ONE, MAX_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "-2");
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_MINUS_ONE, MAX_VALUE_ON_SCREEN, DIVIDE, "-1");
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_MINUS_ONE, MAX_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "0");
//
//            //first is -9999999999999999
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN, MIN_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "-20000000000000000");
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN, MIN_VALUE_ON_SCREEN, DIVIDE, "-19999999999999998");
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN, MIN_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "-19999999999999997");
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN, HALF_MIN_VALUE_ON_SCREEN, DIVIDE, "-14999999999999999");
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN, NEG_HUNDRED, DIVIDE, "-10000000000000099");
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN, NEG_TEN, DIVIDE, "-10000000000000009");
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN, NEG_ONE, DIVIDE, "-10000000000000000");
//
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN, BigDecimal.ZERO, DIVIDE, "-9999999999999999");
//
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN, BigDecimal.ONE, DIVIDE, "-9999999999999998");
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN, BigDecimal.TEN, DIVIDE, "-9999999999999989");
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN, HUNDRED, DIVIDE, "-9999999999999899");
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN, HALF_MAX_VALUE_ON_SCREEN, DIVIDE, "-4999999999999999");
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN, MAX_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "-1");
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN, MAX_VALUE_ON_SCREEN, DIVIDE, "0");
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN, MAX_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "1");
//
//            //first is -9999999999999998
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_PLUS_ONE, MIN_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "-20000000000000000");
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_PLUS_ONE, MIN_VALUE_ON_SCREEN, DIVIDE, "-19999999999999998");
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_PLUS_ONE, MIN_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "-19999999999999996");
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_PLUS_ONE, HALF_MIN_VALUE_ON_SCREEN, DIVIDE, "-14999999999999998");
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_PLUS_ONE, NEG_HUNDRED, DIVIDE, "-10000000000000098");
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_PLUS_ONE, NEG_TEN, DIVIDE, "-10000000000000008");
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_PLUS_ONE, NEG_ONE, DIVIDE, "-9999999999999999");
//
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_PLUS_ONE, BigDecimal.ZERO, DIVIDE, "-9999999999999998");
//
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_PLUS_ONE, BigDecimal.ONE, DIVIDE, "-9999999999999997");
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_PLUS_ONE, BigDecimal.TEN, DIVIDE, "-9999999999999988");
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_PLUS_ONE, HUNDRED, DIVIDE, "-9999999999999898");
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_PLUS_ONE, HALF_MAX_VALUE_ON_SCREEN, DIVIDE, "-4999999999999998");
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_PLUS_ONE, MAX_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "0");
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_PLUS_ONE, MAX_VALUE_ON_SCREEN, DIVIDE, "1");
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_PLUS_ONE, MAX_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "2");
//
//            //first is -5000000000000000
//            checkBinaryOperation(HALF_MIN_VALUE_ON_SCREEN, MIN_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "-20000000000000000");
//            checkBinaryOperation(HALF_MIN_VALUE_ON_SCREEN, MIN_VALUE_ON_SCREEN, DIVIDE, "-19999999999999998");
//            checkBinaryOperation(HALF_MIN_VALUE_ON_SCREEN, MIN_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "-19999999999999996");
//            checkBinaryOperation(HALF_MIN_VALUE_ON_SCREEN, HALF_MIN_VALUE_ON_SCREEN, DIVIDE, "-10000000000000000");
//            checkBinaryOperation(HALF_MIN_VALUE_ON_SCREEN, NEG_HUNDRED, DIVIDE, "-5000000000000100");
//            checkBinaryOperation(HALF_MIN_VALUE_ON_SCREEN, NEG_TEN, DIVIDE, "-5000000000000010");
//            checkBinaryOperation(HALF_MIN_VALUE_ON_SCREEN, NEG_ONE, DIVIDE, "-5000000000000001");
//
//            checkBinaryOperation(HALF_MIN_VALUE_ON_SCREEN, BigDecimal.ZERO, DIVIDE, "-5000000000000000");
//
//            checkBinaryOperation(HALF_MIN_VALUE_ON_SCREEN, BigDecimal.ONE, DIVIDE, "-4999999999999999");
//            checkBinaryOperation(HALF_MIN_VALUE_ON_SCREEN, BigDecimal.TEN, DIVIDE, "-4999999999999990");
//            checkBinaryOperation(HALF_MIN_VALUE_ON_SCREEN, HUNDRED, DIVIDE, "-4999999999999900");
//            checkBinaryOperation(HALF_MIN_VALUE_ON_SCREEN, HALF_MAX_VALUE_ON_SCREEN, DIVIDE, "0");
//            checkBinaryOperation(HALF_MIN_VALUE_ON_SCREEN, MAX_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "4999999999999998");
//            checkBinaryOperation(HALF_MIN_VALUE_ON_SCREEN, MAX_VALUE_ON_SCREEN, DIVIDE, "4999999999999999");
//            checkBinaryOperation(HALF_MIN_VALUE_ON_SCREEN, MAX_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "5000000000000000");
//
//            //first is -100
//            checkBinaryOperation(NEG_HUNDRED, MIN_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "-20000000000000000");
//            checkBinaryOperation(NEG_HUNDRED, MIN_VALUE_ON_SCREEN, DIVIDE, "-19999999999999998");
//            checkBinaryOperation(NEG_HUNDRED, MIN_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "-19999999999999996");
//            checkBinaryOperation(NEG_HUNDRED, HALF_MIN_VALUE_ON_SCREEN, DIVIDE, "-10000000000000000");
//            checkBinaryOperation(NEG_HUNDRED, NEG_HUNDRED, DIVIDE, "-200");
//            checkBinaryOperation(NEG_HUNDRED, NEG_TEN, DIVIDE, "-110");
//            checkBinaryOperation(NEG_HUNDRED, NEG_ONE, DIVIDE, "-101");
//
//            checkBinaryOperation(NEG_HUNDRED, BigDecimal.ZERO, DIVIDE, "-100");
//
//            checkBinaryOperation(NEG_HUNDRED, BigDecimal.ONE, DIVIDE, "-99");
//            checkBinaryOperation(NEG_HUNDRED, BigDecimal.TEN, DIVIDE, "-90");
//            checkBinaryOperation(NEG_HUNDRED, HUNDRED, DIVIDE, "0");
//            checkBinaryOperation(NEG_HUNDRED, HALF_MAX_VALUE_ON_SCREEN, DIVIDE, "4999999999999900");
//            checkBinaryOperation(NEG_HUNDRED, MAX_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "9999999999999898");
//            checkBinaryOperation(NEG_HUNDRED, MAX_VALUE_ON_SCREEN, DIVIDE, "9999999999999899");
//            checkBinaryOperation(NEG_HUNDRED, MAX_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "9999999999999900");
//
//            //first is -10
//            checkBinaryOperation(NEG_TEN, MIN_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "-20000000000000000");
//            checkBinaryOperation(NEG_TEN, MIN_VALUE_ON_SCREEN, DIVIDE, "-19999999999999998");
//            checkBinaryOperation(NEG_TEN, MIN_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "-19999999999999996");
//            checkBinaryOperation(NEG_TEN, HALF_MIN_VALUE_ON_SCREEN, DIVIDE, "-10000000000000000");
//            checkBinaryOperation(NEG_TEN, NEG_HUNDRED, DIVIDE, "-200");
//            checkBinaryOperation(NEG_TEN, NEG_TEN, DIVIDE, "-20");
//            checkBinaryOperation(NEG_TEN, NEG_ONE, DIVIDE, "-11");
//
//            checkBinaryOperation(NEG_TEN, BigDecimal.ZERO, DIVIDE, "-10");
//
//            checkBinaryOperation(NEG_TEN, BigDecimal.ONE, DIVIDE, "-9");
//            checkBinaryOperation(NEG_TEN, BigDecimal.TEN, DIVIDE, "0");
//            checkBinaryOperation(NEG_TEN, HUNDRED, DIVIDE, "90");
//            checkBinaryOperation(NEG_TEN, HALF_MAX_VALUE_ON_SCREEN, DIVIDE, "4999999999999990");
//            checkBinaryOperation(NEG_TEN, MAX_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "9999999999999988");
//            checkBinaryOperation(NEG_TEN, MAX_VALUE_ON_SCREEN, DIVIDE, "9999999999999989");
//            checkBinaryOperation(NEG_TEN, MAX_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "9999999999999990");
//
//            //first is -1
//            checkBinaryOperation(NEG_ONE, MIN_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "-20000000000000000");
//            checkBinaryOperation(NEG_ONE, MIN_VALUE_ON_SCREEN, DIVIDE, "-19999999999999998");
//            checkBinaryOperation(NEG_ONE, MIN_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "-19999999999999996");
//            checkBinaryOperation(NEG_ONE, HALF_MIN_VALUE_ON_SCREEN, DIVIDE, "-10000000000000000");
//            checkBinaryOperation(NEG_ONE, NEG_HUNDRED, DIVIDE, "-200");
//            checkBinaryOperation(NEG_ONE, NEG_TEN, DIVIDE, "-20");
//            checkBinaryOperation(NEG_ONE, NEG_ONE, DIVIDE, "-2");
//
//            checkBinaryOperation(NEG_ONE, BigDecimal.ZERO, DIVIDE, "-1");
//
//            checkBinaryOperation(NEG_ONE, BigDecimal.ONE, DIVIDE, "0");
//            checkBinaryOperation(NEG_ONE, BigDecimal.TEN, DIVIDE, "9");
//            checkBinaryOperation(NEG_ONE, HUNDRED, DIVIDE, "99");
//            checkBinaryOperation(NEG_ONE, HALF_MAX_VALUE_ON_SCREEN, DIVIDE, "4999999999999999");
//            checkBinaryOperation(NEG_ONE, MAX_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "9999999999999997");
//            checkBinaryOperation(NEG_ONE, MAX_VALUE_ON_SCREEN, DIVIDE, "9999999999999998");
//            checkBinaryOperation(NEG_ONE, MAX_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "9999999999999999");
//
//            //first is 0
//            checkBinaryOperation(BigDecimal.ZERO, MIN_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "-20000000000000000");
//            checkBinaryOperation(BigDecimal.ZERO, MIN_VALUE_ON_SCREEN, DIVIDE, "-19999999999999998");
//            checkBinaryOperation(BigDecimal.ZERO, MIN_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "-19999999999999996");
//            checkBinaryOperation(BigDecimal.ZERO, HALF_MIN_VALUE_ON_SCREEN, DIVIDE, "-10000000000000000");
//            checkBinaryOperation(BigDecimal.ZERO, NEG_HUNDRED, DIVIDE, "-200");
//            checkBinaryOperation(BigDecimal.ZERO, NEG_TEN, DIVIDE, "-20");
//            checkBinaryOperation(BigDecimal.ZERO, NEG_ONE, DIVIDE, "-2");
//
//            checkBinaryOperation(BigDecimal.ZERO, BigDecimal.ZERO, DIVIDE, "0");
//
//            checkBinaryOperation(BigDecimal.ZERO, BigDecimal.ONE, DIVIDE, "1");
//            checkBinaryOperation(BigDecimal.ZERO, BigDecimal.TEN, DIVIDE, "10");
//            checkBinaryOperation(BigDecimal.ZERO, HUNDRED, DIVIDE, "100");
//            checkBinaryOperation(BigDecimal.ZERO, HALF_MAX_VALUE_ON_SCREEN, DIVIDE, "5000000000000000");
//            checkBinaryOperation(BigDecimal.ZERO, MAX_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "9999999999999998");
//            checkBinaryOperation(BigDecimal.ZERO, MAX_VALUE_ON_SCREEN, DIVIDE, "9999999999999999");
//            checkBinaryOperation(BigDecimal.ZERO, MAX_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "10000000000000000");
//
//            //first is 1
//            checkBinaryOperation(BigDecimal.ONE, MIN_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "-20000000000000000");
//            checkBinaryOperation(BigDecimal.ONE, MIN_VALUE_ON_SCREEN, DIVIDE, "-19999999999999998");
//            checkBinaryOperation(BigDecimal.ONE, MIN_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "-19999999999999996");
//            checkBinaryOperation(BigDecimal.ONE, HALF_MIN_VALUE_ON_SCREEN, DIVIDE, "-10000000000000000");
//            checkBinaryOperation(BigDecimal.ONE, NEG_HUNDRED, DIVIDE, "-200");
//            checkBinaryOperation(BigDecimal.ONE, NEG_TEN, DIVIDE, "-20");
//            checkBinaryOperation(BigDecimal.ONE, NEG_ONE, DIVIDE, "-2");
//
//            checkBinaryOperation(BigDecimal.ONE, BigDecimal.ZERO, DIVIDE, "0");
//
//            checkBinaryOperation(BigDecimal.ONE, BigDecimal.ONE, DIVIDE, "2");
//            checkBinaryOperation(BigDecimal.ONE, BigDecimal.TEN, DIVIDE, "11");
//            checkBinaryOperation(BigDecimal.ONE, HUNDRED, DIVIDE, "101");
//            checkBinaryOperation(BigDecimal.ONE, HALF_MAX_VALUE_ON_SCREEN, DIVIDE, "5000000000000001");
//            checkBinaryOperation(BigDecimal.ONE, MAX_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "9999999999999999");
//            checkBinaryOperation(BigDecimal.ONE, MAX_VALUE_ON_SCREEN, DIVIDE, "10000000000000000");
//            checkBinaryOperation(BigDecimal.ONE, MAX_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "10000000000000001");
//
//            //first is 10
//            checkBinaryOperation(BigDecimal.TEN, MIN_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "-20000000000000000");
//            checkBinaryOperation(BigDecimal.TEN, MIN_VALUE_ON_SCREEN, DIVIDE, "-19999999999999998");
//            checkBinaryOperation(BigDecimal.TEN, MIN_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "-19999999999999996");
//            checkBinaryOperation(BigDecimal.TEN, HALF_MIN_VALUE_ON_SCREEN, DIVIDE, "-10000000000000000");
//            checkBinaryOperation(BigDecimal.TEN, NEG_HUNDRED, DIVIDE, "-200");
//            checkBinaryOperation(BigDecimal.TEN, NEG_TEN, DIVIDE, "-20");
//            checkBinaryOperation(BigDecimal.TEN, NEG_ONE, DIVIDE, "-2");
//
//            checkBinaryOperation(BigDecimal.TEN, BigDecimal.ZERO, DIVIDE, "0");
//
//            checkBinaryOperation(BigDecimal.TEN, BigDecimal.ONE, DIVIDE, "2");
//            checkBinaryOperation(BigDecimal.TEN, BigDecimal.TEN, DIVIDE, "20");
//            checkBinaryOperation(BigDecimal.TEN, HUNDRED, DIVIDE, "110");
//            checkBinaryOperation(BigDecimal.TEN, HALF_MAX_VALUE_ON_SCREEN, DIVIDE, "5000000000000010");
//            checkBinaryOperation(BigDecimal.TEN, MAX_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "10000000000000008");
//            checkBinaryOperation(BigDecimal.TEN, MAX_VALUE_ON_SCREEN, DIVIDE, "10000000000000009");
//            checkBinaryOperation(BigDecimal.TEN, MAX_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "10000000000000010");
//
//            //first is 100
//            checkBinaryOperation(HUNDRED, MIN_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "-20000000000000000");
//            checkBinaryOperation(HUNDRED, MIN_VALUE_ON_SCREEN, DIVIDE, "-19999999999999998");
//            checkBinaryOperation(HUNDRED, MIN_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "-19999999999999996");
//            checkBinaryOperation(HUNDRED, HALF_MIN_VALUE_ON_SCREEN, DIVIDE, "-10000000000000000");
//            checkBinaryOperation(HUNDRED, NEG_HUNDRED, DIVIDE, "-200");
//            checkBinaryOperation(HUNDRED, NEG_TEN, DIVIDE, "-20");
//            checkBinaryOperation(HUNDRED, NEG_ONE, DIVIDE, "-2");
//
//            checkBinaryOperation(HUNDRED, BigDecimal.ZERO, DIVIDE, "0");
//
//            checkBinaryOperation(HUNDRED, BigDecimal.ONE, DIVIDE, "2");
//            checkBinaryOperation(HUNDRED, BigDecimal.TEN, DIVIDE, "20");
//            checkBinaryOperation(HUNDRED, HUNDRED, DIVIDE, "200");
//            checkBinaryOperation(HUNDRED, HALF_MAX_VALUE_ON_SCREEN, DIVIDE, "5000000000000100");
//            checkBinaryOperation(HUNDRED, MAX_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "10000000000000098");
//            checkBinaryOperation(HUNDRED, MAX_VALUE_ON_SCREEN, DIVIDE, "10000000000000099");
//            checkBinaryOperation(HUNDRED, MAX_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "10000000000000100");
//
//            //first is 5000000000000000
//            checkBinaryOperation(HALF_MAX_VALUE_ON_SCREEN, MIN_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "-20000000000000000");
//            checkBinaryOperation(HALF_MAX_VALUE_ON_SCREEN, MIN_VALUE_ON_SCREEN, DIVIDE, "-19999999999999998");
//            checkBinaryOperation(HALF_MAX_VALUE_ON_SCREEN, MIN_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "-19999999999999996");
//            checkBinaryOperation(HALF_MAX_VALUE_ON_SCREEN, HALF_MIN_VALUE_ON_SCREEN, DIVIDE, "-10000000000000000");
//            checkBinaryOperation(HALF_MAX_VALUE_ON_SCREEN, NEG_HUNDRED, DIVIDE, "-200");
//            checkBinaryOperation(HALF_MAX_VALUE_ON_SCREEN, NEG_TEN, DIVIDE, "-20");
//            checkBinaryOperation(HALF_MAX_VALUE_ON_SCREEN, NEG_ONE, DIVIDE, "-2");
//
//            checkBinaryOperation(HALF_MAX_VALUE_ON_SCREEN, BigDecimal.ZERO, DIVIDE, "0");
//
//            checkBinaryOperation(HALF_MAX_VALUE_ON_SCREEN, BigDecimal.ONE, DIVIDE, "2");
//            checkBinaryOperation(HALF_MAX_VALUE_ON_SCREEN, BigDecimal.TEN, DIVIDE, "20");
//            checkBinaryOperation(HALF_MAX_VALUE_ON_SCREEN, HUNDRED, DIVIDE, "200");
//            checkBinaryOperation(HALF_MAX_VALUE_ON_SCREEN, HALF_MAX_VALUE_ON_SCREEN, DIVIDE, "10000000000000000");
//            checkBinaryOperation(HALF_MAX_VALUE_ON_SCREEN, MAX_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "14999999999999998");
//            checkBinaryOperation(HALF_MAX_VALUE_ON_SCREEN, MAX_VALUE_ON_SCREEN, DIVIDE, "14999999999999999");
//            checkBinaryOperation(HALF_MAX_VALUE_ON_SCREEN, MAX_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "15000000000000000");
//
//            //first is 9999999999999998
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_MINUS_ONE, MIN_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "-20000000000000000");
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_MINUS_ONE, MIN_VALUE_ON_SCREEN, DIVIDE, "-19999999999999998");
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_MINUS_ONE, MIN_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "-19999999999999996");
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_MINUS_ONE, HALF_MIN_VALUE_ON_SCREEN, DIVIDE, "-10000000000000000");
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_MINUS_ONE, NEG_HUNDRED, DIVIDE, "-200");
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_MINUS_ONE, NEG_TEN, DIVIDE, "-20");
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_MINUS_ONE, NEG_ONE, DIVIDE, "-2");
//
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_MINUS_ONE, BigDecimal.ZERO, DIVIDE, "0");
//
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_MINUS_ONE, BigDecimal.ONE, DIVIDE, "2");
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_MINUS_ONE, BigDecimal.TEN, DIVIDE, "20");
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_MINUS_ONE, HUNDRED, DIVIDE, "200");
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_MINUS_ONE, HALF_MAX_VALUE_ON_SCREEN, DIVIDE, "10000000000000000");
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_MINUS_ONE, MAX_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "19999999999999996");
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_MINUS_ONE, MAX_VALUE_ON_SCREEN, DIVIDE, "19999999999999997");
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_MINUS_ONE, MAX_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "19999999999999998");
//
//            //first is 9999999999999999
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN, MIN_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "-20000000000000000");
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN, MIN_VALUE_ON_SCREEN, DIVIDE, "-19999999999999998");
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN, MIN_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "-19999999999999996");
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN, HALF_MIN_VALUE_ON_SCREEN, DIVIDE, "-10000000000000000");
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN, NEG_HUNDRED, DIVIDE, "-200");
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN, NEG_TEN, DIVIDE, "-20");
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN, NEG_ONE, DIVIDE, "-2");
//
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN, BigDecimal.ZERO, DIVIDE, "0");
//
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN, BigDecimal.ONE, DIVIDE, "2");
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN, BigDecimal.TEN, DIVIDE, "20");
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN, HUNDRED, DIVIDE, "200");
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN, HALF_MAX_VALUE_ON_SCREEN, DIVIDE, "10000000000000000");
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN, MAX_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "19999999999999996");
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN, MAX_VALUE_ON_SCREEN, DIVIDE, "19999999999999998");
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN, MAX_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "19999999999999999");
//
//            //first is 10000000000000000
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_PLUS_ONE, MIN_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "-20000000000000000");
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_PLUS_ONE, MIN_VALUE_ON_SCREEN, DIVIDE, "-19999999999999998");
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_PLUS_ONE, MIN_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "-19999999999999996");
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_PLUS_ONE, HALF_MIN_VALUE_ON_SCREEN, DIVIDE, "-10000000000000000");
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_PLUS_ONE, NEG_HUNDRED, DIVIDE, "-200");
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_PLUS_ONE, NEG_TEN, DIVIDE, "-20");
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_PLUS_ONE, NEG_ONE, DIVIDE, "-2");
//
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_PLUS_ONE, BigDecimal.ZERO, DIVIDE, "0");
//
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_PLUS_ONE, BigDecimal.ONE, DIVIDE, "2");
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_PLUS_ONE, BigDecimal.TEN, DIVIDE, "20");
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_PLUS_ONE, HUNDRED, DIVIDE, "200");
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_PLUS_ONE, HALF_MAX_VALUE_ON_SCREEN, DIVIDE, "10000000000000000");
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_PLUS_ONE, MAX_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "19999999999999996");
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_PLUS_ONE, MAX_VALUE_ON_SCREEN, DIVIDE, "19999999999999998");
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_PLUS_ONE, MAX_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "20000000000000000");
//        }
//
//        //integer and decimal
//        {
//            //first is -10000000000000000 (and vice versa)
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_MINUS_ONE, NEG_ZERO_DOT_17_NINES, DIVIDE, "-10000000000000000.99999999999999999");
//            checkBinaryOperation(NEG_ZERO_DOT_17_NINES, MIN_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "-10000000000000000.99999999999999999");
//
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_MINUS_ONE, NEG_ZERO_DOT_16_NINES, DIVIDE, "-10000000000000000.9999999999999999");
//            checkBinaryOperation(NEG_ZERO_DOT_16_NINES, MIN_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "-10000000000000000.9999999999999999");
//
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_MINUS_ONE, NEG_NINETY_NINE_HUNDREDTH, DIVIDE, "-10000000000000000.99");
//            checkBinaryOperation(NEG_NINETY_NINE_HUNDREDTH, MIN_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "-10000000000000000.99");
//
//            checkBinaryOperation(NEG_NINE_TENTH, MIN_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "-10000000000000000.9");
//            checkBinaryOperation(NEG_NINE_TENTH, MIN_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "-10000000000000000.9");
//
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_MINUS_ONE, NEG_ONE_TENTH, DIVIDE, "-10000000000000000.1");
//            checkBinaryOperation(NEG_ONE_TENTH, MIN_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "-10000000000000000.1");
//
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_MINUS_ONE, NEG_NINE_HUNDREDTH, DIVIDE, "-10000000000000000.09");
//            checkBinaryOperation(NEG_NINE_HUNDREDTH, MIN_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "-10000000000000000.09");
//
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_MINUS_ONE, NEG_ONE_HUNDREDTH, DIVIDE, "-10000000000000000.01");
//            checkBinaryOperation(NEG_ONE_HUNDREDTH, MIN_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "-10000000000000000.01");
//
//
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_MINUS_ONE, ONE_HUNDREDTH, DIVIDE, "-9999999999999999.99");
//            checkBinaryOperation(ONE_HUNDREDTH, MIN_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "-9999999999999999.99");
//
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_MINUS_ONE, NINE_HUNDREDTH, DIVIDE, "-9999999999999999.91");
//            checkBinaryOperation(NINE_HUNDREDTH, MIN_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "-9999999999999999.91");
//
//            checkBinaryOperation(ONE_TENTH, MIN_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "-9999999999999999.9");
//            checkBinaryOperation(ONE_TENTH, MIN_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "-9999999999999999.9");
//
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_MINUS_ONE, NINE_TENTH, DIVIDE, "-9999999999999999.1");
//            checkBinaryOperation(NINE_TENTH, MIN_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "-9999999999999999.1");
//
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_MINUS_ONE, NINETY_NINE_HUNDREDTH, DIVIDE, "-9999999999999999.01");
//            checkBinaryOperation(NINETY_NINE_HUNDREDTH, MIN_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "-9999999999999999.01");
//
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_MINUS_ONE, ZERO_DOT_16_NINES, DIVIDE, "-9999999999999999.0000000000000001");
//            checkBinaryOperation(ZERO_DOT_16_NINES, MIN_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "-9999999999999999.0000000000000001");
//
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_MINUS_ONE, ZERO_DOT_17_NINES, DIVIDE, "-9999999999999999.00000000000000001");
//            checkBinaryOperation(ZERO_DOT_17_NINES, MIN_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "-9999999999999999.00000000000000001");
//
//            //first is -9999999999999999 (and vice versa)
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN, NEG_ZERO_DOT_17_NINES, DIVIDE, "-9999999999999999.99999999999999999");
//            checkBinaryOperation(NEG_ZERO_DOT_17_NINES, MIN_VALUE_ON_SCREEN, DIVIDE, "-9999999999999999.99999999999999999");
//
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN, NEG_ZERO_DOT_16_NINES, DIVIDE, "-9999999999999999.9999999999999999");
//            checkBinaryOperation(NEG_ZERO_DOT_16_NINES, MIN_VALUE_ON_SCREEN, DIVIDE, "-9999999999999999.9999999999999999");
//
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN, NEG_NINETY_NINE_HUNDREDTH, DIVIDE, "-9999999999999999.99");
//            checkBinaryOperation(NEG_NINETY_NINE_HUNDREDTH, MIN_VALUE_ON_SCREEN, DIVIDE, "-9999999999999999.99");
//
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN, NEG_NINE_TENTH, DIVIDE, "-9999999999999999.9");
//            checkBinaryOperation(NEG_NINE_TENTH, MIN_VALUE_ON_SCREEN, DIVIDE, "-9999999999999999.9");
//
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN, NEG_ONE_TENTH, DIVIDE, "-9999999999999999.1");
//            checkBinaryOperation(NEG_ONE_TENTH, MIN_VALUE_ON_SCREEN, DIVIDE, "-9999999999999999.1");
//
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN, NEG_NINE_HUNDREDTH, DIVIDE, "-9999999999999999.09");
//            checkBinaryOperation(NEG_NINE_HUNDREDTH, MIN_VALUE_ON_SCREEN, DIVIDE, "-9999999999999999.09");
//
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN, NEG_ONE_HUNDREDTH, DIVIDE, "-9999999999999999.01");
//            checkBinaryOperation(NEG_ONE_HUNDREDTH, MIN_VALUE_ON_SCREEN, DIVIDE, "-9999999999999999.01");
//
//
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN, ONE_HUNDREDTH, DIVIDE, "-9999999999999998.99");
//            checkBinaryOperation(ONE_HUNDREDTH, MIN_VALUE_ON_SCREEN, DIVIDE, "-9999999999999998.99");
//
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN, NINE_HUNDREDTH, DIVIDE, "-9999999999999998.91");
//            checkBinaryOperation(NINE_HUNDREDTH, MIN_VALUE_ON_SCREEN, DIVIDE, "-9999999999999998.91");
//
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN, ONE_TENTH, DIVIDE, "-9999999999999998.9");
//            checkBinaryOperation(ONE_TENTH, MIN_VALUE_ON_SCREEN, DIVIDE, "-9999999999999998.9");
//
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN, NINE_TENTH, DIVIDE, "-9999999999999998.1");
//            checkBinaryOperation(NINE_TENTH, MIN_VALUE_ON_SCREEN, DIVIDE, "-9999999999999998.1");
//
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN, NINETY_NINE_HUNDREDTH, DIVIDE, "-9999999999999998.01");
//            checkBinaryOperation(NINETY_NINE_HUNDREDTH, MIN_VALUE_ON_SCREEN, DIVIDE, "-9999999999999998.01");
//
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN, ZERO_DOT_16_NINES, DIVIDE, "-9999999999999998.0000000000000001");
//            checkBinaryOperation(ZERO_DOT_16_NINES, MIN_VALUE_ON_SCREEN, DIVIDE, "-9999999999999998.0000000000000001");
//
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN, ZERO_DOT_17_NINES, DIVIDE, "-9999999999999998.00000000000000001");
//            checkBinaryOperation(ZERO_DOT_17_NINES, MIN_VALUE_ON_SCREEN, DIVIDE, "-9999999999999998.00000000000000001");
//
//            //first is -9999999999999998 (and vice versa)
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_PLUS_ONE, NEG_ZERO_DOT_17_NINES, DIVIDE, "-9999999999999998.99999999999999999");
//            checkBinaryOperation(NEG_ZERO_DOT_17_NINES, MIN_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "-9999999999999998.99999999999999999");
//
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_PLUS_ONE, NEG_ZERO_DOT_16_NINES, DIVIDE, "-9999999999999998.9999999999999999");
//            checkBinaryOperation(NEG_ZERO_DOT_16_NINES, MIN_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "-9999999999999998.9999999999999999");
//
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_PLUS_ONE, NEG_NINETY_NINE_HUNDREDTH, DIVIDE, "-9999999999999998.99");
//            checkBinaryOperation(NEG_NINETY_NINE_HUNDREDTH, MIN_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "-9999999999999998.99");
//
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_PLUS_ONE, NEG_NINE_TENTH, DIVIDE, "-9999999999999998.9");
//            checkBinaryOperation(NEG_NINE_TENTH, MIN_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "-9999999999999998.9");
//
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_PLUS_ONE, NEG_ONE_TENTH, DIVIDE, "-9999999999999998.1");
//            checkBinaryOperation(NEG_ONE_TENTH, MIN_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "-9999999999999998.1");
//
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_PLUS_ONE, NEG_NINE_HUNDREDTH, DIVIDE, "-9999999999999998.09");
//            checkBinaryOperation(NEG_NINE_HUNDREDTH, MIN_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "-9999999999999998.09");
//
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_PLUS_ONE, NEG_ONE_HUNDREDTH, DIVIDE, "-9999999999999998.01");
//            checkBinaryOperation(NEG_ONE_HUNDREDTH, MIN_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "-9999999999999998.01");
//
//
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_PLUS_ONE, ONE_HUNDREDTH, DIVIDE, "-9999999999999997.99");
//            checkBinaryOperation(ONE_HUNDREDTH, MIN_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "-9999999999999997.99");
//
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_PLUS_ONE, NINE_HUNDREDTH, DIVIDE, "-9999999999999997.91");
//            checkBinaryOperation(NINE_HUNDREDTH, MIN_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "-9999999999999997.91");
//
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_PLUS_ONE, ONE_TENTH, DIVIDE, "-9999999999999997.9");
//            checkBinaryOperation(ONE_TENTH, MIN_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "-9999999999999997.9");
//
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_PLUS_ONE, NINE_TENTH, DIVIDE, "-9999999999999997.1");
//            checkBinaryOperation(NINE_TENTH, MIN_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "-9999999999999997.1");
//
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_PLUS_ONE, NINETY_NINE_HUNDREDTH, DIVIDE, "-9999999999999997.01");
//            checkBinaryOperation(NINETY_NINE_HUNDREDTH, MIN_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "-9999999999999997.01");
//
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_PLUS_ONE, ZERO_DOT_16_NINES, DIVIDE, "-9999999999999997.0000000000000001");
//            checkBinaryOperation(ZERO_DOT_16_NINES, MIN_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "-9999999999999997.0000000000000001");
//
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_PLUS_ONE, ZERO_DOT_17_NINES, DIVIDE, "-9999999999999997.00000000000000001");
//            checkBinaryOperation(ZERO_DOT_17_NINES, MIN_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "-9999999999999997.00000000000000001");
//
//            //first is -5000000000000000 (and vice versa)
//            checkBinaryOperation(HALF_MIN_VALUE_ON_SCREEN, NEG_ZERO_DOT_17_NINES, DIVIDE, "-5000000000000000.99999999999999999");
//            checkBinaryOperation(NEG_ZERO_DOT_17_NINES, HALF_MIN_VALUE_ON_SCREEN, DIVIDE, "-5000000000000000.99999999999999999");
//
//            checkBinaryOperation(HALF_MIN_VALUE_ON_SCREEN, NEG_ZERO_DOT_16_NINES, DIVIDE, "-5000000000000000.9999999999999999");
//            checkBinaryOperation(NEG_ZERO_DOT_16_NINES, HALF_MIN_VALUE_ON_SCREEN, DIVIDE, "-5000000000000000.9999999999999999");
//
//            checkBinaryOperation(HALF_MIN_VALUE_ON_SCREEN, NEG_NINETY_NINE_HUNDREDTH, DIVIDE, "-5000000000000000.99");
//            checkBinaryOperation(NEG_NINETY_NINE_HUNDREDTH, HALF_MIN_VALUE_ON_SCREEN, DIVIDE, "-5000000000000000.99");
//
//            checkBinaryOperation(HALF_MIN_VALUE_ON_SCREEN, NEG_NINE_TENTH, DIVIDE, "-5000000000000000.9");
//            checkBinaryOperation(NEG_NINE_TENTH, HALF_MIN_VALUE_ON_SCREEN, DIVIDE, "-5000000000000000.9");
//
//            checkBinaryOperation(HALF_MIN_VALUE_ON_SCREEN, NEG_ONE_TENTH, DIVIDE, "-5000000000000000.1");
//            checkBinaryOperation(NEG_ONE_TENTH, HALF_MIN_VALUE_ON_SCREEN, DIVIDE, "-5000000000000000.1");
//
//            checkBinaryOperation(HALF_MIN_VALUE_ON_SCREEN, NEG_NINE_HUNDREDTH, DIVIDE, "-5000000000000000.09");
//            checkBinaryOperation(NEG_NINE_HUNDREDTH, HALF_MIN_VALUE_ON_SCREEN, DIVIDE, "-5000000000000000.09");
//
//            checkBinaryOperation(HALF_MIN_VALUE_ON_SCREEN, NEG_ONE_HUNDREDTH, DIVIDE, "-5000000000000000.01");
//            checkBinaryOperation(NEG_ONE_HUNDREDTH, HALF_MIN_VALUE_ON_SCREEN, DIVIDE, "-5000000000000000.01");
//
//
//            checkBinaryOperation(HALF_MIN_VALUE_ON_SCREEN, ONE_HUNDREDTH, DIVIDE, "-4999999999999999.99");
//            checkBinaryOperation(ONE_HUNDREDTH, HALF_MIN_VALUE_ON_SCREEN, DIVIDE, "-4999999999999999.99");
//
//            checkBinaryOperation(HALF_MIN_VALUE_ON_SCREEN, NINE_HUNDREDTH, DIVIDE, "-4999999999999999.91");
//            checkBinaryOperation(NINE_HUNDREDTH, HALF_MIN_VALUE_ON_SCREEN, DIVIDE, "-4999999999999999.91");
//
//            checkBinaryOperation(HALF_MIN_VALUE_ON_SCREEN, ONE_TENTH, DIVIDE, "-4999999999999999.9");
//            checkBinaryOperation(ONE_TENTH, HALF_MIN_VALUE_ON_SCREEN, DIVIDE, "-4999999999999999.9");
//
//            checkBinaryOperation(HALF_MIN_VALUE_ON_SCREEN, NINE_TENTH, DIVIDE, "-4999999999999999.1");
//            checkBinaryOperation(NINE_TENTH, HALF_MIN_VALUE_ON_SCREEN, DIVIDE, "-4999999999999999.1");
//
//            checkBinaryOperation(HALF_MIN_VALUE_ON_SCREEN, NINETY_NINE_HUNDREDTH, DIVIDE, "-4999999999999999.01");
//            checkBinaryOperation(NINETY_NINE_HUNDREDTH, HALF_MIN_VALUE_ON_SCREEN, DIVIDE, "-4999999999999999.01");
//
//            checkBinaryOperation(HALF_MIN_VALUE_ON_SCREEN, ZERO_DOT_16_NINES, DIVIDE, "-4999999999999999.0000000000000001");
//            checkBinaryOperation(ZERO_DOT_16_NINES, HALF_MIN_VALUE_ON_SCREEN, DIVIDE, "-4999999999999999.0000000000000001");
//
//            checkBinaryOperation(HALF_MIN_VALUE_ON_SCREEN, ZERO_DOT_17_NINES, DIVIDE, "-4999999999999999.00000000000000001");
//            checkBinaryOperation(ZERO_DOT_17_NINES, HALF_MIN_VALUE_ON_SCREEN, DIVIDE, "-4999999999999999.00000000000000001");
//
//            //first is -100 (and vice versa)
//            checkBinaryOperation(NEG_HUNDRED, NEG_ZERO_DOT_17_NINES, DIVIDE, "-100.99999999999999999");
//            checkBinaryOperation(NEG_ZERO_DOT_17_NINES, NEG_HUNDRED, DIVIDE, "-100.99999999999999999");
//
//            checkBinaryOperation(NEG_HUNDRED, NEG_ZERO_DOT_16_NINES, DIVIDE, "-100.9999999999999999");
//            checkBinaryOperation(NEG_ZERO_DOT_16_NINES, NEG_HUNDRED, DIVIDE, "-100.9999999999999999");
//
//            checkBinaryOperation(NEG_HUNDRED, NEG_NINETY_NINE_HUNDREDTH, DIVIDE, "-100.99");
//            checkBinaryOperation(NEG_NINETY_NINE_HUNDREDTH, NEG_HUNDRED, DIVIDE, "-100.99");
//
//            checkBinaryOperation(NEG_HUNDRED, NEG_NINE_TENTH, DIVIDE, "-100.9");
//            checkBinaryOperation(NEG_NINE_TENTH, NEG_HUNDRED, DIVIDE, "-100.9");
//
//            checkBinaryOperation(NEG_HUNDRED, NEG_ONE_TENTH, DIVIDE, "-100.1");
//            checkBinaryOperation(NEG_ONE_TENTH, NEG_HUNDRED, DIVIDE, "-100.1");
//
//            checkBinaryOperation(NEG_HUNDRED, NEG_NINE_HUNDREDTH, DIVIDE, "-100.09");
//            checkBinaryOperation(NEG_NINE_HUNDREDTH, NEG_HUNDRED, DIVIDE, "-100.09");
//
//            checkBinaryOperation(NEG_HUNDRED, NEG_ONE_HUNDREDTH, DIVIDE, "-100.01");
//            checkBinaryOperation(NEG_ONE_HUNDREDTH, NEG_HUNDRED, DIVIDE, "-100.01");
//
//
//            checkBinaryOperation(NEG_HUNDRED, ONE_HUNDREDTH, DIVIDE, "-99.99");
//            checkBinaryOperation(ONE_HUNDREDTH, NEG_HUNDRED, DIVIDE, "-99.99");
//
//            checkBinaryOperation(NEG_HUNDRED, NINE_HUNDREDTH, DIVIDE, "-99.91");
//            checkBinaryOperation(NINE_HUNDREDTH, NEG_HUNDRED, DIVIDE, "-99.91");
//
//            checkBinaryOperation(NEG_HUNDRED, ONE_TENTH, DIVIDE, "-99.9");
//            checkBinaryOperation(ONE_TENTH, NEG_HUNDRED, DIVIDE, "-99.9");
//
//            checkBinaryOperation(NEG_HUNDRED, NINE_TENTH, DIVIDE, "-99.1");
//            checkBinaryOperation(NINE_TENTH, NEG_HUNDRED, DIVIDE, "-99.1");
//
//            checkBinaryOperation(NEG_HUNDRED, NINETY_NINE_HUNDREDTH, DIVIDE, "-99.01");
//            checkBinaryOperation(NINETY_NINE_HUNDREDTH, NEG_HUNDRED, DIVIDE, "-99.01");
//
//            checkBinaryOperation(NEG_HUNDRED, ZERO_DOT_16_NINES, DIVIDE, "-99.0000000000000001");
//            checkBinaryOperation(ZERO_DOT_16_NINES, NEG_HUNDRED, DIVIDE, "-99.0000000000000001");
//
//            checkBinaryOperation(NEG_HUNDRED, ZERO_DOT_17_NINES, DIVIDE, "-99.00000000000000001");
//            checkBinaryOperation(ZERO_DOT_17_NINES, NEG_HUNDRED, DIVIDE, "-99.00000000000000001");
//
//            //first is -10 (and vice versa)
//            checkBinaryOperation(NEG_TEN, NEG_ZERO_DOT_17_NINES, DIVIDE, "-10.99999999999999999");
//            checkBinaryOperation(NEG_ZERO_DOT_17_NINES, NEG_TEN, DIVIDE, "-10.99999999999999999");
//
//            checkBinaryOperation(NEG_TEN, NEG_ZERO_DOT_16_NINES, DIVIDE, "-10.9999999999999999");
//            checkBinaryOperation(NEG_ZERO_DOT_16_NINES, NEG_TEN, DIVIDE, "-10.9999999999999999");
//
//            checkBinaryOperation(NEG_TEN, NEG_NINETY_NINE_HUNDREDTH, DIVIDE, "-10.99");
//            checkBinaryOperation(NEG_NINETY_NINE_HUNDREDTH, NEG_TEN, DIVIDE, "-10.99");
//
//            checkBinaryOperation(NEG_TEN, NEG_NINE_TENTH, DIVIDE, "-10.9");
//            checkBinaryOperation(NEG_NINE_TENTH, NEG_TEN, DIVIDE, "-10.9");
//
//            checkBinaryOperation(NEG_TEN, NEG_ONE_TENTH, DIVIDE, "-10.1");
//            checkBinaryOperation(NEG_ONE_TENTH, NEG_TEN, DIVIDE, "-10.1");
//
//            checkBinaryOperation(NEG_TEN, NEG_NINE_HUNDREDTH, DIVIDE, "-10.09");
//            checkBinaryOperation(NEG_NINE_HUNDREDTH, NEG_TEN, DIVIDE, "-10.09");
//
//            checkBinaryOperation(NEG_TEN, NEG_ONE_HUNDREDTH, DIVIDE, "-10.01");
//            checkBinaryOperation(NEG_ONE_HUNDREDTH, NEG_TEN, DIVIDE, "-10.01");
//
//
//            checkBinaryOperation(NEG_TEN, ONE_HUNDREDTH, DIVIDE, "-9.99");
//            checkBinaryOperation(ONE_HUNDREDTH, NEG_TEN, DIVIDE, "-9.99");
//
//            checkBinaryOperation(NEG_TEN, NINE_HUNDREDTH, DIVIDE, "-9.91");
//            checkBinaryOperation(NINE_HUNDREDTH, NEG_TEN, DIVIDE, "-9.91");
//
//            checkBinaryOperation(NEG_TEN, ONE_TENTH, DIVIDE, "-9.9");
//            checkBinaryOperation(ONE_TENTH, NEG_TEN, DIVIDE, "-9.9");
//
//            checkBinaryOperation(NEG_TEN, NINE_TENTH, DIVIDE, "-9.1");
//            checkBinaryOperation(NINE_TENTH, NEG_TEN, DIVIDE, "-9.1");
//
//            checkBinaryOperation(NEG_TEN, NINETY_NINE_HUNDREDTH, DIVIDE, "-9.01");
//            checkBinaryOperation(NINETY_NINE_HUNDREDTH, NEG_TEN, DIVIDE, "-9.01");
//
//            checkBinaryOperation(NEG_TEN, ZERO_DOT_16_NINES, DIVIDE, "-9.0000000000000001");
//            checkBinaryOperation(ZERO_DOT_16_NINES, NEG_TEN, DIVIDE, "-9.0000000000000001");
//
//            checkBinaryOperation(NEG_TEN, ZERO_DOT_17_NINES, DIVIDE, "-9.00000000000000001");
//            checkBinaryOperation(ZERO_DOT_17_NINES, NEG_TEN, DIVIDE, "-9.00000000000000001");
//
//            //first is -1 (and vice versa)
//            checkBinaryOperation(NEG_ONE, NEG_ZERO_DOT_17_NINES, DIVIDE, "-1.99999999999999999");
//            checkBinaryOperation(NEG_ZERO_DOT_17_NINES, NEG_ONE, DIVIDE, "-1.99999999999999999");
//
//            checkBinaryOperation(NEG_ONE, NEG_ZERO_DOT_16_NINES, DIVIDE, "-1.9999999999999999");
//            checkBinaryOperation(NEG_ZERO_DOT_16_NINES, NEG_ONE, DIVIDE, "-1.9999999999999999");
//
//            checkBinaryOperation(NEG_ONE, NEG_NINETY_NINE_HUNDREDTH, DIVIDE, "-1.99");
//            checkBinaryOperation(NEG_NINETY_NINE_HUNDREDTH, NEG_ONE, DIVIDE, "-1.99");
//
//            checkBinaryOperation(NEG_ONE, NEG_NINE_TENTH, DIVIDE, "-1.9");
//            checkBinaryOperation(NEG_NINE_TENTH, NEG_ONE, DIVIDE, "-1.9");
//
//            checkBinaryOperation(NEG_ONE, NEG_ONE_TENTH, DIVIDE, "-1.1");
//            checkBinaryOperation(NEG_ONE_TENTH, NEG_ONE, DIVIDE, "-1.1");
//
//            checkBinaryOperation(NEG_ONE, NEG_NINE_HUNDREDTH, DIVIDE, "-1.09");
//            checkBinaryOperation(NEG_NINE_HUNDREDTH, NEG_ONE, DIVIDE, "-1.09");
//
//            checkBinaryOperation(NEG_ONE, NEG_ONE_HUNDREDTH, DIVIDE, "-1.01");
//            checkBinaryOperation(NEG_ONE_HUNDREDTH, NEG_ONE, DIVIDE, "-1.01");
//
//
//            checkBinaryOperation(NEG_ONE, ONE_HUNDREDTH, DIVIDE, "-0.99");
//            checkBinaryOperation(ONE_HUNDREDTH, NEG_ONE, DIVIDE, "-0.99");
//
//            checkBinaryOperation(NEG_ONE, NINE_HUNDREDTH, DIVIDE, "-0.91");
//            checkBinaryOperation(NINE_HUNDREDTH, NEG_ONE, DIVIDE, "-0.91");
//
//            checkBinaryOperation(NEG_ONE, ONE_TENTH, DIVIDE, "-0.9");
//            checkBinaryOperation(ONE_TENTH, NEG_ONE, DIVIDE, "-0.9");
//
//            checkBinaryOperation(NEG_ONE, NINE_TENTH, DIVIDE, "-0.1");
//            checkBinaryOperation(NINE_TENTH, NEG_ONE, DIVIDE, "-0.1");
//
//            checkBinaryOperation(NEG_ONE, NINETY_NINE_HUNDREDTH, DIVIDE, "-0.01");
//            checkBinaryOperation(NINETY_NINE_HUNDREDTH, NEG_ONE, DIVIDE, "-0.01");
//
//            checkBinaryOperation(NEG_ONE, ZERO_DOT_16_NINES, DIVIDE, "-0.0000000000000001");
//            checkBinaryOperation(ZERO_DOT_16_NINES, NEG_ONE, DIVIDE, "-0.0000000000000001");
//
//            checkBinaryOperation(NEG_ONE, ZERO_DOT_17_NINES, DIVIDE, "-0.00000000000000001");
//            checkBinaryOperation(ZERO_DOT_17_NINES, NEG_ONE, DIVIDE, "-0.00000000000000001");
//
//            //first is 0 (and vice versa)
//            checkBinaryOperation(BigDecimal.ZERO, NEG_ZERO_DOT_17_NINES, DIVIDE, "-0.99999999999999999");
//            checkBinaryOperation(NEG_ZERO_DOT_17_NINES, BigDecimal.ZERO, DIVIDE, "-0.99999999999999999");
//
//            checkBinaryOperation(BigDecimal.ZERO, NEG_ZERO_DOT_16_NINES, DIVIDE, "-0.9999999999999999");
//            checkBinaryOperation(NEG_ZERO_DOT_16_NINES, BigDecimal.ZERO, DIVIDE, "-0.9999999999999999");
//
//            checkBinaryOperation(BigDecimal.ZERO, NEG_NINETY_NINE_HUNDREDTH, DIVIDE, "-0.99");
//            checkBinaryOperation(NEG_NINETY_NINE_HUNDREDTH, BigDecimal.ZERO, DIVIDE, "-0.99");
//
//            checkBinaryOperation(BigDecimal.ZERO, NEG_NINE_TENTH, DIVIDE, "-0.9");
//            checkBinaryOperation(NEG_NINE_TENTH, BigDecimal.ZERO, DIVIDE, "-0.9");
//
//            checkBinaryOperation(BigDecimal.ZERO, NEG_ONE_TENTH, DIVIDE, "-0.1");
//            checkBinaryOperation(NEG_ONE_TENTH, BigDecimal.ZERO, DIVIDE, "-0.1");
//
//            checkBinaryOperation(BigDecimal.ZERO, NEG_NINE_HUNDREDTH, DIVIDE, "-0.09");
//            checkBinaryOperation(NEG_NINE_HUNDREDTH, BigDecimal.ZERO, DIVIDE, "-0.09");
//
//            checkBinaryOperation(BigDecimal.ZERO, NEG_ONE_HUNDREDTH, DIVIDE, "-0.01");
//            checkBinaryOperation(NEG_ONE_HUNDREDTH, BigDecimal.ZERO, DIVIDE, "-0.01");
//
//
//            checkBinaryOperation(BigDecimal.ZERO, ONE_HUNDREDTH, DIVIDE, "0.01");
//            checkBinaryOperation(ONE_HUNDREDTH, BigDecimal.ZERO, DIVIDE, "0.01");
//
//            checkBinaryOperation(BigDecimal.ZERO, NINE_HUNDREDTH, DIVIDE, "0.09");
//            checkBinaryOperation(NINE_HUNDREDTH, BigDecimal.ZERO, DIVIDE, "0.09");
//
//            checkBinaryOperation(BigDecimal.ZERO, ONE_TENTH, DIVIDE, "0.1");
//            checkBinaryOperation(ONE_TENTH, BigDecimal.ZERO, DIVIDE, "0.1");
//
//            checkBinaryOperation(BigDecimal.ZERO, NINE_TENTH, DIVIDE, "0.9");
//            checkBinaryOperation(NINE_TENTH, BigDecimal.ZERO, DIVIDE, "0.9");
//
//            checkBinaryOperation(BigDecimal.ZERO, NINETY_NINE_HUNDREDTH, DIVIDE, "0.99");
//            checkBinaryOperation(NINETY_NINE_HUNDREDTH, BigDecimal.ZERO, DIVIDE, "0.99");
//
//            checkBinaryOperation(BigDecimal.ZERO, ZERO_DOT_16_NINES, DIVIDE, "0.9999999999999999");
//            checkBinaryOperation(ZERO_DOT_16_NINES, BigDecimal.ZERO, DIVIDE, "0.9999999999999999");
//
//            checkBinaryOperation(BigDecimal.ZERO, ZERO_DOT_17_NINES, DIVIDE, "0.99999999999999999");
//            checkBinaryOperation(ZERO_DOT_17_NINES, BigDecimal.ZERO, DIVIDE, "0.99999999999999999");
//
//            //first is 1 (and vice versa)
//            checkBinaryOperation(BigDecimal.ONE, NEG_ZERO_DOT_17_NINES, DIVIDE, "0.00000000000000001");
//            checkBinaryOperation(NEG_ZERO_DOT_17_NINES, BigDecimal.ONE, DIVIDE, "0.00000000000000001");
//
//            checkBinaryOperation(BigDecimal.ONE, NEG_ZERO_DOT_16_NINES, DIVIDE, "0.0000000000000001");
//            checkBinaryOperation(NEG_ZERO_DOT_16_NINES, BigDecimal.ONE, DIVIDE, "0.0000000000000001");
//
//            checkBinaryOperation(BigDecimal.ONE, NEG_NINETY_NINE_HUNDREDTH, DIVIDE, "0.01");
//            checkBinaryOperation(NEG_NINETY_NINE_HUNDREDTH, BigDecimal.ONE, DIVIDE, "0.01");
//
//            checkBinaryOperation(BigDecimal.ONE, NEG_NINE_TENTH, DIVIDE, "0.1");
//            checkBinaryOperation(NEG_NINE_TENTH, BigDecimal.ONE, DIVIDE, "0.1");
//
//            checkBinaryOperation(BigDecimal.ONE, NEG_ONE_TENTH, DIVIDE, "0.9");
//            checkBinaryOperation(NEG_ONE_TENTH, BigDecimal.ONE, DIVIDE, "0.9");
//
//            checkBinaryOperation(BigDecimal.ONE, NEG_NINE_HUNDREDTH, DIVIDE, "0.91");
//            checkBinaryOperation(NEG_NINE_HUNDREDTH, BigDecimal.ONE, DIVIDE, "0.91");
//
//            checkBinaryOperation(BigDecimal.ONE, NEG_ONE_HUNDREDTH, DIVIDE, "0.99");
//            checkBinaryOperation(NEG_ONE_HUNDREDTH, BigDecimal.ONE, DIVIDE, "0.99");
//
//
//            checkBinaryOperation(BigDecimal.ONE, ONE_HUNDREDTH, DIVIDE, "1.01");
//            checkBinaryOperation(ONE_HUNDREDTH, BigDecimal.ONE, DIVIDE, "1.01");
//
//            checkBinaryOperation(BigDecimal.ONE, NINE_HUNDREDTH, DIVIDE, "1.09");
//            checkBinaryOperation(NINE_HUNDREDTH, BigDecimal.ONE, DIVIDE, "1.09");
//
//            checkBinaryOperation(BigDecimal.ONE, ONE_TENTH, DIVIDE, "1.1");
//            checkBinaryOperation(ONE_TENTH, BigDecimal.ONE, DIVIDE, "1.1");
//
//            checkBinaryOperation(BigDecimal.ONE, NINE_TENTH, DIVIDE, "1.9");
//            checkBinaryOperation(NINE_TENTH, BigDecimal.ONE, DIVIDE, "1.9");
//
//            checkBinaryOperation(BigDecimal.ONE, NINETY_NINE_HUNDREDTH, DIVIDE, "1.99");
//            checkBinaryOperation(NINETY_NINE_HUNDREDTH, BigDecimal.ONE, DIVIDE, "1.99");
//
//            checkBinaryOperation(BigDecimal.ONE, ZERO_DOT_16_NINES, DIVIDE, "1.9999999999999999");
//            checkBinaryOperation(ZERO_DOT_16_NINES, BigDecimal.ONE, DIVIDE, "1.9999999999999999");
//
//            checkBinaryOperation(BigDecimal.ONE, ZERO_DOT_17_NINES, DIVIDE, "1.99999999999999999");
//            checkBinaryOperation(ZERO_DOT_17_NINES, BigDecimal.ONE, DIVIDE, "1.99999999999999999");
//
//            //first is 10 (and vice versa)
//            checkBinaryOperation(BigDecimal.TEN, NEG_ZERO_DOT_17_NINES, DIVIDE, "9.00000000000000001");
//            checkBinaryOperation(NEG_ZERO_DOT_17_NINES, BigDecimal.TEN, DIVIDE, "9.00000000000000001");
//
//            checkBinaryOperation(BigDecimal.TEN, NEG_ZERO_DOT_16_NINES, DIVIDE, "9.0000000000000001");
//            checkBinaryOperation(NEG_ZERO_DOT_16_NINES, BigDecimal.TEN, DIVIDE, "9.0000000000000001");
//
//            checkBinaryOperation(BigDecimal.TEN, NEG_NINETY_NINE_HUNDREDTH, DIVIDE, "9.01");
//            checkBinaryOperation(NEG_NINETY_NINE_HUNDREDTH, BigDecimal.TEN, DIVIDE, "9.01");
//
//            checkBinaryOperation(BigDecimal.TEN, NEG_NINE_TENTH, DIVIDE, "9.1");
//            checkBinaryOperation(NEG_NINE_TENTH, BigDecimal.TEN, DIVIDE, "9.1");
//
//            checkBinaryOperation(BigDecimal.TEN, NEG_ONE_TENTH, DIVIDE, "9.9");
//            checkBinaryOperation(NEG_ONE_TENTH, BigDecimal.TEN, DIVIDE, "9.9");
//
//            checkBinaryOperation(BigDecimal.TEN, NEG_NINE_HUNDREDTH, DIVIDE, "9.91");
//            checkBinaryOperation(NEG_NINE_HUNDREDTH, BigDecimal.TEN, DIVIDE, "9.91");
//
//            checkBinaryOperation(BigDecimal.TEN, NEG_ONE_HUNDREDTH, DIVIDE, "9.99");
//            checkBinaryOperation(NEG_ONE_HUNDREDTH, BigDecimal.TEN, DIVIDE, "9.99");
//
//
//            checkBinaryOperation(BigDecimal.TEN, ONE_HUNDREDTH, DIVIDE, "10.01");
//            checkBinaryOperation(ONE_HUNDREDTH, BigDecimal.TEN, DIVIDE, "10.01");
//
//            checkBinaryOperation(BigDecimal.TEN, NINE_HUNDREDTH, DIVIDE, "10.09");
//            checkBinaryOperation(NINE_HUNDREDTH, BigDecimal.TEN, DIVIDE, "10.09");
//
//            checkBinaryOperation(BigDecimal.TEN, ONE_TENTH, DIVIDE, "10.1");
//            checkBinaryOperation(ONE_TENTH, BigDecimal.TEN, DIVIDE, "10.1");
//
//            checkBinaryOperation(BigDecimal.TEN, NINE_TENTH, DIVIDE, "10.9");
//            checkBinaryOperation(NINE_TENTH, BigDecimal.TEN, DIVIDE, "10.9");
//
//            checkBinaryOperation(BigDecimal.TEN, NINETY_NINE_HUNDREDTH, DIVIDE, "10.99");
//            checkBinaryOperation(NINETY_NINE_HUNDREDTH, BigDecimal.TEN, DIVIDE, "10.99");
//
//            checkBinaryOperation(BigDecimal.TEN, ZERO_DOT_16_NINES, DIVIDE, "10.9999999999999999");
//            checkBinaryOperation(ZERO_DOT_16_NINES, BigDecimal.TEN, DIVIDE, "10.9999999999999999");
//
//            checkBinaryOperation(BigDecimal.TEN, ZERO_DOT_17_NINES, DIVIDE, "10.99999999999999999");
//            checkBinaryOperation(ZERO_DOT_17_NINES, BigDecimal.TEN, DIVIDE, "10.99999999999999999");
//
//            //first is 100 (and vice versa)
//            checkBinaryOperation(HUNDRED, NEG_ZERO_DOT_17_NINES, DIVIDE, "99.00000000000000001");
//            checkBinaryOperation(NEG_ZERO_DOT_17_NINES, HUNDRED, DIVIDE, "99.00000000000000001");
//
//            checkBinaryOperation(HUNDRED, NEG_ZERO_DOT_16_NINES, DIVIDE, "99.0000000000000001");
//            checkBinaryOperation(NEG_ZERO_DOT_16_NINES, HUNDRED, DIVIDE, "99.0000000000000001");
//
//            checkBinaryOperation(HUNDRED, NEG_NINETY_NINE_HUNDREDTH, DIVIDE, "99.01");
//            checkBinaryOperation(NEG_NINETY_NINE_HUNDREDTH, HUNDRED, DIVIDE, "99.01");
//
//            checkBinaryOperation(HUNDRED, NEG_NINE_TENTH, DIVIDE, "99.1");
//            checkBinaryOperation(NEG_NINE_TENTH, HUNDRED, DIVIDE, "99.1");
//
//            checkBinaryOperation(HUNDRED, NEG_ONE_TENTH, DIVIDE, "99.9");
//            checkBinaryOperation(NEG_ONE_TENTH, HUNDRED, DIVIDE, "99.9");
//
//            checkBinaryOperation(HUNDRED, NEG_NINE_HUNDREDTH, DIVIDE, "99.91");
//            checkBinaryOperation(NEG_NINE_HUNDREDTH, HUNDRED, DIVIDE, "99.91");
//
//            checkBinaryOperation(HUNDRED, NEG_ONE_HUNDREDTH, DIVIDE, "99.99");
//            checkBinaryOperation(NEG_ONE_HUNDREDTH, HUNDRED, DIVIDE, "99.99");
//
//
//            checkBinaryOperation(HUNDRED, ONE_HUNDREDTH, DIVIDE, "100.01");
//            checkBinaryOperation(ONE_HUNDREDTH, HUNDRED, DIVIDE, "100.01");
//
//            checkBinaryOperation(HUNDRED, NINE_HUNDREDTH, DIVIDE, "100.09");
//            checkBinaryOperation(NINE_HUNDREDTH, HUNDRED, DIVIDE, "100.09");
//
//            checkBinaryOperation(HUNDRED, ONE_TENTH, DIVIDE, "100.1");
//            checkBinaryOperation(ONE_TENTH, HUNDRED, DIVIDE, "100.1");
//
//            checkBinaryOperation(HUNDRED, NINE_TENTH, DIVIDE, "100.9");
//            checkBinaryOperation(NINE_TENTH, HUNDRED, DIVIDE, "100.9");
//
//            checkBinaryOperation(HUNDRED, NINETY_NINE_HUNDREDTH, DIVIDE, "100.99");
//            checkBinaryOperation(NINETY_NINE_HUNDREDTH, HUNDRED, DIVIDE, "100.99");
//
//            checkBinaryOperation(HUNDRED, ZERO_DOT_16_NINES, DIVIDE, "100.9999999999999999");
//            checkBinaryOperation(ZERO_DOT_16_NINES, HUNDRED, DIVIDE, "100.9999999999999999");
//
//            checkBinaryOperation(HUNDRED, ZERO_DOT_17_NINES, DIVIDE, "100.99999999999999999");
//            checkBinaryOperation(ZERO_DOT_17_NINES, HUNDRED, DIVIDE, "100.99999999999999999");
//
//            //first is 5000000000000000 (and vice versa)
//            checkBinaryOperation(HALF_MAX_VALUE_ON_SCREEN, NEG_ZERO_DOT_17_NINES, DIVIDE, "4999999999999999.00000000000000001");
//            checkBinaryOperation(NEG_ZERO_DOT_17_NINES, HALF_MAX_VALUE_ON_SCREEN, DIVIDE, "4999999999999999.00000000000000001");
//
//            checkBinaryOperation(HALF_MAX_VALUE_ON_SCREEN, NEG_ZERO_DOT_16_NINES, DIVIDE, "4999999999999999.0000000000000001");
//            checkBinaryOperation(NEG_ZERO_DOT_16_NINES, HALF_MAX_VALUE_ON_SCREEN, DIVIDE, "4999999999999999.0000000000000001");
//
//            checkBinaryOperation(HALF_MAX_VALUE_ON_SCREEN, NEG_NINETY_NINE_HUNDREDTH, DIVIDE, "4999999999999999.01");
//            checkBinaryOperation(NEG_NINETY_NINE_HUNDREDTH, HALF_MAX_VALUE_ON_SCREEN, DIVIDE, "4999999999999999.01");
//
//            checkBinaryOperation(HALF_MAX_VALUE_ON_SCREEN, NEG_NINE_TENTH, DIVIDE, "4999999999999999.1");
//            checkBinaryOperation(NEG_NINE_TENTH, HALF_MAX_VALUE_ON_SCREEN, DIVIDE, "4999999999999999.1");
//
//            checkBinaryOperation(HALF_MAX_VALUE_ON_SCREEN, NEG_ONE_TENTH, DIVIDE, "4999999999999999.9");
//            checkBinaryOperation(NEG_ONE_TENTH, HALF_MAX_VALUE_ON_SCREEN, DIVIDE, "4999999999999999.9");
//
//            checkBinaryOperation(HALF_MAX_VALUE_ON_SCREEN, NEG_NINE_HUNDREDTH, DIVIDE, "4999999999999999.91");
//            checkBinaryOperation(NEG_NINE_HUNDREDTH, HALF_MAX_VALUE_ON_SCREEN, DIVIDE, "4999999999999999.91");
//
//            checkBinaryOperation(HALF_MAX_VALUE_ON_SCREEN, NEG_ONE_HUNDREDTH, DIVIDE, "4999999999999999.99");
//            checkBinaryOperation(NEG_ONE_HUNDREDTH, HALF_MAX_VALUE_ON_SCREEN, DIVIDE, "4999999999999999.99");
//
//
//            checkBinaryOperation(HALF_MAX_VALUE_ON_SCREEN, ONE_HUNDREDTH, DIVIDE, "5000000000000000.01");
//            checkBinaryOperation(ONE_HUNDREDTH, HALF_MAX_VALUE_ON_SCREEN, DIVIDE, "5000000000000000.01");
//
//            checkBinaryOperation(HALF_MAX_VALUE_ON_SCREEN, NINE_HUNDREDTH, DIVIDE, "5000000000000000.09");
//            checkBinaryOperation(NINE_HUNDREDTH, HALF_MAX_VALUE_ON_SCREEN, DIVIDE, "5000000000000000.09");
//
//            checkBinaryOperation(HALF_MAX_VALUE_ON_SCREEN, ONE_TENTH, DIVIDE, "5000000000000000.1");
//            checkBinaryOperation(ONE_TENTH, HALF_MAX_VALUE_ON_SCREEN, DIVIDE, "5000000000000000.1");
//
//            checkBinaryOperation(HALF_MAX_VALUE_ON_SCREEN, NINE_TENTH, DIVIDE, "5000000000000000.9");
//            checkBinaryOperation(NINE_TENTH, HALF_MAX_VALUE_ON_SCREEN, DIVIDE, "5000000000000000.9");
//
//            checkBinaryOperation(HALF_MAX_VALUE_ON_SCREEN, NINETY_NINE_HUNDREDTH, DIVIDE, "5000000000000000.99");
//            checkBinaryOperation(NINETY_NINE_HUNDREDTH, HALF_MAX_VALUE_ON_SCREEN, DIVIDE, "5000000000000000.99");
//
//            checkBinaryOperation(HALF_MAX_VALUE_ON_SCREEN, ZERO_DOT_16_NINES, DIVIDE, "5000000000000000.9999999999999999");
//            checkBinaryOperation(ZERO_DOT_16_NINES, HALF_MAX_VALUE_ON_SCREEN, DIVIDE, "5000000000000000.9999999999999999");
//
//            checkBinaryOperation(HALF_MAX_VALUE_ON_SCREEN, ZERO_DOT_17_NINES, DIVIDE, "5000000000000000.99999999999999999");
//            checkBinaryOperation(ZERO_DOT_17_NINES, HALF_MAX_VALUE_ON_SCREEN, DIVIDE, "5000000000000000.99999999999999999");
//
//            //first is 9999999999999998 (and vice versa)
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_MINUS_ONE, NEG_ZERO_DOT_17_NINES, DIVIDE, "9999999999999997.00000000000000001");
//            checkBinaryOperation(NEG_ZERO_DOT_17_NINES, MAX_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "9999999999999997.00000000000000001");
//
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_MINUS_ONE, NEG_ZERO_DOT_16_NINES, DIVIDE, "9999999999999997.0000000000000001");
//            checkBinaryOperation(NEG_ZERO_DOT_16_NINES, MAX_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "9999999999999997.0000000000000001");
//
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_MINUS_ONE, NEG_NINETY_NINE_HUNDREDTH, DIVIDE, "9999999999999997.01");
//            checkBinaryOperation(NEG_NINETY_NINE_HUNDREDTH, MAX_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "9999999999999997.01");
//
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_MINUS_ONE, NEG_NINE_TENTH, DIVIDE, "9999999999999997.1");
//            checkBinaryOperation(NEG_NINE_TENTH, MAX_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "9999999999999997.1");
//
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_MINUS_ONE, NEG_ONE_TENTH, DIVIDE, "9999999999999997.9");
//            checkBinaryOperation(NEG_ONE_TENTH, MAX_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "9999999999999997.9");
//
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_MINUS_ONE, NEG_NINE_HUNDREDTH, DIVIDE, "9999999999999997.91");
//            checkBinaryOperation(NEG_NINE_HUNDREDTH, MAX_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "9999999999999997.91");
//
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_MINUS_ONE, NEG_ONE_HUNDREDTH, DIVIDE, "9999999999999997.99");
//            checkBinaryOperation(NEG_ONE_HUNDREDTH, MAX_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "9999999999999997.99");
//
//
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_MINUS_ONE, ONE_HUNDREDTH, DIVIDE, "9999999999999998.01");
//            checkBinaryOperation(ONE_HUNDREDTH, MAX_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "9999999999999998.01");
//
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_MINUS_ONE, NINE_HUNDREDTH, DIVIDE, "9999999999999998.09");
//            checkBinaryOperation(NINE_HUNDREDTH, MAX_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "9999999999999998.09");
//
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_MINUS_ONE, ONE_TENTH, DIVIDE, "9999999999999998.1");
//            checkBinaryOperation(ONE_TENTH, MAX_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "9999999999999998.1");
//
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_MINUS_ONE, NINE_TENTH, DIVIDE, "9999999999999998.9");
//            checkBinaryOperation(NINE_TENTH, MAX_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "9999999999999998.9");
//
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_MINUS_ONE, NINETY_NINE_HUNDREDTH, DIVIDE, "9999999999999998.99");
//            checkBinaryOperation(NINETY_NINE_HUNDREDTH, MAX_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "9999999999999998.99");
//
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_MINUS_ONE, ZERO_DOT_16_NINES, DIVIDE, "9999999999999998.9999999999999999");
//            checkBinaryOperation(ZERO_DOT_16_NINES, MAX_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "9999999999999998.9999999999999999");
//
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_MINUS_ONE, ZERO_DOT_17_NINES, DIVIDE, "9999999999999998.99999999999999999");
//            checkBinaryOperation(ZERO_DOT_17_NINES, MAX_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "9999999999999998.99999999999999999");
//
//            //first is 9999999999999999 (and vice versa)
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN, NEG_ZERO_DOT_17_NINES, DIVIDE, "9999999999999998.00000000000000001");
//            checkBinaryOperation(NEG_ZERO_DOT_17_NINES, MAX_VALUE_ON_SCREEN, DIVIDE, "9999999999999998.00000000000000001");
//
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN, NEG_ZERO_DOT_16_NINES, DIVIDE, "9999999999999998.0000000000000001");
//            checkBinaryOperation(NEG_ZERO_DOT_16_NINES, MAX_VALUE_ON_SCREEN, DIVIDE, "9999999999999998.0000000000000001");
//
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN, NEG_NINETY_NINE_HUNDREDTH, DIVIDE, "9999999999999998.01");
//            checkBinaryOperation(NEG_NINETY_NINE_HUNDREDTH, MAX_VALUE_ON_SCREEN, DIVIDE, "9999999999999998.01");
//
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN, NEG_NINE_TENTH, DIVIDE, "9999999999999998.1");
//            checkBinaryOperation(NEG_NINE_TENTH, MAX_VALUE_ON_SCREEN, DIVIDE, "9999999999999998.1");
//
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN, NEG_ONE_TENTH, DIVIDE, "9999999999999998.9");
//            checkBinaryOperation(NEG_ONE_TENTH, MAX_VALUE_ON_SCREEN, DIVIDE, "9999999999999998.9");
//
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN, NEG_NINE_HUNDREDTH, DIVIDE, "9999999999999998.91");
//            checkBinaryOperation(NEG_NINE_HUNDREDTH, MAX_VALUE_ON_SCREEN, DIVIDE, "9999999999999998.91");
//
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN, NEG_ONE_HUNDREDTH, DIVIDE, "9999999999999998.99");
//            checkBinaryOperation(NEG_ONE_HUNDREDTH, MAX_VALUE_ON_SCREEN, DIVIDE, "9999999999999998.99");
//
//
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN, ONE_HUNDREDTH, DIVIDE, "9999999999999999.01");
//            checkBinaryOperation(ONE_HUNDREDTH, MAX_VALUE_ON_SCREEN, DIVIDE, "9999999999999999.01");
//
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN, NINE_HUNDREDTH, DIVIDE, "9999999999999999.09");
//            checkBinaryOperation(NINE_HUNDREDTH, MAX_VALUE_ON_SCREEN, DIVIDE, "9999999999999999.09");
//
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN, ONE_TENTH, DIVIDE, "9999999999999999.1");
//            checkBinaryOperation(ONE_TENTH, MAX_VALUE_ON_SCREEN, DIVIDE, "9999999999999999.1");
//
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN, NINE_TENTH, DIVIDE, "9999999999999999.9");
//            checkBinaryOperation(NINE_TENTH, MAX_VALUE_ON_SCREEN, DIVIDE, "9999999999999999.9");
//
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN, NINETY_NINE_HUNDREDTH, DIVIDE, "9999999999999999.99");
//            checkBinaryOperation(NINETY_NINE_HUNDREDTH, MAX_VALUE_ON_SCREEN, DIVIDE, "9999999999999999.99");
//
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN, ZERO_DOT_16_NINES, DIVIDE, "9999999999999999.9999999999999999");
//            checkBinaryOperation(ZERO_DOT_16_NINES, MAX_VALUE_ON_SCREEN, DIVIDE, "9999999999999999.9999999999999999");
//
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN, ZERO_DOT_17_NINES, DIVIDE, "9999999999999999.99999999999999999");
//            checkBinaryOperation(ZERO_DOT_17_NINES, MAX_VALUE_ON_SCREEN, DIVIDE, "9999999999999999.99999999999999999");
//
//            //first is 10000000000000000 (and vice versa)
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_PLUS_ONE, NEG_ZERO_DOT_17_NINES, DIVIDE, "9999999999999999.00000000000000001");
//            checkBinaryOperation(NEG_ZERO_DOT_17_NINES, MAX_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "9999999999999999.00000000000000001");
//
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_PLUS_ONE, NEG_ZERO_DOT_16_NINES, DIVIDE, "9999999999999999.0000000000000001");
//            checkBinaryOperation(NEG_ZERO_DOT_16_NINES, MAX_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "9999999999999999.0000000000000001");
//
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_PLUS_ONE, NEG_NINETY_NINE_HUNDREDTH, DIVIDE, "9999999999999999.01");
//            checkBinaryOperation(NEG_NINETY_NINE_HUNDREDTH, MAX_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "9999999999999999.01");
//
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_PLUS_ONE, NEG_NINE_TENTH, DIVIDE, "9999999999999999.1");
//            checkBinaryOperation(NEG_NINE_TENTH, MAX_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "9999999999999999.1");
//
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_PLUS_ONE, NEG_ONE_TENTH, DIVIDE, "9999999999999999.9");
//            checkBinaryOperation(NEG_ONE_TENTH, MAX_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "9999999999999999.9");
//
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_PLUS_ONE, NEG_NINE_HUNDREDTH, DIVIDE, "9999999999999999.91");
//            checkBinaryOperation(NEG_NINE_HUNDREDTH, MAX_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "9999999999999999.91");
//
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_PLUS_ONE, NEG_ONE_HUNDREDTH, DIVIDE, "9999999999999999.99");
//            checkBinaryOperation(NEG_ONE_HUNDREDTH, MAX_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "9999999999999999.99");
//
//
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_PLUS_ONE, ONE_HUNDREDTH, DIVIDE, "10000000000000000.01");
//            checkBinaryOperation(ONE_HUNDREDTH, MAX_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "10000000000000000.01");
//
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_PLUS_ONE, NINE_HUNDREDTH, DIVIDE, "10000000000000000.09");
//            checkBinaryOperation(NINE_HUNDREDTH, MAX_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "10000000000000000.09");
//
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_PLUS_ONE, ONE_TENTH, DIVIDE, "10000000000000000.1");
//            checkBinaryOperation(ONE_TENTH, MAX_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "10000000000000000.1");
//
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_PLUS_ONE, NINE_TENTH, DIVIDE, "10000000000000000.9");
//            checkBinaryOperation(NINE_TENTH, MAX_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "10000000000000000.9");
//
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_PLUS_ONE, NINETY_NINE_HUNDREDTH, DIVIDE, "10000000000000000.99");
//            checkBinaryOperation(NINETY_NINE_HUNDREDTH, MAX_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "10000000000000000.99");
//
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_PLUS_ONE, ZERO_DOT_16_NINES, DIVIDE, "10000000000000000.9999999999999999");
//            checkBinaryOperation(ZERO_DOT_16_NINES, MAX_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "10000000000000000.9999999999999999");
//
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_PLUS_ONE, ZERO_DOT_17_NINES, DIVIDE, "10000000000000000.99999999999999999");
//            checkBinaryOperation(ZERO_DOT_17_NINES, MAX_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "10000000000000000.99999999999999999");
//        }
//
//        //decimals only
//        {
//            //first is -0.99999999999999999
//            checkBinaryOperation(NEG_ZERO_DOT_17_NINES, NEG_ZERO_DOT_17_NINES, DIVIDE, "-1.99999999999999998");
//            checkBinaryOperation(NEG_ZERO_DOT_17_NINES, NEG_ZERO_DOT_16_NINES, DIVIDE, "-1.99999999999999989");
//            checkBinaryOperation(NEG_ZERO_DOT_17_NINES, NEG_NINETY_NINE_HUNDREDTH, DIVIDE, "-1.98999999999999999");
//            checkBinaryOperation(NEG_ZERO_DOT_17_NINES, NEG_NINE_TENTH, DIVIDE, "-1.89999999999999999");
//            checkBinaryOperation(NEG_ZERO_DOT_17_NINES, NEG_ONE_TENTH, DIVIDE, "-1.09999999999999999");
//            checkBinaryOperation(NEG_ZERO_DOT_17_NINES, NEG_NINE_HUNDREDTH, DIVIDE, "-1.08999999999999999");
//            checkBinaryOperation(NEG_ZERO_DOT_17_NINES, NEG_ONE_HUNDREDTH, DIVIDE, "-1.00999999999999999");
//
//            checkBinaryOperation(NEG_ZERO_DOT_17_NINES, ONE_HUNDREDTH, DIVIDE, "-0.98999999999999999");
//            checkBinaryOperation(NEG_ZERO_DOT_17_NINES, NINE_HUNDREDTH, DIVIDE, "-0.90999999999999999");
//            checkBinaryOperation(NEG_ZERO_DOT_17_NINES, ONE_TENTH, DIVIDE, "-0.89999999999999999");
//            checkBinaryOperation(NEG_ZERO_DOT_17_NINES, NINE_TENTH, DIVIDE, "-0.09999999999999999");
//            checkBinaryOperation(NEG_ZERO_DOT_17_NINES, NINETY_NINE_HUNDREDTH, DIVIDE, "-0.00999999999999999");
//            checkBinaryOperation(NEG_ZERO_DOT_17_NINES, ZERO_DOT_16_NINES, DIVIDE, "-0.00000000000000009");
//            checkBinaryOperation(NEG_ZERO_DOT_17_NINES, ZERO_DOT_17_NINES, DIVIDE, "0.00000000000000000");
//
//            //first is -0.9999999999999999
//            checkBinaryOperation(NEG_ZERO_DOT_16_NINES, NEG_ZERO_DOT_17_NINES, DIVIDE, "-1.99999999999999998");
//            checkBinaryOperation(NEG_ZERO_DOT_16_NINES, NEG_ZERO_DOT_16_NINES, DIVIDE, "-1.9999999999999998");
//            checkBinaryOperation(NEG_ZERO_DOT_16_NINES, NEG_NINETY_NINE_HUNDREDTH, DIVIDE, "-1.9899999999999999");
//            checkBinaryOperation(NEG_ZERO_DOT_16_NINES, NEG_NINE_TENTH, DIVIDE, "-1.8999999999999999");
//            checkBinaryOperation(NEG_ZERO_DOT_16_NINES, NEG_ONE_TENTH, DIVIDE, "-1.0999999999999999");
//            checkBinaryOperation(NEG_ZERO_DOT_16_NINES, NEG_NINE_HUNDREDTH, DIVIDE, "-1.0899999999999999");
//            checkBinaryOperation(NEG_ZERO_DOT_16_NINES, NEG_ONE_HUNDREDTH, DIVIDE, "-1.0099999999999999");
//
//            checkBinaryOperation(NEG_ZERO_DOT_16_NINES, ONE_HUNDREDTH, DIVIDE, "-0.9899999999999999");
//            checkBinaryOperation(NEG_ZERO_DOT_16_NINES, NINE_HUNDREDTH, DIVIDE, "-0.9099999999999999");
//            checkBinaryOperation(NEG_ZERO_DOT_16_NINES, ONE_TENTH, DIVIDE, "-0.8999999999999999");
//            checkBinaryOperation(NEG_ZERO_DOT_16_NINES, NINE_TENTH, DIVIDE, "-0.0999999999999999");
//            checkBinaryOperation(NEG_ZERO_DOT_16_NINES, NINETY_NINE_HUNDREDTH, DIVIDE, "-0.0099999999999999");
//            checkBinaryOperation(NEG_ZERO_DOT_16_NINES, ZERO_DOT_16_NINES, DIVIDE, "0.0000000000000000");
//            checkBinaryOperation(NEG_ZERO_DOT_16_NINES, ZERO_DOT_17_NINES, DIVIDE, "0.00000000000000009");
//
//            //first is -0.99
//            checkBinaryOperation(NEG_NINETY_NINE_HUNDREDTH, NEG_ZERO_DOT_17_NINES, DIVIDE, "-1.99999999999999998");
//            checkBinaryOperation(NEG_NINETY_NINE_HUNDREDTH, NEG_ZERO_DOT_16_NINES, DIVIDE, "-1.9999999999999998");
//            checkBinaryOperation(NEG_NINETY_NINE_HUNDREDTH, NEG_NINETY_NINE_HUNDREDTH, DIVIDE, "-1.98");
//            checkBinaryOperation(NEG_NINETY_NINE_HUNDREDTH, NEG_NINE_TENTH, DIVIDE, "-1.89");
//            checkBinaryOperation(NEG_NINETY_NINE_HUNDREDTH, NEG_ONE_TENTH, DIVIDE, "-1.09");
//            checkBinaryOperation(NEG_NINETY_NINE_HUNDREDTH, NEG_NINE_HUNDREDTH, DIVIDE, "-1.08");
//            checkBinaryOperation(NEG_NINETY_NINE_HUNDREDTH, NEG_ONE_HUNDREDTH, DIVIDE, "-1.00");
//
//            checkBinaryOperation(NEG_NINETY_NINE_HUNDREDTH, ONE_HUNDREDTH, DIVIDE, "-0.98");
//            checkBinaryOperation(NEG_NINETY_NINE_HUNDREDTH, NINE_HUNDREDTH, DIVIDE, "-0.90");
//            checkBinaryOperation(NEG_NINETY_NINE_HUNDREDTH, ONE_TENTH, DIVIDE, "-0.89");
//            checkBinaryOperation(NEG_NINETY_NINE_HUNDREDTH, NINE_TENTH, DIVIDE, "-0.09");
//            checkBinaryOperation(NEG_NINETY_NINE_HUNDREDTH, NINETY_NINE_HUNDREDTH, DIVIDE, "0.00");
//            checkBinaryOperation(NEG_NINETY_NINE_HUNDREDTH, ZERO_DOT_16_NINES, DIVIDE, "0.0099999999999999");
//            checkBinaryOperation(NEG_NINETY_NINE_HUNDREDTH, ZERO_DOT_17_NINES, DIVIDE, "0.00999999999999999");
//
//            //first is -0.9
//            checkBinaryOperation(NEG_NINE_TENTH, NEG_ZERO_DOT_17_NINES, DIVIDE, "-1.99999999999999998");
//            checkBinaryOperation(NEG_NINE_TENTH, NEG_ZERO_DOT_16_NINES, DIVIDE, "-1.9999999999999998");
//            checkBinaryOperation(NEG_NINE_TENTH, NEG_NINETY_NINE_HUNDREDTH, DIVIDE, "-1.98");
//            checkBinaryOperation(NEG_NINE_TENTH, NEG_NINE_TENTH, DIVIDE, "-1.8");
//            checkBinaryOperation(NEG_NINE_TENTH, NEG_ONE_TENTH, DIVIDE, "-1.0");
//            checkBinaryOperation(NEG_NINE_TENTH, NEG_NINE_HUNDREDTH, DIVIDE, "-0.99");
//            checkBinaryOperation(NEG_NINE_TENTH, NEG_ONE_HUNDREDTH, DIVIDE, "-0.91");
//
//            checkBinaryOperation(NEG_NINE_TENTH, ONE_HUNDREDTH, DIVIDE, "-0.89");
//            checkBinaryOperation(NEG_NINE_TENTH, NINE_HUNDREDTH, DIVIDE, "-0.81");
//            checkBinaryOperation(NEG_NINE_TENTH, ONE_TENTH, DIVIDE, "-0.8");
//            checkBinaryOperation(NEG_NINE_TENTH, NINE_TENTH, DIVIDE, "0.0");
//            checkBinaryOperation(NEG_NINE_TENTH, NINETY_NINE_HUNDREDTH, DIVIDE, "0.09");
//            checkBinaryOperation(NEG_NINE_TENTH, ZERO_DOT_16_NINES, DIVIDE, "0.0999999999999999");
//            checkBinaryOperation(NEG_NINE_TENTH, ZERO_DOT_17_NINES, DIVIDE, "0.09999999999999999");
//
//            //first is -0.1
//            checkBinaryOperation(NEG_ONE_TENTH, NEG_ZERO_DOT_17_NINES, DIVIDE, "-1.99999999999999998");
//            checkBinaryOperation(NEG_ONE_TENTH, NEG_ZERO_DOT_16_NINES, DIVIDE, "-1.9999999999999998");
//            checkBinaryOperation(NEG_ONE_TENTH, NEG_NINETY_NINE_HUNDREDTH, DIVIDE, "-1.98");
//            checkBinaryOperation(NEG_ONE_TENTH, NEG_NINE_TENTH, DIVIDE, "-1.8");
//            checkBinaryOperation(NEG_ONE_TENTH, NEG_ONE_TENTH, DIVIDE, "-0.2");
//            checkBinaryOperation(NEG_ONE_TENTH, NEG_NINE_HUNDREDTH, DIVIDE, "-0.19");
//            checkBinaryOperation(NEG_ONE_TENTH, NEG_ONE_HUNDREDTH, DIVIDE, "-0.11");
//
//            checkBinaryOperation(NEG_ONE_TENTH, ONE_HUNDREDTH, DIVIDE, "-0.09");
//            checkBinaryOperation(NEG_ONE_TENTH, NINE_HUNDREDTH, DIVIDE, "-0.01");
//            checkBinaryOperation(NEG_ONE_TENTH, ONE_TENTH, DIVIDE, "0.0");
//            checkBinaryOperation(NEG_ONE_TENTH, NINE_TENTH, DIVIDE, "0.8");
//            checkBinaryOperation(NEG_ONE_TENTH, NINETY_NINE_HUNDREDTH, DIVIDE, "0.89");
//            checkBinaryOperation(NEG_ONE_TENTH, ZERO_DOT_16_NINES, DIVIDE, "0.8999999999999999");
//            checkBinaryOperation(NEG_ONE_TENTH, ZERO_DOT_17_NINES, DIVIDE, "0.89999999999999999");
//
//            //first is -0.09
//            checkBinaryOperation(NEG_NINE_HUNDREDTH, NEG_ZERO_DOT_17_NINES, DIVIDE, "-1.99999999999999998");
//            checkBinaryOperation(NEG_NINE_HUNDREDTH, NEG_ZERO_DOT_16_NINES, DIVIDE, "-1.9999999999999998");
//            checkBinaryOperation(NEG_NINE_HUNDREDTH, NEG_NINETY_NINE_HUNDREDTH, DIVIDE, "-1.98");
//            checkBinaryOperation(NEG_NINE_HUNDREDTH, NEG_NINE_TENTH, DIVIDE, "-1.8");
//            checkBinaryOperation(NEG_NINE_HUNDREDTH, NEG_ONE_TENTH, DIVIDE, "-0.2");
//            checkBinaryOperation(NEG_NINE_HUNDREDTH, NEG_NINE_HUNDREDTH, DIVIDE, "-0.18");
//            checkBinaryOperation(NEG_NINE_HUNDREDTH, NEG_ONE_HUNDREDTH, DIVIDE, "-0.10");
//
//            checkBinaryOperation(NEG_NINE_HUNDREDTH, ONE_HUNDREDTH, DIVIDE, "-0.08");
//            checkBinaryOperation(NEG_NINE_HUNDREDTH, NINE_HUNDREDTH, DIVIDE, "0.00");
//            checkBinaryOperation(NEG_NINE_HUNDREDTH, ONE_TENTH, DIVIDE, "0.01");
//            checkBinaryOperation(NEG_NINE_HUNDREDTH, NINE_TENTH, DIVIDE, "0.81");
//            checkBinaryOperation(NEG_NINE_HUNDREDTH, NINETY_NINE_HUNDREDTH, DIVIDE, "0.90");
//            checkBinaryOperation(NEG_NINE_HUNDREDTH, ZERO_DOT_16_NINES, DIVIDE, "0.9099999999999999");
//            checkBinaryOperation(NEG_NINE_HUNDREDTH, ZERO_DOT_17_NINES, DIVIDE, "0.90999999999999999");
//
//            //first is -0.01
//            checkBinaryOperation(NEG_ONE_HUNDREDTH, NEG_ZERO_DOT_17_NINES, DIVIDE, "-1.99999999999999998");
//            checkBinaryOperation(NEG_ONE_HUNDREDTH, NEG_ZERO_DOT_16_NINES, DIVIDE, "-1.9999999999999998");
//            checkBinaryOperation(NEG_ONE_HUNDREDTH, NEG_NINETY_NINE_HUNDREDTH, DIVIDE, "-1.98");
//            checkBinaryOperation(NEG_ONE_HUNDREDTH, NEG_NINE_TENTH, DIVIDE, "-1.8");
//            checkBinaryOperation(NEG_ONE_HUNDREDTH, NEG_ONE_TENTH, DIVIDE, "-0.2");
//            checkBinaryOperation(NEG_ONE_HUNDREDTH, NEG_NINE_HUNDREDTH, DIVIDE, "-0.18");
//            checkBinaryOperation(NEG_ONE_HUNDREDTH, NEG_ONE_HUNDREDTH, DIVIDE, "-0.02");
//
//            checkBinaryOperation(NEG_ONE_HUNDREDTH, ONE_HUNDREDTH, DIVIDE, "0.00");
//            checkBinaryOperation(NEG_ONE_HUNDREDTH, NINE_HUNDREDTH, DIVIDE, "0.08");
//            checkBinaryOperation(NEG_ONE_HUNDREDTH, ONE_TENTH, DIVIDE, "0.09");
//            checkBinaryOperation(NEG_ONE_HUNDREDTH, NINE_TENTH, DIVIDE, "0.89");
//            checkBinaryOperation(NEG_ONE_HUNDREDTH, NINETY_NINE_HUNDREDTH, DIVIDE, "0.98");
//            checkBinaryOperation(NEG_ONE_HUNDREDTH, ZERO_DOT_16_NINES, DIVIDE, "0.9899999999999999");
//            checkBinaryOperation(NEG_ONE_HUNDREDTH, ZERO_DOT_17_NINES, DIVIDE, "0.98999999999999999");
//
//            //first is 0.01
//            checkBinaryOperation(ONE_HUNDREDTH, NEG_ZERO_DOT_17_NINES, DIVIDE, "-1.99999999999999998");
//            checkBinaryOperation(ONE_HUNDREDTH, NEG_ZERO_DOT_16_NINES, DIVIDE, "-1.9999999999999998");
//            checkBinaryOperation(ONE_HUNDREDTH, NEG_NINETY_NINE_HUNDREDTH, DIVIDE, "-1.98");
//            checkBinaryOperation(ONE_HUNDREDTH, NEG_NINE_TENTH, DIVIDE, "-1.8");
//            checkBinaryOperation(ONE_HUNDREDTH, NEG_ONE_TENTH, DIVIDE, "-0.2");
//            checkBinaryOperation(ONE_HUNDREDTH, NEG_NINE_HUNDREDTH, DIVIDE, "-0.18");
//            checkBinaryOperation(ONE_HUNDREDTH, NEG_ONE_HUNDREDTH, DIVIDE, "-0.02");
//
//            checkBinaryOperation(ONE_HUNDREDTH, ONE_HUNDREDTH, DIVIDE, "0.02");
//            checkBinaryOperation(ONE_HUNDREDTH, NINE_HUNDREDTH, DIVIDE, "0.10");
//            checkBinaryOperation(ONE_HUNDREDTH, ONE_TENTH, DIVIDE, "0.11");
//            checkBinaryOperation(ONE_HUNDREDTH, NINE_TENTH, DIVIDE, "0.91");
//            checkBinaryOperation(ONE_HUNDREDTH, NINETY_NINE_HUNDREDTH, DIVIDE, "1.00");
//            checkBinaryOperation(ONE_HUNDREDTH, ZERO_DOT_16_NINES, DIVIDE, "1.0099999999999999");
//            checkBinaryOperation(ONE_HUNDREDTH, ZERO_DOT_17_NINES, DIVIDE, "1.00999999999999999");
//
//            //first is 0.09
//            checkBinaryOperation(NINE_HUNDREDTH, NEG_ZERO_DOT_17_NINES, DIVIDE, "-1.99999999999999998");
//            checkBinaryOperation(NINE_HUNDREDTH, NEG_ZERO_DOT_16_NINES, DIVIDE, "-1.9999999999999998");
//            checkBinaryOperation(NINE_HUNDREDTH, NEG_NINETY_NINE_HUNDREDTH, DIVIDE, "-1.98");
//            checkBinaryOperation(NINE_HUNDREDTH, NEG_NINE_TENTH, DIVIDE, "-1.8");
//            checkBinaryOperation(NINE_HUNDREDTH, NEG_ONE_TENTH, DIVIDE, "-0.2");
//            checkBinaryOperation(NINE_HUNDREDTH, NEG_NINE_HUNDREDTH, DIVIDE, "-0.18");
//            checkBinaryOperation(NINE_HUNDREDTH, NEG_ONE_HUNDREDTH, DIVIDE, "-0.02");
//
//            checkBinaryOperation(NINE_HUNDREDTH, ONE_HUNDREDTH, DIVIDE, "0.02");
//            checkBinaryOperation(NINE_HUNDREDTH, NINE_HUNDREDTH, DIVIDE, "0.18");
//            checkBinaryOperation(NINE_HUNDREDTH, ONE_TENTH, DIVIDE, "0.19");
//            checkBinaryOperation(NINE_HUNDREDTH, NINE_TENTH, DIVIDE, "0.99");
//            checkBinaryOperation(NINE_HUNDREDTH, NINETY_NINE_HUNDREDTH, DIVIDE, "1.08");
//            checkBinaryOperation(NINE_HUNDREDTH, ZERO_DOT_16_NINES, DIVIDE, "1.0899999999999999");
//            checkBinaryOperation(NINE_HUNDREDTH, ZERO_DOT_17_NINES, DIVIDE, "1.08999999999999999");
//
//            //first is 0.1
//            checkBinaryOperation(ONE_TENTH, NEG_ZERO_DOT_17_NINES, DIVIDE, "-1.99999999999999998");
//            checkBinaryOperation(ONE_TENTH, NEG_ZERO_DOT_16_NINES, DIVIDE, "-1.9999999999999998");
//            checkBinaryOperation(ONE_TENTH, NEG_NINETY_NINE_HUNDREDTH, DIVIDE, "-1.98");
//            checkBinaryOperation(ONE_TENTH, NEG_NINE_TENTH, DIVIDE, "-1.8");
//            checkBinaryOperation(ONE_TENTH, NEG_ONE_TENTH, DIVIDE, "-0.2");
//            checkBinaryOperation(ONE_TENTH, NEG_NINE_HUNDREDTH, DIVIDE, "-0.18");
//            checkBinaryOperation(ONE_TENTH, NEG_ONE_HUNDREDTH, DIVIDE, "-0.02");
//
//            checkBinaryOperation(ONE_TENTH, ONE_HUNDREDTH, DIVIDE, "0.02");
//            checkBinaryOperation(ONE_TENTH, NINE_HUNDREDTH, DIVIDE, "0.18");
//            checkBinaryOperation(ONE_TENTH, ONE_TENTH, DIVIDE, "0.2");
//            checkBinaryOperation(ONE_TENTH, NINE_TENTH, DIVIDE, "1.0");
//            checkBinaryOperation(ONE_TENTH, NINETY_NINE_HUNDREDTH, DIVIDE, "1.09");
//            checkBinaryOperation(ONE_TENTH, ZERO_DOT_16_NINES, DIVIDE, "1.0999999999999999");
//            checkBinaryOperation(ONE_TENTH, ZERO_DOT_17_NINES, DIVIDE, "1.09999999999999999");
//
//            //first is 0.9
//            checkBinaryOperation(NINE_TENTH, NEG_ZERO_DOT_17_NINES, DIVIDE, "-1.99999999999999998");
//            checkBinaryOperation(NINE_TENTH, NEG_ZERO_DOT_16_NINES, DIVIDE, "-1.9999999999999998");
//            checkBinaryOperation(NINE_TENTH, NEG_NINETY_NINE_HUNDREDTH, DIVIDE, "-1.98");
//            checkBinaryOperation(NINE_TENTH, NEG_NINE_TENTH, DIVIDE, "-1.8");
//            checkBinaryOperation(NINE_TENTH, NEG_ONE_TENTH, DIVIDE, "-0.2");
//            checkBinaryOperation(NINE_TENTH, NEG_NINE_HUNDREDTH, DIVIDE, "-0.18");
//            checkBinaryOperation(NINE_TENTH, NEG_ONE_HUNDREDTH, DIVIDE, "-0.02");
//
//            checkBinaryOperation(NINE_TENTH, ONE_HUNDREDTH, DIVIDE, "0.02");
//            checkBinaryOperation(NINE_TENTH, NINE_HUNDREDTH, DIVIDE, "0.18");
//            checkBinaryOperation(NINE_TENTH, ONE_TENTH, DIVIDE, "0.2");
//            checkBinaryOperation(NINE_TENTH, NINE_TENTH, DIVIDE, "1.8");
//            checkBinaryOperation(NINE_TENTH, NINETY_NINE_HUNDREDTH, DIVIDE, "1.89");
//            checkBinaryOperation(NINE_TENTH, ZERO_DOT_16_NINES, DIVIDE, "1.8999999999999999");
//            checkBinaryOperation(NINE_TENTH, ZERO_DOT_17_NINES, DIVIDE, "1.89999999999999999");
//
//            //first is 0.99
//            checkBinaryOperation(NINETY_NINE_HUNDREDTH, NEG_ZERO_DOT_17_NINES, DIVIDE, "-1.99999999999999998");
//            checkBinaryOperation(NINETY_NINE_HUNDREDTH, NEG_ZERO_DOT_16_NINES, DIVIDE, "-1.9999999999999998");
//            checkBinaryOperation(NINETY_NINE_HUNDREDTH, NEG_NINETY_NINE_HUNDREDTH, DIVIDE, "-1.98");
//            checkBinaryOperation(NINETY_NINE_HUNDREDTH, NEG_NINE_TENTH, DIVIDE, "-1.8");
//            checkBinaryOperation(NINETY_NINE_HUNDREDTH, NEG_ONE_TENTH, DIVIDE, "-0.2");
//            checkBinaryOperation(NINETY_NINE_HUNDREDTH, NEG_NINE_HUNDREDTH, DIVIDE, "-0.18");
//            checkBinaryOperation(NINETY_NINE_HUNDREDTH, NEG_ONE_HUNDREDTH, DIVIDE, "-0.02");
//
//            checkBinaryOperation(NINETY_NINE_HUNDREDTH, ONE_HUNDREDTH, DIVIDE, "0.02");
//            checkBinaryOperation(NINETY_NINE_HUNDREDTH, NINE_HUNDREDTH, DIVIDE, "0.18");
//            checkBinaryOperation(NINETY_NINE_HUNDREDTH, ONE_TENTH, DIVIDE, "0.2");
//            checkBinaryOperation(NINETY_NINE_HUNDREDTH, NINE_TENTH, DIVIDE, "1.8");
//            checkBinaryOperation(NINETY_NINE_HUNDREDTH, NINETY_NINE_HUNDREDTH, DIVIDE, "1.98");
//            checkBinaryOperation(NINETY_NINE_HUNDREDTH, ZERO_DOT_16_NINES, DIVIDE, "1.9899999999999999");
//            checkBinaryOperation(NINETY_NINE_HUNDREDTH, ZERO_DOT_17_NINES, DIVIDE, "1.98999999999999999");
//
//            //first is 0.9999999999999999
//            checkBinaryOperation(ZERO_DOT_16_NINES, NEG_ZERO_DOT_17_NINES, DIVIDE, "-1.99999999999999998");
//            checkBinaryOperation(ZERO_DOT_16_NINES, NEG_ZERO_DOT_16_NINES, DIVIDE, "-1.9999999999999998");
//            checkBinaryOperation(ZERO_DOT_16_NINES, NEG_NINETY_NINE_HUNDREDTH, DIVIDE, "-1.98");
//            checkBinaryOperation(ZERO_DOT_16_NINES, NEG_NINE_TENTH, DIVIDE, "-1.8");
//            checkBinaryOperation(ZERO_DOT_16_NINES, NEG_ONE_TENTH, DIVIDE, "-0.2");
//            checkBinaryOperation(ZERO_DOT_16_NINES, NEG_NINE_HUNDREDTH, DIVIDE, "-0.18");
//            checkBinaryOperation(ZERO_DOT_16_NINES, NEG_ONE_HUNDREDTH, DIVIDE, "-0.02");
//
//            checkBinaryOperation(ZERO_DOT_16_NINES, ONE_HUNDREDTH, DIVIDE, "0.02");
//            checkBinaryOperation(ZERO_DOT_16_NINES, NINE_HUNDREDTH, DIVIDE, "0.18");
//            checkBinaryOperation(ZERO_DOT_16_NINES, ONE_TENTH, DIVIDE, "0.2");
//            checkBinaryOperation(ZERO_DOT_16_NINES, NINE_TENTH, DIVIDE, "1.8");
//            checkBinaryOperation(ZERO_DOT_16_NINES, NINETY_NINE_HUNDREDTH, DIVIDE, "1.98");
//            checkBinaryOperation(ZERO_DOT_16_NINES, ZERO_DOT_16_NINES, DIVIDE, "1.9999999999999998");
//            checkBinaryOperation(ZERO_DOT_16_NINES, ZERO_DOT_17_NINES, DIVIDE, "1.99999999999999989");
//
//            //first is 0.99999999999999999
//            checkBinaryOperation(ZERO_DOT_17_NINES, NEG_ZERO_DOT_17_NINES, DIVIDE, "-1.99999999999999998");
//            checkBinaryOperation(ZERO_DOT_17_NINES, NEG_ZERO_DOT_16_NINES, DIVIDE, "-1.9999999999999998");
//            checkBinaryOperation(ZERO_DOT_17_NINES, NEG_NINETY_NINE_HUNDREDTH, DIVIDE, "-1.98");
//            checkBinaryOperation(ZERO_DOT_17_NINES, NEG_NINE_TENTH, DIVIDE, "-1.8");
//            checkBinaryOperation(ZERO_DOT_17_NINES, NEG_ONE_TENTH, DIVIDE, "-0.2");
//            checkBinaryOperation(ZERO_DOT_17_NINES, NEG_NINE_HUNDREDTH, DIVIDE, "-0.18");
//            checkBinaryOperation(ZERO_DOT_17_NINES, NEG_ONE_HUNDREDTH, DIVIDE, "-0.02");
//
//            checkBinaryOperation(ZERO_DOT_17_NINES, ONE_HUNDREDTH, DIVIDE, "0.02");
//            checkBinaryOperation(ZERO_DOT_17_NINES, NINE_HUNDREDTH, DIVIDE, "0.18");
//            checkBinaryOperation(ZERO_DOT_17_NINES, ONE_TENTH, DIVIDE, "0.2");
//            checkBinaryOperation(ZERO_DOT_17_NINES, NINE_TENTH, DIVIDE, "1.8");
//            checkBinaryOperation(ZERO_DOT_17_NINES, NINETY_NINE_HUNDREDTH, DIVIDE, "1.98");
//            checkBinaryOperation(ZERO_DOT_17_NINES, ZERO_DOT_16_NINES, DIVIDE, "1.9999999999999998");
//            checkBinaryOperation(ZERO_DOT_17_NINES, ZERO_DOT_17_NINES, DIVIDE, "1.99999999999999998");
//        }
//
//        //engineer numbers
//        //with engineer numbers
//        {
//            //first is -1.E+9999
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9999, NEG_ONE_DOT_E_PLUS_9999, DIVIDE, "-2.E+9999");
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9999, NEG_ONE_DOT_E_PLUS_9998, DIVIDE, "-1.1E+9999");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9999, ONE_DOT_E_PLUS_9998, DIVIDE, "-9.E+9998");
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9999, ONE_DOT_E_PLUS_9999, DIVIDE, "0.E+9999");
//
//            //first is -1.E+9998
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9998, NEG_ONE_DOT_E_PLUS_9999, DIVIDE, "-2.E+9999");
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9998, NEG_ONE_DOT_E_PLUS_9998, DIVIDE, "-2.E+9998");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9998, ONE_DOT_E_PLUS_9998, DIVIDE, "0.E+9998");
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9998, ONE_DOT_E_PLUS_9999, DIVIDE, "9.E+9998");
//
//            //first is 1.E+9998
//            checkBinaryOperation(ONE_DOT_E_PLUS_9998, NEG_ONE_DOT_E_PLUS_9999, DIVIDE, "-2.E+9999");
//            checkBinaryOperation(ONE_DOT_E_PLUS_9998, NEG_ONE_DOT_E_PLUS_9998, DIVIDE, "-2.E+9998");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_9998, ONE_DOT_E_PLUS_9998, DIVIDE, "2.E+9998");
//            checkBinaryOperation(ONE_DOT_E_PLUS_9998, ONE_DOT_E_PLUS_9999, DIVIDE, "1.1E+9999");
//
//            //first is 1.E+9999
//            checkBinaryOperation(ONE_DOT_E_PLUS_9999, NEG_ONE_DOT_E_PLUS_9999, DIVIDE, "-2.E+9999");
//            checkBinaryOperation(ONE_DOT_E_PLUS_9999, NEG_ONE_DOT_E_PLUS_9998, DIVIDE, "-2.E+9998");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_9999, ONE_DOT_E_PLUS_9998, DIVIDE, "2.E+9998");
//            checkBinaryOperation(ONE_DOT_E_PLUS_9999, ONE_DOT_E_PLUS_9999, DIVIDE, "2.E+9999");
//
//            //first is -1.E+17
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_17, NEG_ONE_DOT_E_PLUS_17, DIVIDE, "-2.E+17");
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_17, NEG_ONE_DOT_E_PLUS_16, DIVIDE, "-1.1E+17");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_17, ONE_DOT_E_PLUS_16, DIVIDE, "-9.E+16");
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_17, ONE_DOT_E_PLUS_17, DIVIDE, "0.E+17");
//
//            //first is -1.E+16
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_16, NEG_ONE_DOT_E_PLUS_17, DIVIDE, "-2.E+17");
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_16, NEG_ONE_DOT_E_PLUS_16, DIVIDE, "-2.E+16");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_16, ONE_DOT_E_PLUS_16, DIVIDE, "0.E+16");
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_16, ONE_DOT_E_PLUS_17, DIVIDE, "9.E+16");
//
//            //first is 1.E+16
//            checkBinaryOperation(ONE_DOT_E_PLUS_16, NEG_ONE_DOT_E_PLUS_17, DIVIDE, "-2.E+17");
//            checkBinaryOperation(ONE_DOT_E_PLUS_16, ONE_DOT_E_PLUS_16, DIVIDE, "0.E+16");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_16, ONE_DOT_E_PLUS_16, DIVIDE, "2.E+16");
//            checkBinaryOperation(ONE_DOT_E_PLUS_16, ONE_DOT_E_PLUS_17, DIVIDE, "1.1E+17");
//
//            //first is 1.E+17
//            checkBinaryOperation(ONE_DOT_E_PLUS_17, NEG_ONE_DOT_E_PLUS_17, DIVIDE, "-2.E+17");
//            checkBinaryOperation(ONE_DOT_E_PLUS_17, ONE_DOT_E_PLUS_16, DIVIDE, "0.E+16");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_17, ONE_DOT_E_PLUS_16, DIVIDE, "2.E+16");
//            checkBinaryOperation(ONE_DOT_E_PLUS_17, ONE_DOT_E_PLUS_17, DIVIDE, "2.E+17");
//
//            //first is -1.E-9999
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9999, NEG_ONE_DOT_E_MINUS_9999, DIVIDE, "-2.E-9999");
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9999, NEG_ONE_DOT_E_MINUS_9998, DIVIDE, "-1.1E-9998");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9999, ONE_DOT_E_MINUS_9998, DIVIDE, "9.E-9999");
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9999, ONE_DOT_E_MINUS_9999, DIVIDE, "0.E-9999");
//
//            //first is -1.E-9998
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9998, NEG_ONE_DOT_E_MINUS_9999, DIVIDE, "-2.E-9999");
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9998, NEG_ONE_DOT_E_MINUS_9998, DIVIDE, "-2E-9998");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9998, ONE_DOT_E_MINUS_9998, DIVIDE, "0.E-9998");
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9998, ONE_DOT_E_MINUS_9999, DIVIDE, "-9.E-9999");
//
//            //first is 1.E-9998
//            checkBinaryOperation(ONE_DOT_E_MINUS_9998, NEG_ONE_DOT_E_MINUS_9999, DIVIDE, "-2.E-9999");
//            checkBinaryOperation(ONE_DOT_E_MINUS_9998, NEG_ONE_DOT_E_MINUS_9998, DIVIDE, "-2E-9998");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_9998, ONE_DOT_E_MINUS_9998, DIVIDE, "2.E-9998");
//            checkBinaryOperation(ONE_DOT_E_MINUS_9998, ONE_DOT_E_MINUS_9999, DIVIDE, "1.1E-9998");
//
//            //first is 1.E-9999
//            checkBinaryOperation(ONE_DOT_E_MINUS_9999, NEG_ONE_DOT_E_MINUS_9999, DIVIDE, "-2.E-9999");
//            checkBinaryOperation(ONE_DOT_E_MINUS_9999, NEG_ONE_DOT_E_MINUS_9998, DIVIDE, "-2E-9998");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_9999, ONE_DOT_E_MINUS_9998, DIVIDE, "2.E-9998");
//            checkBinaryOperation(ONE_DOT_E_MINUS_9999, ONE_DOT_E_MINUS_9999, DIVIDE, "2.E-9999");
//
//            //first is -1.E-17
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_17, NEG_ONE_DOT_E_MINUS_17, DIVIDE, "-2.E-17");
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_17, NEG_ONE_DOT_E_MINUS_16, DIVIDE, "-1.1E-16");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_17, ONE_DOT_E_MINUS_16, DIVIDE, "9.E-17");
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_17, ONE_DOT_E_MINUS_17, DIVIDE, "0.E-17");
//
//            //first is -1.E-16
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_16, NEG_ONE_DOT_E_MINUS_17, DIVIDE, "-2.E-17");
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_16, NEG_ONE_DOT_E_MINUS_16, DIVIDE, "-2E-16");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_16, ONE_DOT_E_MINUS_16, DIVIDE, "0.E-16");
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_16, ONE_DOT_E_MINUS_17, DIVIDE, "-9.E-17");
//
//            //first is 1.E-16
//            checkBinaryOperation(ONE_DOT_E_MINUS_16, NEG_ONE_DOT_E_MINUS_17, DIVIDE, "-2.E-17");
//            checkBinaryOperation(ONE_DOT_E_MINUS_16, NEG_ONE_DOT_E_MINUS_16, DIVIDE, "-2E-16");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_16, ONE_DOT_E_MINUS_16, DIVIDE, "2.E-16");
//            checkBinaryOperation(ONE_DOT_E_MINUS_16, ONE_DOT_E_MINUS_17, DIVIDE, "1.1E-16");
//
//            //first is 1.E-17
//            checkBinaryOperation(ONE_DOT_E_MINUS_17, NEG_ONE_DOT_E_MINUS_17, DIVIDE, "-2.E-17");
//            checkBinaryOperation(ONE_DOT_E_MINUS_17, NEG_ONE_DOT_E_MINUS_16, DIVIDE, "-2E-16");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_17, ONE_DOT_E_MINUS_16, DIVIDE, "2.E-16");
//            checkBinaryOperation(ONE_DOT_E_MINUS_17, ONE_DOT_E_MINUS_17, DIVIDE, "2.E-17");
//        }
//
//        //with integers
//        {
//            //first is -1.E+9999 (and vice versa)
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9999, MIN_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "-110000000000000000");
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_MINUS_ONE, NEG_ONE_DOT_E_PLUS_9999, DIVIDE, "-110000000000000000");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9999, MIN_VALUE_ON_SCREEN, DIVIDE, "-109999999999999999");
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN, NEG_ONE_DOT_E_PLUS_9999, DIVIDE, "-109999999999999999");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9999, MIN_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "-109999999999999998");
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_PLUS_ONE, NEG_ONE_DOT_E_PLUS_9999, DIVIDE, "-109999999999999998");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9999, HALF_MIN_VALUE_ON_SCREEN, DIVIDE, "-105000000000000000");
//            checkBinaryOperation(HALF_MIN_VALUE_ON_SCREEN, NEG_ONE_DOT_E_PLUS_9999, DIVIDE, "-105000000000000000");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9999, NEG_HUNDRED, DIVIDE, "-100000000000000100");
//            checkBinaryOperation(NEG_HUNDRED, NEG_ONE_DOT_E_PLUS_9999, DIVIDE, "-100000000000000100");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9999, NEG_TEN, DIVIDE, "-100000000000000010");
//            checkBinaryOperation(NEG_TEN, NEG_ONE_DOT_E_PLUS_9999, DIVIDE, "-100000000000000010");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9999, NEG_ONE, DIVIDE, "-100000000000000001");
//            checkBinaryOperation(NEG_ONE, NEG_ONE_DOT_E_PLUS_9999, DIVIDE, "-100000000000000001");
//
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9999, BigDecimal.ZERO, DIVIDE, "-100000000000000000");
//            checkBinaryOperation(BigDecimal.ZERO, NEG_ONE_DOT_E_PLUS_9999, DIVIDE, "-100000000000000000");
//
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9999, BigDecimal.ONE, DIVIDE, "-99999999999999999");
//            checkBinaryOperation(BigDecimal.ONE, NEG_ONE_DOT_E_PLUS_9999, DIVIDE, "-99999999999999999");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9999, BigDecimal.TEN, DIVIDE, "-99999999999999990");
//            checkBinaryOperation(BigDecimal.TEN, NEG_ONE_DOT_E_PLUS_9999, DIVIDE, "-99999999999999990");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9999, HUNDRED, DIVIDE, "-99999999999999900");
//            checkBinaryOperation(HUNDRED, NEG_ONE_DOT_E_PLUS_9999, DIVIDE, "-99999999999999900");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9999, HALF_MAX_VALUE_ON_SCREEN, DIVIDE, "-95000000000000000");
//            checkBinaryOperation(HALF_MAX_VALUE_ON_SCREEN, NEG_ONE_DOT_E_PLUS_9999, DIVIDE, "-95000000000000000");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9999, MAX_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "-90000000000000002");
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_MINUS_ONE, NEG_ONE_DOT_E_PLUS_9999, DIVIDE, "-90000000000000002");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9999, MAX_VALUE_ON_SCREEN, DIVIDE, "-90000000000000001");
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN, NEG_ONE_DOT_E_PLUS_9999, DIVIDE, "-90000000000000001");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9999, MAX_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "-90000000000000000");
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_PLUS_ONE, NEG_ONE_DOT_E_PLUS_9999, DIVIDE, "-90000000000000000");
//
//
//            //first is -1.E+9998 (and vice versa)
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9998, MIN_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "-20000000000000000");
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_MINUS_ONE, NEG_ONE_DOT_E_PLUS_9998, DIVIDE, "-20000000000000000");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9998, MIN_VALUE_ON_SCREEN, DIVIDE, "-19999999999999999");
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN, NEG_ONE_DOT_E_PLUS_9998, DIVIDE, "-19999999999999999");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9998, MIN_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "-19999999999999998");
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_PLUS_ONE, NEG_ONE_DOT_E_PLUS_9998, DIVIDE, "-19999999999999998");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9998, HALF_MIN_VALUE_ON_SCREEN, DIVIDE, "-15000000000000000");
//            checkBinaryOperation(HALF_MIN_VALUE_ON_SCREEN, NEG_ONE_DOT_E_PLUS_9998, DIVIDE, "-15000000000000000");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9998, NEG_HUNDRED, DIVIDE, "-10000000000000100");
//            checkBinaryOperation(NEG_HUNDRED, NEG_ONE_DOT_E_PLUS_9998, DIVIDE, "-10000000000000100");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9998, NEG_TEN, DIVIDE, "-10000000000000010");
//            checkBinaryOperation(NEG_TEN, NEG_ONE_DOT_E_PLUS_9998, DIVIDE, "-10000000000000010");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9998, NEG_ONE, DIVIDE, "-10000000000000001");
//            checkBinaryOperation(NEG_ONE, NEG_ONE_DOT_E_PLUS_9998, DIVIDE, "-10000000000000001");
//
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9998, BigDecimal.ZERO, DIVIDE, "-10000000000000000");
//            checkBinaryOperation(BigDecimal.ZERO, NEG_ONE_DOT_E_PLUS_9998, DIVIDE, "-10000000000000000");
//
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9998, BigDecimal.ONE, DIVIDE, "-9999999999999999");
//            checkBinaryOperation(BigDecimal.ONE, NEG_ONE_DOT_E_PLUS_9998, DIVIDE, "-9999999999999999");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9998, BigDecimal.TEN, DIVIDE, "-9999999999999990");
//            checkBinaryOperation(BigDecimal.TEN, NEG_ONE_DOT_E_PLUS_9998, DIVIDE, "-9999999999999990");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9998, HUNDRED, DIVIDE, "-9999999999999900");
//            checkBinaryOperation(HUNDRED, NEG_ONE_DOT_E_PLUS_9998, DIVIDE, "-9999999999999900");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9998, HALF_MAX_VALUE_ON_SCREEN, DIVIDE, "-5000000000000000");
//            checkBinaryOperation(HALF_MAX_VALUE_ON_SCREEN, NEG_ONE_DOT_E_PLUS_9998, DIVIDE, "-5000000000000000");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9998, MAX_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "-2");
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_MINUS_ONE, NEG_ONE_DOT_E_PLUS_9998, DIVIDE, "-2");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9998, MAX_VALUE_ON_SCREEN, DIVIDE, "-1");
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN, NEG_ONE_DOT_E_PLUS_9998, DIVIDE, "-1");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9998, MAX_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "0");
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_PLUS_ONE, NEG_ONE_DOT_E_PLUS_9998, DIVIDE, "0");
//
//
//            //first is 1.E+9998 (and vice versa)
//            checkBinaryOperation(ONE_DOT_E_PLUS_9998, MIN_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "0");
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_MINUS_ONE, ONE_DOT_E_PLUS_9998, DIVIDE, "0");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_9998, MIN_VALUE_ON_SCREEN, DIVIDE, "1");
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN, ONE_DOT_E_PLUS_9998, DIVIDE, "1");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_9998, MIN_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "2");
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_PLUS_ONE, ONE_DOT_E_PLUS_9998, DIVIDE, "2");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_9998, HALF_MIN_VALUE_ON_SCREEN, DIVIDE, "5000000000000000");
//            checkBinaryOperation(HALF_MIN_VALUE_ON_SCREEN, ONE_DOT_E_PLUS_9998, DIVIDE, "5000000000000000");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_9998, NEG_HUNDRED, DIVIDE, "9999999999999900");
//            checkBinaryOperation(NEG_HUNDRED, ONE_DOT_E_PLUS_9998, DIVIDE, "9999999999999900");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_9998, NEG_TEN, DIVIDE, "9999999999999990");
//            checkBinaryOperation(NEG_TEN, ONE_DOT_E_PLUS_9998, DIVIDE, "9999999999999990");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_9998, NEG_ONE, DIVIDE, "9999999999999999");
//            checkBinaryOperation(NEG_ONE, ONE_DOT_E_PLUS_9998, DIVIDE, "9999999999999999");
//
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_9998, BigDecimal.ZERO, DIVIDE, "10000000000000000");
//            checkBinaryOperation(BigDecimal.ZERO, ONE_DOT_E_PLUS_9998, DIVIDE, "10000000000000000");
//
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_9998, BigDecimal.ONE, DIVIDE, "10000000000000001");
//            checkBinaryOperation(BigDecimal.ONE, ONE_DOT_E_PLUS_9998, DIVIDE, "10000000000000001");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_9998, BigDecimal.TEN, DIVIDE, "10000000000000010");
//            checkBinaryOperation(BigDecimal.TEN, ONE_DOT_E_PLUS_9998, DIVIDE, "10000000000000010");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_9998, HUNDRED, DIVIDE, "10000000000000100");
//            checkBinaryOperation(HUNDRED, ONE_DOT_E_PLUS_9998, DIVIDE, "10000000000000100");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_9998, HALF_MAX_VALUE_ON_SCREEN, DIVIDE, "15000000000000000");
//            checkBinaryOperation(HALF_MAX_VALUE_ON_SCREEN, ONE_DOT_E_PLUS_9998, DIVIDE, "15000000000000000");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_9998, MAX_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "19999999999999998");
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_MINUS_ONE, ONE_DOT_E_PLUS_9998, DIVIDE, "19999999999999998");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_9998, MAX_VALUE_ON_SCREEN, DIVIDE, "19999999999999999");
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN, ONE_DOT_E_PLUS_9998, DIVIDE, "19999999999999999");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_9998, MAX_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "20000000000000000");
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_PLUS_ONE, ONE_DOT_E_PLUS_9998, DIVIDE, "20000000000000000");
//
//
//            //first is 1.E+9999 (and vice versa)
//            checkBinaryOperation(ONE_DOT_E_PLUS_9999, MIN_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "90000000000000000");
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_MINUS_ONE, ONE_DOT_E_PLUS_9999, DIVIDE, "90000000000000000");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_9999, MIN_VALUE_ON_SCREEN, DIVIDE, "90000000000000001");
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN, ONE_DOT_E_PLUS_9999, DIVIDE, "90000000000000001");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_9999, MIN_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "90000000000000002");
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_PLUS_ONE, ONE_DOT_E_PLUS_9999, DIVIDE, "90000000000000002");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_9999, HALF_MIN_VALUE_ON_SCREEN, DIVIDE, "95000000000000000");
//            checkBinaryOperation(HALF_MIN_VALUE_ON_SCREEN, ONE_DOT_E_PLUS_9999, DIVIDE, "95000000000000000");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_9999, NEG_HUNDRED, DIVIDE, "99999999999999900");
//            checkBinaryOperation(NEG_HUNDRED, ONE_DOT_E_PLUS_9999, DIVIDE, "99999999999999900");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_9999, NEG_TEN, DIVIDE, "99999999999999990");
//            checkBinaryOperation(NEG_TEN, ONE_DOT_E_PLUS_9999, DIVIDE, "99999999999999990");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_9999, NEG_ONE, DIVIDE, "99999999999999999");
//            checkBinaryOperation(NEG_ONE, ONE_DOT_E_PLUS_9999, DIVIDE, "99999999999999999");
//
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_9999, BigDecimal.ZERO, DIVIDE, "100000000000000000");
//            checkBinaryOperation(BigDecimal.ZERO, ONE_DOT_E_PLUS_9999, DIVIDE, "100000000000000000");
//
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_9999, BigDecimal.ONE, DIVIDE, "100000000000000001");
//            checkBinaryOperation(BigDecimal.ONE, ONE_DOT_E_PLUS_9999, DIVIDE, "100000000000000001");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_9999, BigDecimal.TEN, DIVIDE, "100000000000000010");
//            checkBinaryOperation(BigDecimal.TEN, ONE_DOT_E_PLUS_9999, DIVIDE, "100000000000000010");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_9999, HUNDRED, DIVIDE, "100000000000000100");
//            checkBinaryOperation(HUNDRED, ONE_DOT_E_PLUS_9999, DIVIDE, "100000000000000100");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_9999, HALF_MAX_VALUE_ON_SCREEN, DIVIDE, "105000000000000000");
//            checkBinaryOperation(HALF_MAX_VALUE_ON_SCREEN, ONE_DOT_E_PLUS_9999, DIVIDE, "105000000000000000");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_9999, MAX_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "109999999999999998");
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_MINUS_ONE, ONE_DOT_E_PLUS_9999, DIVIDE, "109999999999999998");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_9999, MAX_VALUE_ON_SCREEN, DIVIDE, "109999999999999999");
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN, ONE_DOT_E_PLUS_9999, DIVIDE, "109999999999999999");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_9999, MAX_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "110000000000000000");
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_PLUS_ONE, ONE_DOT_E_PLUS_9999, DIVIDE, "110000000000000000");
//
//
//            //first is -1.E+17 (and vice versa)
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_17, MIN_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "-110000000000000000");
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_MINUS_ONE, NEG_ONE_DOT_E_PLUS_17, DIVIDE, "-110000000000000000");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_17, MIN_VALUE_ON_SCREEN, DIVIDE, "-109999999999999999");
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN, NEG_ONE_DOT_E_PLUS_17, DIVIDE, "-109999999999999999");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_17, MIN_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "-109999999999999998");
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_PLUS_ONE, NEG_ONE_DOT_E_PLUS_17, DIVIDE, "-109999999999999998");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_17, HALF_MIN_VALUE_ON_SCREEN, DIVIDE, "-105000000000000000");
//            checkBinaryOperation(HALF_MIN_VALUE_ON_SCREEN, NEG_ONE_DOT_E_PLUS_17, DIVIDE, "-105000000000000000");
//
//            checkBinaryOperation(NEG_HUNDRED, NEG_ONE_DOT_E_PLUS_17, DIVIDE, "-100000000000000100");
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_17, NEG_HUNDRED, DIVIDE, "-100000000000000100");
//
//            checkBinaryOperation(NEG_TEN, NEG_ONE_DOT_E_PLUS_17, DIVIDE, "-100000000000000010");
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_17, NEG_TEN, DIVIDE, "-100000000000000010");
//
//            checkBinaryOperation(NEG_ONE, NEG_ONE_DOT_E_PLUS_17, DIVIDE, "-100000000000000001");
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_17, NEG_ONE, DIVIDE, "-100000000000000001");
//
//
//            checkBinaryOperation(BigDecimal.ZERO, NEG_ONE_DOT_E_PLUS_17, DIVIDE, "-100000000000000000");
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_17, BigDecimal.ZERO, DIVIDE, "-100000000000000000");
//
//
//            checkBinaryOperation(BigDecimal.ONE, NEG_ONE_DOT_E_PLUS_17, DIVIDE, "-99999999999999999");
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_17, BigDecimal.ONE, DIVIDE, "-99999999999999999");
//
//            checkBinaryOperation(BigDecimal.TEN, NEG_ONE_DOT_E_PLUS_17, DIVIDE, "-99999999999999990");
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_17, BigDecimal.TEN, DIVIDE, "-99999999999999990");
//
//            checkBinaryOperation(HUNDRED, NEG_ONE_DOT_E_PLUS_17, DIVIDE, "-99999999999999900");
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_17, HUNDRED, DIVIDE, "-99999999999999900");
//
//            checkBinaryOperation(HALF_MAX_VALUE_ON_SCREEN, NEG_ONE_DOT_E_PLUS_17, DIVIDE, "-95000000000000000");
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_17, HALF_MAX_VALUE_ON_SCREEN, DIVIDE, "-95000000000000000");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_17, MAX_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "-90000000000000002");
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_MINUS_ONE, NEG_ONE_DOT_E_PLUS_17, DIVIDE, "-90000000000000002");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_17, MAX_VALUE_ON_SCREEN, DIVIDE, "-90000000000000001");
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN, NEG_ONE_DOT_E_PLUS_17, DIVIDE, "-90000000000000001");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_17, MAX_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "-90000000000000000");
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_PLUS_ONE, NEG_ONE_DOT_E_PLUS_17, DIVIDE, "-90000000000000000");
//
//
//            //first is -1.E+16 (and vice versa)
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_16, MIN_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "-20000000000000000");
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_MINUS_ONE, NEG_ONE_DOT_E_PLUS_16, DIVIDE, "-20000000000000000");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_16, MIN_VALUE_ON_SCREEN, DIVIDE, "-19999999999999999");
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN, NEG_ONE_DOT_E_PLUS_16, DIVIDE, "-19999999999999999");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_16, MIN_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "-19999999999999998");
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_PLUS_ONE, NEG_ONE_DOT_E_PLUS_16, DIVIDE, "-19999999999999998");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_16, HALF_MIN_VALUE_ON_SCREEN, DIVIDE, "-15000000000000000");
//            checkBinaryOperation(HALF_MIN_VALUE_ON_SCREEN, NEG_ONE_DOT_E_PLUS_16, DIVIDE, "-15000000000000000");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_16, NEG_HUNDRED, DIVIDE, "-10000000000000100");
//            checkBinaryOperation(NEG_HUNDRED, NEG_ONE_DOT_E_PLUS_16, DIVIDE, "-10000000000000100");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_16, NEG_TEN, DIVIDE, "-10000000000000010");
//            checkBinaryOperation(NEG_TEN, NEG_ONE_DOT_E_PLUS_16, DIVIDE, "-10000000000000010");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_16, NEG_ONE, DIVIDE, "-10000000000000001");
//            checkBinaryOperation(NEG_ONE, NEG_ONE_DOT_E_PLUS_16, DIVIDE, "-10000000000000001");
//
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_16, BigDecimal.ZERO, DIVIDE, "-10000000000000000");
//            checkBinaryOperation(BigDecimal.ZERO, NEG_ONE_DOT_E_PLUS_16, DIVIDE, "-10000000000000000");
//
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_16, BigDecimal.ONE, DIVIDE, "-9999999999999999");
//            checkBinaryOperation(BigDecimal.ONE, NEG_ONE_DOT_E_PLUS_16, DIVIDE, "-9999999999999999");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_16, BigDecimal.TEN, DIVIDE, "-9999999999999990");
//            checkBinaryOperation(BigDecimal.TEN, NEG_ONE_DOT_E_PLUS_16, DIVIDE, "-9999999999999990");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_16, HUNDRED, DIVIDE, "-9999999999999900");
//            checkBinaryOperation(HUNDRED, NEG_ONE_DOT_E_PLUS_16, DIVIDE, "-9999999999999900");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_16, HALF_MAX_VALUE_ON_SCREEN, DIVIDE, "-5000000000000000");
//            checkBinaryOperation(HALF_MAX_VALUE_ON_SCREEN, NEG_ONE_DOT_E_PLUS_16, DIVIDE, "-5000000000000000");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_16, MAX_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "-2");
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_MINUS_ONE, NEG_ONE_DOT_E_PLUS_16, DIVIDE, "-2");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_16, MAX_VALUE_ON_SCREEN, DIVIDE, "-1");
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN, NEG_ONE_DOT_E_PLUS_16, DIVIDE, "-1");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_16, MAX_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "0");
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_PLUS_ONE, NEG_ONE_DOT_E_PLUS_16, DIVIDE, "0");
//
//
//            //first is 1.E+16 (and vice versa)
//            checkBinaryOperation(ONE_DOT_E_PLUS_16, MIN_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "0");
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_MINUS_ONE, ONE_DOT_E_PLUS_16, DIVIDE, "0");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_16, MIN_VALUE_ON_SCREEN, DIVIDE, "1");
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN, ONE_DOT_E_PLUS_16, DIVIDE, "1");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_16, MIN_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "2");
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_PLUS_ONE, ONE_DOT_E_PLUS_16, DIVIDE, "2");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_16, HALF_MIN_VALUE_ON_SCREEN, DIVIDE, "5000000000000000");
//            checkBinaryOperation(HALF_MIN_VALUE_ON_SCREEN, ONE_DOT_E_PLUS_16, DIVIDE, "5000000000000000");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_16, NEG_HUNDRED, DIVIDE, "9999999999999900");
//            checkBinaryOperation(NEG_HUNDRED, ONE_DOT_E_PLUS_16, DIVIDE, "9999999999999900");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_16, NEG_TEN, DIVIDE, "9999999999999990");
//            checkBinaryOperation(NEG_TEN, ONE_DOT_E_PLUS_16, DIVIDE, "9999999999999990");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_16, NEG_ONE, DIVIDE, "9999999999999999");
//            checkBinaryOperation(NEG_ONE, ONE_DOT_E_PLUS_16, DIVIDE, "9999999999999999");
//
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_16, BigDecimal.ZERO, DIVIDE, "10000000000000000");
//            checkBinaryOperation(BigDecimal.ZERO, ONE_DOT_E_PLUS_16, DIVIDE, "10000000000000000");
//
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_16, BigDecimal.ONE, DIVIDE, "10000000000000001");
//            checkBinaryOperation(BigDecimal.ONE, ONE_DOT_E_PLUS_16, DIVIDE, "10000000000000001");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_16, BigDecimal.TEN, DIVIDE, "10000000000000010");
//            checkBinaryOperation(BigDecimal.TEN, ONE_DOT_E_PLUS_16, DIVIDE, "10000000000000010");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_16, HUNDRED, DIVIDE, "10000000000000100");
//            checkBinaryOperation(HUNDRED, ONE_DOT_E_PLUS_16, DIVIDE, "10000000000000100");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_16, HALF_MAX_VALUE_ON_SCREEN, DIVIDE, "15000000000000000");
//            checkBinaryOperation(HALF_MAX_VALUE_ON_SCREEN, ONE_DOT_E_PLUS_16, DIVIDE, "15000000000000000");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_16, MAX_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "19999999999999998");
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_MINUS_ONE, ONE_DOT_E_PLUS_16, DIVIDE, "19999999999999998");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_16, MAX_VALUE_ON_SCREEN, DIVIDE, "19999999999999999");
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN, ONE_DOT_E_PLUS_16, DIVIDE, "19999999999999999");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_16, MAX_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "20000000000000000");
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_PLUS_ONE, ONE_DOT_E_PLUS_16, DIVIDE, "20000000000000000");
//
//
//            //first is 1.E+17 (and vice versa)
//            checkBinaryOperation(ONE_DOT_E_PLUS_17, MIN_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "90000000000000000");
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_MINUS_ONE, ONE_DOT_E_PLUS_17, DIVIDE, "90000000000000000");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_17, MIN_VALUE_ON_SCREEN, DIVIDE, "90000000000000001");
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN, ONE_DOT_E_PLUS_17, DIVIDE, "90000000000000001");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_17, MIN_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "90000000000000002");
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_PLUS_ONE, ONE_DOT_E_PLUS_17, DIVIDE, "90000000000000002");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_17, HALF_MIN_VALUE_ON_SCREEN, DIVIDE, "95000000000000000");
//            checkBinaryOperation(HALF_MIN_VALUE_ON_SCREEN, ONE_DOT_E_PLUS_17, DIVIDE, "95000000000000000");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_17, NEG_HUNDRED, DIVIDE, "99999999999999900");
//            checkBinaryOperation(NEG_HUNDRED, ONE_DOT_E_PLUS_17, DIVIDE, "99999999999999900");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_17, NEG_TEN, DIVIDE, "99999999999999990");
//            checkBinaryOperation(NEG_TEN, ONE_DOT_E_PLUS_17, DIVIDE, "99999999999999990");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_17, NEG_ONE, DIVIDE, "99999999999999999");
//            checkBinaryOperation(NEG_ONE, ONE_DOT_E_PLUS_17, DIVIDE, "99999999999999999");
//
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_17, BigDecimal.ZERO, DIVIDE, "100000000000000000");
//            checkBinaryOperation(BigDecimal.ZERO, ONE_DOT_E_PLUS_17, DIVIDE, "100000000000000000");
//
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_17, BigDecimal.ONE, DIVIDE, "100000000000000001");
//            checkBinaryOperation(BigDecimal.ONE, ONE_DOT_E_PLUS_17, DIVIDE, "100000000000000001");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_17, BigDecimal.TEN, DIVIDE, "100000000000000010");
//            checkBinaryOperation(BigDecimal.TEN, ONE_DOT_E_PLUS_17, DIVIDE, "100000000000000010");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_17, HUNDRED, DIVIDE, "100000000000000100");
//            checkBinaryOperation(HUNDRED, ONE_DOT_E_PLUS_17, DIVIDE, "100000000000000100");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_17, HALF_MAX_VALUE_ON_SCREEN, DIVIDE, "105000000000000000");
//            checkBinaryOperation(HALF_MAX_VALUE_ON_SCREEN, ONE_DOT_E_PLUS_17, DIVIDE, "105000000000000000");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_17, MAX_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "109999999999999998");
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_MINUS_ONE, ONE_DOT_E_PLUS_17, DIVIDE, "109999999999999998");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_17, MAX_VALUE_ON_SCREEN, DIVIDE, "109999999999999999");
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN, ONE_DOT_E_PLUS_17, DIVIDE, "109999999999999999");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_17, MAX_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "110000000000000000");
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_PLUS_ONE, ONE_DOT_E_PLUS_17, DIVIDE, "110000000000000000");
//
//
//            //first is -1.E-9999 (and vice versa)
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9999, MIN_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "-10000000000000000.00000000000000001");
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_MINUS_ONE, NEG_ONE_DOT_E_MINUS_9999, DIVIDE, "-10000000000000000.00000000000000001");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9999, MIN_VALUE_ON_SCREEN, DIVIDE, "-9999999999999999.00000000000000001");
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN, NEG_ONE_DOT_E_MINUS_9999, DIVIDE, "-9999999999999999.00000000000000001");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9999, MIN_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "-9999999999999998.00000000000000001");
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_PLUS_ONE, NEG_ONE_DOT_E_MINUS_9999, DIVIDE, "-9999999999999998.00000000000000001");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9999, HALF_MIN_VALUE_ON_SCREEN, DIVIDE, "-5000000000000000.00000000000000001");
//            checkBinaryOperation(HALF_MIN_VALUE_ON_SCREEN, NEG_ONE_DOT_E_MINUS_9999, DIVIDE, "-5000000000000000.00000000000000001");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9999, NEG_HUNDRED, DIVIDE, "-100.00000000000000001");
//            checkBinaryOperation(NEG_HUNDRED, NEG_ONE_DOT_E_MINUS_9999, DIVIDE, "-100.00000000000000001");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9999, NEG_TEN, DIVIDE, "-10.00000000000000001");
//            checkBinaryOperation(NEG_TEN, NEG_ONE_DOT_E_MINUS_9999, DIVIDE, "-10.00000000000000001");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9999, NEG_ONE, DIVIDE, "-1.00000000000000001");
//            checkBinaryOperation(NEG_ONE, NEG_ONE_DOT_E_MINUS_9999, DIVIDE, "-1.00000000000000001");
//
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9999, BigDecimal.ZERO, DIVIDE, "-1.E-17");
//            checkBinaryOperation(BigDecimal.ZERO, NEG_ONE_DOT_E_MINUS_9999, DIVIDE, "-1.E-17");
//
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9999, BigDecimal.ONE, DIVIDE, "0.99999999999999999");
//            checkBinaryOperation(BigDecimal.ONE, NEG_ONE_DOT_E_MINUS_9999, DIVIDE, "0.99999999999999999");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9999, BigDecimal.TEN, DIVIDE, "9.99999999999999999");
//            checkBinaryOperation(BigDecimal.TEN, NEG_ONE_DOT_E_MINUS_9999, DIVIDE, "9.99999999999999999");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9999, HUNDRED, DIVIDE, "99.99999999999999999");
//            checkBinaryOperation(HUNDRED, NEG_ONE_DOT_E_MINUS_9999, DIVIDE, "99.99999999999999999");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9999, HALF_MAX_VALUE_ON_SCREEN, DIVIDE, "4999999999999999.99999999999999999");
//            checkBinaryOperation(HALF_MAX_VALUE_ON_SCREEN, NEG_ONE_DOT_E_MINUS_9999, DIVIDE, "4999999999999999.99999999999999999");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9999, MAX_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "9999999999999997.99999999999999999");
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_MINUS_ONE, NEG_ONE_DOT_E_MINUS_9999, DIVIDE, "9999999999999997.99999999999999999");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9999, MAX_VALUE_ON_SCREEN, DIVIDE, "9999999999999998.99999999999999999");
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN, NEG_ONE_DOT_E_MINUS_9999, DIVIDE, "9999999999999998.99999999999999999");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9999, MAX_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "9999999999999999.99999999999999999");
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_PLUS_ONE, NEG_ONE_DOT_E_MINUS_9999, DIVIDE, "9999999999999999.99999999999999999");
//
//
//            //first is -1.E-9998 (and vice versa)
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9998, MIN_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "-10000000000000000.0000000000000001");
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_MINUS_ONE, NEG_ONE_DOT_E_MINUS_9998, DIVIDE, "-10000000000000000.0000000000000001");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9998, MIN_VALUE_ON_SCREEN, DIVIDE, "-9999999999999999.0000000000000001");
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN, NEG_ONE_DOT_E_MINUS_9998, DIVIDE, "-9999999999999999.0000000000000001");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9998, MIN_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "-9999999999999998.0000000000000001");
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_PLUS_ONE, NEG_ONE_DOT_E_MINUS_9998, DIVIDE, "-9999999999999998.0000000000000001");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9998, HALF_MIN_VALUE_ON_SCREEN, DIVIDE, "-5000000000000000.0000000000000001");
//            checkBinaryOperation(HALF_MIN_VALUE_ON_SCREEN, NEG_ONE_DOT_E_MINUS_9998, DIVIDE, "-5000000000000000.0000000000000001");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9998, NEG_HUNDRED, DIVIDE, "-100.0000000000000001");
//            checkBinaryOperation(NEG_HUNDRED, NEG_ONE_DOT_E_MINUS_9998, DIVIDE, "-100.0000000000000001");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9998, NEG_TEN, DIVIDE, "-10.0000000000000001");
//            checkBinaryOperation(NEG_TEN, NEG_ONE_DOT_E_MINUS_9998, DIVIDE, "-10.0000000000000001");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9998, NEG_ONE, DIVIDE, "-1.0000000000000001");
//            checkBinaryOperation(NEG_ONE, NEG_ONE_DOT_E_MINUS_9998, DIVIDE, "-1.0000000000000001");
//
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9998, BigDecimal.ZERO, DIVIDE, "-1.E-16");
//            checkBinaryOperation(BigDecimal.ZERO, NEG_ONE_DOT_E_MINUS_9998, DIVIDE, "-1.E-16");
//
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9998, BigDecimal.ONE, DIVIDE, "0.9999999999999999");
//            checkBinaryOperation(BigDecimal.ONE, NEG_ONE_DOT_E_MINUS_9998, DIVIDE, "0.9999999999999999");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9998, BigDecimal.TEN, DIVIDE, "9.9999999999999999");
//            checkBinaryOperation(BigDecimal.TEN, NEG_ONE_DOT_E_MINUS_9998, DIVIDE, "9.9999999999999999");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9998, HUNDRED, DIVIDE, "99.9999999999999999");
//            checkBinaryOperation(HUNDRED, NEG_ONE_DOT_E_MINUS_9998, DIVIDE, "99.9999999999999999");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9998, HALF_MAX_VALUE_ON_SCREEN, DIVIDE, "4999999999999999.9999999999999999");
//            checkBinaryOperation(HALF_MAX_VALUE_ON_SCREEN, NEG_ONE_DOT_E_MINUS_9998, DIVIDE, "4999999999999999.9999999999999999");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9998, MAX_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "9999999999999997.9999999999999999");
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_MINUS_ONE, NEG_ONE_DOT_E_MINUS_9998, DIVIDE, "9999999999999997.9999999999999999");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9998, MAX_VALUE_ON_SCREEN, DIVIDE, "9999999999999998.9999999999999999");
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN, NEG_ONE_DOT_E_MINUS_9998, DIVIDE, "9999999999999998.9999999999999999");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9998, MAX_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "9999999999999999.9999999999999999");
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_PLUS_ONE, NEG_ONE_DOT_E_MINUS_9998, DIVIDE, "9999999999999999.9999999999999999");
//
//
//            //first is 1.E-9998 (and vice versa)
//            checkBinaryOperation(ONE_DOT_E_MINUS_9998, MIN_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "-9999999999999999.9999999999999999");
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_MINUS_ONE, ONE_DOT_E_MINUS_9998, DIVIDE, "-9999999999999999.9999999999999999");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_9998, MIN_VALUE_ON_SCREEN, DIVIDE, "-9999999999999998.9999999999999999");
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN, ONE_DOT_E_MINUS_9998, DIVIDE, "-9999999999999998.9999999999999999");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_9998, MIN_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "-9999999999999997.9999999999999999");
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_PLUS_ONE, ONE_DOT_E_MINUS_9998, DIVIDE, "-9999999999999997.9999999999999999");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_9998, HALF_MIN_VALUE_ON_SCREEN, DIVIDE, "-4999999999999999.9999999999999999");
//            checkBinaryOperation(HALF_MIN_VALUE_ON_SCREEN, ONE_DOT_E_MINUS_9998, DIVIDE, "-4999999999999999.9999999999999999");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_9998, NEG_HUNDRED, DIVIDE, "-99.9999999999999999");
//            checkBinaryOperation(NEG_HUNDRED, ONE_DOT_E_MINUS_9998, DIVIDE, "-99.9999999999999999");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_9998, NEG_TEN, DIVIDE, "-9.9999999999999999");
//            checkBinaryOperation(NEG_TEN, ONE_DOT_E_MINUS_9998, DIVIDE, "-9.9999999999999999");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_9998, NEG_ONE, DIVIDE, "-0.9999999999999999");
//            checkBinaryOperation(NEG_ONE, ONE_DOT_E_MINUS_9998, DIVIDE, "-0.9999999999999999");
//
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_9998, BigDecimal.ZERO, DIVIDE, "1.E-16");
//            checkBinaryOperation(BigDecimal.ZERO, ONE_DOT_E_MINUS_9998, DIVIDE, "1.E-16");
//
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_9998, BigDecimal.ONE, DIVIDE, "1.0000000000000001");
//            checkBinaryOperation(BigDecimal.ONE, ONE_DOT_E_MINUS_9998, DIVIDE, "1.0000000000000001");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_9998, BigDecimal.TEN, DIVIDE, "10.0000000000000001");
//            checkBinaryOperation(BigDecimal.TEN, ONE_DOT_E_MINUS_9998, DIVIDE, "10.0000000000000001");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_9998, HUNDRED, DIVIDE, "100.0000000000000001");
//            checkBinaryOperation(HUNDRED, ONE_DOT_E_MINUS_9998, DIVIDE, "100.0000000000000001");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_9998, HALF_MAX_VALUE_ON_SCREEN, DIVIDE, "5000000000000000.0000000000000001");
//            checkBinaryOperation(HALF_MAX_VALUE_ON_SCREEN, ONE_DOT_E_MINUS_9998, DIVIDE, "5000000000000000.0000000000000001");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_9998, MAX_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "9999999999999998.0000000000000001");
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_MINUS_ONE, ONE_DOT_E_MINUS_9998, DIVIDE, "9999999999999998.0000000000000001");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_9998, MAX_VALUE_ON_SCREEN, DIVIDE, "9999999999999999.0000000000000001");
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN, ONE_DOT_E_MINUS_9998, DIVIDE, "9999999999999999.0000000000000001");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_9998, MAX_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "10000000000000000.0000000000000001");
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_PLUS_ONE, ONE_DOT_E_MINUS_9998, DIVIDE, "10000000000000000.0000000000000001");
//
//
//            //first is 1.E-9999 (and vice versa)
//            checkBinaryOperation(ONE_DOT_E_MINUS_9999, MIN_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "-9999999999999999.99999999999999999");
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_MINUS_ONE, ONE_DOT_E_MINUS_9999, DIVIDE, "-9999999999999999.99999999999999999");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_9999, MIN_VALUE_ON_SCREEN, DIVIDE, "-9999999999999998.99999999999999999");
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN, ONE_DOT_E_MINUS_9999, DIVIDE, "-9999999999999998.99999999999999999");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_9999, MIN_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "-9999999999999997.99999999999999999");
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_PLUS_ONE, ONE_DOT_E_MINUS_9999, DIVIDE, "-9999999999999997.99999999999999999");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_9999, HALF_MIN_VALUE_ON_SCREEN, DIVIDE, "-4999999999999999.99999999999999999");
//            checkBinaryOperation(HALF_MIN_VALUE_ON_SCREEN, ONE_DOT_E_MINUS_9999, DIVIDE, "-4999999999999999.99999999999999999");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_9999, NEG_HUNDRED, DIVIDE, "-99.99999999999999999");
//            checkBinaryOperation(NEG_HUNDRED, ONE_DOT_E_MINUS_9999, DIVIDE, "-99.99999999999999999");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_9999, NEG_TEN, DIVIDE, "-9.99999999999999999");
//            checkBinaryOperation(NEG_TEN, ONE_DOT_E_MINUS_9999, DIVIDE, "-9.99999999999999999");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_9999, NEG_ONE, DIVIDE, "-0.99999999999999999");
//            checkBinaryOperation(NEG_ONE, ONE_DOT_E_MINUS_9999, DIVIDE, "-0.99999999999999999");
//
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_9999, BigDecimal.ZERO, DIVIDE, "1.E-17");
//            checkBinaryOperation(BigDecimal.ZERO, ONE_DOT_E_MINUS_9999, DIVIDE, "1.E-17");
//
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_9999, BigDecimal.ONE, DIVIDE, "1.00000000000000001");
//            checkBinaryOperation(BigDecimal.ONE, ONE_DOT_E_MINUS_9999, DIVIDE, "1.00000000000000001");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_9999, BigDecimal.TEN, DIVIDE, "10.00000000000000001");
//            checkBinaryOperation(BigDecimal.TEN, ONE_DOT_E_MINUS_9999, DIVIDE, "10.00000000000000001");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_9999, HUNDRED, DIVIDE, "100.00000000000000001");
//            checkBinaryOperation(HUNDRED, ONE_DOT_E_MINUS_9999, DIVIDE, "100.00000000000000001");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_9999, HALF_MAX_VALUE_ON_SCREEN, DIVIDE, "5000000000000000.00000000000000001");
//            checkBinaryOperation(HALF_MAX_VALUE_ON_SCREEN, ONE_DOT_E_MINUS_9999, DIVIDE, "5000000000000000.00000000000000001");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_9999, MAX_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "9999999999999998.00000000000000001");
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_MINUS_ONE, ONE_DOT_E_MINUS_9999, DIVIDE, "9999999999999998.00000000000000001");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_9999, MAX_VALUE_ON_SCREEN, DIVIDE, "9999999999999999.00000000000000001");
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN, ONE_DOT_E_MINUS_9999, DIVIDE, "9999999999999999.00000000000000001");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_9999, MAX_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "10000000000000000.00000000000000001");
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_PLUS_ONE, ONE_DOT_E_MINUS_9999, DIVIDE, "10000000000000000.00000000000000001");
//
//
//            //first is -1.E-17 (and vice versa)
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_17, MIN_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "-10000000000000000.00000000000000001");
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_MINUS_ONE, NEG_ONE_DOT_E_MINUS_17, DIVIDE, "-10000000000000000.00000000000000001");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_17, MIN_VALUE_ON_SCREEN, DIVIDE, "-9999999999999999.00000000000000001");
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN, NEG_ONE_DOT_E_MINUS_17, DIVIDE, "-9999999999999999.00000000000000001");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_17, MIN_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "-9999999999999998.00000000000000001");
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_PLUS_ONE, NEG_ONE_DOT_E_MINUS_17, DIVIDE, "-9999999999999998.00000000000000001");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_17, HALF_MIN_VALUE_ON_SCREEN, DIVIDE, "-5000000000000000.00000000000000001");
//            checkBinaryOperation(HALF_MIN_VALUE_ON_SCREEN, NEG_ONE_DOT_E_MINUS_17, DIVIDE, "-5000000000000000.00000000000000001");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_17, NEG_HUNDRED, DIVIDE, "-100.00000000000000001");
//            checkBinaryOperation(NEG_HUNDRED, NEG_ONE_DOT_E_MINUS_17, DIVIDE, "-100.00000000000000001");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_17, NEG_TEN, DIVIDE, "-10.00000000000000001");
//            checkBinaryOperation(NEG_TEN, NEG_ONE_DOT_E_MINUS_17, DIVIDE, "-10.00000000000000001");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_17, NEG_ONE, DIVIDE, "-1.00000000000000001");
//            checkBinaryOperation(NEG_ONE, NEG_ONE_DOT_E_MINUS_17, DIVIDE, "-1.00000000000000001");
//
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_17, BigDecimal.ZERO, DIVIDE, "-1.E-17");
//            checkBinaryOperation(BigDecimal.ZERO, NEG_ONE_DOT_E_MINUS_17, DIVIDE, "-1.E-17");
//
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_17, BigDecimal.ONE, DIVIDE, "0.99999999999999999");
//            checkBinaryOperation(BigDecimal.ONE, NEG_ONE_DOT_E_MINUS_17, DIVIDE, "0.99999999999999999");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_17, BigDecimal.TEN, DIVIDE, "9.99999999999999999");
//            checkBinaryOperation(BigDecimal.TEN, NEG_ONE_DOT_E_MINUS_17, DIVIDE, "9.99999999999999999");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_17, HUNDRED, DIVIDE, "99.99999999999999999");
//            checkBinaryOperation(HUNDRED, NEG_ONE_DOT_E_MINUS_17, DIVIDE, "99.99999999999999999");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_17, HALF_MAX_VALUE_ON_SCREEN, DIVIDE, "4999999999999999.99999999999999999");
//            checkBinaryOperation(HALF_MAX_VALUE_ON_SCREEN, NEG_ONE_DOT_E_MINUS_17, DIVIDE, "4999999999999999.99999999999999999");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_17, MAX_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "9999999999999997.99999999999999999");
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_MINUS_ONE, NEG_ONE_DOT_E_MINUS_17, DIVIDE, "9999999999999997.99999999999999999");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_17, MAX_VALUE_ON_SCREEN, DIVIDE, "9999999999999998.99999999999999999");
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN, NEG_ONE_DOT_E_MINUS_17, DIVIDE, "9999999999999998.99999999999999999");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_17, MAX_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "9999999999999999.99999999999999999");
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_PLUS_ONE, NEG_ONE_DOT_E_MINUS_17, DIVIDE, "9999999999999999.99999999999999999");
//
//
//            //first is -1.E-16 (and vice versa)
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_16, MIN_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "-10000000000000000.0000000000000001");
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_MINUS_ONE, NEG_ONE_DOT_E_MINUS_16, DIVIDE, "-10000000000000000.0000000000000001");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_16, MIN_VALUE_ON_SCREEN, DIVIDE, "-9999999999999999.0000000000000001");
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN, NEG_ONE_DOT_E_MINUS_16, DIVIDE, "-9999999999999999.0000000000000001");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_16, MIN_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "-9999999999999998.0000000000000001");
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_PLUS_ONE, NEG_ONE_DOT_E_MINUS_16, DIVIDE, "-9999999999999998.0000000000000001");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_16, HALF_MIN_VALUE_ON_SCREEN, DIVIDE, "-5000000000000000.0000000000000001");
//            checkBinaryOperation(HALF_MIN_VALUE_ON_SCREEN, NEG_ONE_DOT_E_MINUS_16, DIVIDE, "-5000000000000000.0000000000000001");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_16, NEG_HUNDRED, DIVIDE, "-100.0000000000000001");
//            checkBinaryOperation(NEG_HUNDRED, NEG_ONE_DOT_E_MINUS_16, DIVIDE, "-100.0000000000000001");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_16, NEG_TEN, DIVIDE, "-10.0000000000000001");
//            checkBinaryOperation(NEG_TEN, NEG_ONE_DOT_E_MINUS_16, DIVIDE, "-10.0000000000000001");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_16, NEG_ONE, DIVIDE, "-1.0000000000000001");
//            checkBinaryOperation(NEG_ONE, NEG_ONE_DOT_E_MINUS_16, DIVIDE, "-1.0000000000000001");
//
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_16, BigDecimal.ZERO, DIVIDE, "-1.E-16");
//            checkBinaryOperation(BigDecimal.ZERO, NEG_ONE_DOT_E_MINUS_16, DIVIDE, "-1.E-16");
//
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_16, BigDecimal.ONE, DIVIDE, "0.9999999999999999");
//            checkBinaryOperation(BigDecimal.ONE, NEG_ONE_DOT_E_MINUS_16, DIVIDE, "0.9999999999999999");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_16, BigDecimal.TEN, DIVIDE, "9.9999999999999999");
//            checkBinaryOperation(BigDecimal.TEN, NEG_ONE_DOT_E_MINUS_16, DIVIDE, "9.9999999999999999");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_16, HUNDRED, DIVIDE, "99.9999999999999999");
//            checkBinaryOperation(HUNDRED, NEG_ONE_DOT_E_MINUS_16, DIVIDE, "99.9999999999999999");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_16, HALF_MAX_VALUE_ON_SCREEN, DIVIDE, "4999999999999999.9999999999999999");
//            checkBinaryOperation(HALF_MAX_VALUE_ON_SCREEN, NEG_ONE_DOT_E_MINUS_16, DIVIDE, "4999999999999999.9999999999999999");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_16, MAX_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "9999999999999997.9999999999999999");
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_MINUS_ONE, NEG_ONE_DOT_E_MINUS_16, DIVIDE, "9999999999999997.9999999999999999");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_16, MAX_VALUE_ON_SCREEN, DIVIDE, "9999999999999998.9999999999999999");
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN, NEG_ONE_DOT_E_MINUS_16, DIVIDE, "9999999999999998.9999999999999999");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_16, MAX_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "9999999999999999.9999999999999999");
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_PLUS_ONE, NEG_ONE_DOT_E_MINUS_16, DIVIDE, "9999999999999999.9999999999999999");
//
//
//            //first is 1.E-16 (and vice versa)
//            checkBinaryOperation(ONE_DOT_E_MINUS_16, MIN_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "-9999999999999999.9999999999999999");
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_MINUS_ONE, ONE_DOT_E_MINUS_16, DIVIDE, "-9999999999999999.9999999999999999");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_16, MIN_VALUE_ON_SCREEN, DIVIDE, "-9999999999999998.9999999999999999");
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN, ONE_DOT_E_MINUS_16, DIVIDE, "-9999999999999998.9999999999999999");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_16, MIN_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "-9999999999999997.9999999999999999");
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_PLUS_ONE, ONE_DOT_E_MINUS_16, DIVIDE, "-9999999999999997.9999999999999999");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_16, HALF_MIN_VALUE_ON_SCREEN, DIVIDE, "-4999999999999999.9999999999999999");
//            checkBinaryOperation(HALF_MIN_VALUE_ON_SCREEN, ONE_DOT_E_MINUS_16, DIVIDE, "-4999999999999999.9999999999999999");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_16, NEG_HUNDRED, DIVIDE, "-99.9999999999999999");
//            checkBinaryOperation(NEG_HUNDRED, ONE_DOT_E_MINUS_16, DIVIDE, "-99.9999999999999999");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_16, NEG_TEN, DIVIDE, "-9.9999999999999999");
//            checkBinaryOperation(NEG_TEN, ONE_DOT_E_MINUS_16, DIVIDE, "-9.9999999999999999");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_16, NEG_ONE, DIVIDE, "-0.9999999999999999");
//            checkBinaryOperation(NEG_ONE, ONE_DOT_E_MINUS_16, DIVIDE, "-0.9999999999999999");
//
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_16, BigDecimal.ZERO, DIVIDE, "1.E-16");
//            checkBinaryOperation(BigDecimal.ZERO, ONE_DOT_E_MINUS_16, DIVIDE, "1.E-16");
//
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_16, BigDecimal.ONE, DIVIDE, "1.0000000000000001");
//            checkBinaryOperation(BigDecimal.ONE, ONE_DOT_E_MINUS_16, DIVIDE, "1.0000000000000001");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_16, BigDecimal.TEN, DIVIDE, "10.0000000000000001");
//            checkBinaryOperation(BigDecimal.TEN, ONE_DOT_E_MINUS_16, DIVIDE, "10.0000000000000001");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_16, HUNDRED, DIVIDE, "100.0000000000000001");
//            checkBinaryOperation(HUNDRED, ONE_DOT_E_MINUS_16, DIVIDE, "100.0000000000000001");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_16, HALF_MAX_VALUE_ON_SCREEN, DIVIDE, "5000000000000000.0000000000000001");
//            checkBinaryOperation(HALF_MAX_VALUE_ON_SCREEN, ONE_DOT_E_MINUS_16, DIVIDE, "5000000000000000.0000000000000001");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_16, MAX_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "9999999999999998.0000000000000001");
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_MINUS_ONE, ONE_DOT_E_MINUS_16, DIVIDE, "9999999999999998.0000000000000001");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_16, MAX_VALUE_ON_SCREEN, DIVIDE, "9999999999999999.0000000000000001");
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN, ONE_DOT_E_MINUS_16, DIVIDE, "9999999999999999.0000000000000001");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_16, MAX_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "10000000000000000.0000000000000001");
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_PLUS_ONE, ONE_DOT_E_MINUS_16, DIVIDE, "10000000000000000.0000000000000001");
//
//
//            //first is 1.E-17 (and vice versa)
//            checkBinaryOperation(ONE_DOT_E_MINUS_17, MIN_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "-9999999999999999.99999999999999999");
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_MINUS_ONE, ONE_DOT_E_MINUS_17, DIVIDE, "-9999999999999999.99999999999999999");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_17, MIN_VALUE_ON_SCREEN, DIVIDE, "-9999999999999998.99999999999999999");
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN, ONE_DOT_E_MINUS_17, DIVIDE, "-9999999999999998.99999999999999999");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_17, MIN_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "-9999999999999997.99999999999999999");
//            checkBinaryOperation(MIN_VALUE_ON_SCREEN_PLUS_ONE, ONE_DOT_E_MINUS_17, DIVIDE, "-9999999999999997.99999999999999999");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_17, HALF_MIN_VALUE_ON_SCREEN, DIVIDE, "-4999999999999999.99999999999999999");
//            checkBinaryOperation(HALF_MIN_VALUE_ON_SCREEN, ONE_DOT_E_MINUS_17, DIVIDE, "-4999999999999999.99999999999999999");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_17, NEG_HUNDRED, DIVIDE, "-99.99999999999999999");
//            checkBinaryOperation(NEG_HUNDRED, ONE_DOT_E_MINUS_17, DIVIDE, "-99.99999999999999999");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_17, NEG_TEN, DIVIDE, "-9.99999999999999999");
//            checkBinaryOperation(NEG_TEN, ONE_DOT_E_MINUS_17, DIVIDE, "-9.99999999999999999");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_17, NEG_ONE, DIVIDE, "-0.99999999999999999");
//            checkBinaryOperation(NEG_ONE, ONE_DOT_E_MINUS_17, DIVIDE, "-0.99999999999999999");
//
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_17, BigDecimal.ZERO, DIVIDE, "1.E-17");
//            checkBinaryOperation(BigDecimal.ZERO, ONE_DOT_E_MINUS_17, DIVIDE, "1.E-17");
//
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_17, BigDecimal.ONE, DIVIDE, "1.00000000000000001");
//            checkBinaryOperation(BigDecimal.ONE, ONE_DOT_E_MINUS_17, DIVIDE, "1.00000000000000001");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_17, BigDecimal.TEN, DIVIDE, "10.00000000000000001");
//            checkBinaryOperation(BigDecimal.TEN, ONE_DOT_E_MINUS_17, DIVIDE, "10.00000000000000001");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_17, HUNDRED, DIVIDE, "100.00000000000000001");
//            checkBinaryOperation(HUNDRED, ONE_DOT_E_MINUS_17, DIVIDE, "100.00000000000000001");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_17, HALF_MAX_VALUE_ON_SCREEN, DIVIDE, "5000000000000000.00000000000000001");
//            checkBinaryOperation(HALF_MAX_VALUE_ON_SCREEN, ONE_DOT_E_MINUS_17, DIVIDE, "5000000000000000.00000000000000001");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_17, MAX_VALUE_ON_SCREEN_MINUS_ONE, DIVIDE, "9999999999999998.00000000000000001");
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_MINUS_ONE, ONE_DOT_E_MINUS_17, DIVIDE, "9999999999999998.00000000000000001");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_17, MAX_VALUE_ON_SCREEN, DIVIDE, "9999999999999999.00000000000000001");
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN, ONE_DOT_E_MINUS_17, DIVIDE, "9999999999999999.00000000000000001");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_17, MAX_VALUE_ON_SCREEN_PLUS_ONE, DIVIDE, "10000000000000000.00000000000000001");
//            checkBinaryOperation(MAX_VALUE_ON_SCREEN_PLUS_ONE, ONE_DOT_E_MINUS_17, DIVIDE, "10000000000000000.00000000000000001");
//        }
//
//        //with decimals
//        {
//            //first is -1.E+9999 (and vice versa)
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9999, NEG_ZERO_DOT_17_NINES, DIVIDE, "-100000000000000000.99999999999999999");
//            checkBinaryOperation(NEG_ZERO_DOT_17_NINES, NEG_ONE_DOT_E_PLUS_9999, DIVIDE, "-100000000000000000.99999999999999999");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9999, NEG_ZERO_DOT_16_NINES, DIVIDE, "-100000000000000000.9999999999999999");
//            checkBinaryOperation(NEG_ZERO_DOT_16_NINES, NEG_ONE_DOT_E_PLUS_9999, DIVIDE, "-100000000000000000.9999999999999999");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9999, NEG_NINETY_NINE_HUNDREDTH, DIVIDE, "-100000000000000000.99");
//            checkBinaryOperation(NEG_NINETY_NINE_HUNDREDTH, NEG_ONE_DOT_E_PLUS_9999, DIVIDE, "-100000000000000000.99");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9999, NEG_NINE_TENTH, DIVIDE, "-100000000000000000.9");
//            checkBinaryOperation(NEG_NINE_TENTH, NEG_ONE_DOT_E_PLUS_9999, DIVIDE, "-100000000000000000.9");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9999, NEG_ONE_TENTH, DIVIDE, "-100000000000000000.1");
//            checkBinaryOperation(NEG_ONE_TENTH, NEG_ONE_DOT_E_PLUS_9999, DIVIDE, "-100000000000000000.1");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9999, NEG_NINE_HUNDREDTH, DIVIDE, "-100000000000000000.09");
//            checkBinaryOperation(NEG_NINE_HUNDREDTH, NEG_ONE_DOT_E_PLUS_9999, DIVIDE, "-100000000000000000.09");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9999, NEG_ONE_HUNDREDTH, DIVIDE, "-100000000000000000.01");
//            checkBinaryOperation(NEG_ONE_HUNDREDTH, NEG_ONE_DOT_E_PLUS_9999, DIVIDE, "-100000000000000000.01");
//
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9999, ONE_HUNDREDTH, DIVIDE, "-99999999999999999.99");
//            checkBinaryOperation(ONE_HUNDREDTH, NEG_ONE_DOT_E_PLUS_9999, DIVIDE, "-99999999999999999.99");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9999, NINE_HUNDREDTH, DIVIDE, "-99999999999999999.91");
//            checkBinaryOperation(NINE_HUNDREDTH, NEG_ONE_DOT_E_PLUS_9999, DIVIDE, "-99999999999999999.91");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9999, ONE_TENTH, DIVIDE, "-99999999999999999.9");
//            checkBinaryOperation(ONE_TENTH, NEG_ONE_DOT_E_PLUS_9999, DIVIDE, "-99999999999999999.9");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9999, NINE_TENTH, DIVIDE, "-99999999999999999.1");
//            checkBinaryOperation(NINE_TENTH, NEG_ONE_DOT_E_PLUS_9999, DIVIDE, "-99999999999999999.1");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9999, NINETY_NINE_HUNDREDTH, DIVIDE, "-99999999999999999.01");
//            checkBinaryOperation(NINETY_NINE_HUNDREDTH, NEG_ONE_DOT_E_PLUS_9999, DIVIDE, "-99999999999999999.01");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9999, ZERO_DOT_16_NINES, DIVIDE, "-99999999999999999.0000000000000001");
//            checkBinaryOperation(ZERO_DOT_16_NINES, NEG_ONE_DOT_E_PLUS_9999, DIVIDE, "-99999999999999999.0000000000000001");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9999, ZERO_DOT_17_NINES, DIVIDE, "-99999999999999999.00000000000000001");
//            checkBinaryOperation(ZERO_DOT_17_NINES, NEG_ONE_DOT_E_PLUS_9999, DIVIDE, "-99999999999999999.00000000000000001");
//
//            //first is -1.E+9998 (and vice versa)
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9998, NEG_ZERO_DOT_17_NINES, DIVIDE, "-10000000000000000.99999999999999999");
//            checkBinaryOperation(NEG_ZERO_DOT_17_NINES, NEG_ONE_DOT_E_PLUS_9998, DIVIDE, "-10000000000000000.99999999999999999");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9998, NEG_ZERO_DOT_16_NINES, DIVIDE, "-10000000000000000.9999999999999999");
//            checkBinaryOperation(NEG_ZERO_DOT_16_NINES, NEG_ONE_DOT_E_PLUS_9998, DIVIDE, "-10000000000000000.9999999999999999");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9998, NEG_NINETY_NINE_HUNDREDTH, DIVIDE, "-10000000000000000.99");
//            checkBinaryOperation(NEG_NINETY_NINE_HUNDREDTH, NEG_ONE_DOT_E_PLUS_9998, DIVIDE, "-10000000000000000.99");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9998, NEG_NINE_TENTH, DIVIDE, "-10000000000000000.9");
//            checkBinaryOperation(NEG_NINE_TENTH, NEG_ONE_DOT_E_PLUS_9998, DIVIDE, "-10000000000000000.9");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9998, NEG_ONE_TENTH, DIVIDE, "-10000000000000000.1");
//            checkBinaryOperation(NEG_ONE_TENTH, NEG_ONE_DOT_E_PLUS_9998, DIVIDE, "-10000000000000000.1");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9998, NEG_NINE_HUNDREDTH, DIVIDE, "-10000000000000000.09");
//            checkBinaryOperation(NEG_NINE_HUNDREDTH, NEG_ONE_DOT_E_PLUS_9998, DIVIDE, "-10000000000000000.09");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9998, NEG_ONE_HUNDREDTH, DIVIDE, "-10000000000000000.01");
//            checkBinaryOperation(NEG_ONE_HUNDREDTH, NEG_ONE_DOT_E_PLUS_9998, DIVIDE, "-10000000000000000.01");
//
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9998, ONE_HUNDREDTH, DIVIDE, "-9999999999999999.99");
//            checkBinaryOperation(ONE_HUNDREDTH, NEG_ONE_DOT_E_PLUS_9998, DIVIDE, "-9999999999999999.99");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9998, NINE_HUNDREDTH, DIVIDE, "-9999999999999999.91");
//            checkBinaryOperation(NINE_HUNDREDTH, NEG_ONE_DOT_E_PLUS_9998, DIVIDE, "-9999999999999999.91");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9998, ONE_TENTH, DIVIDE, "-9999999999999999.9");
//            checkBinaryOperation(ONE_TENTH, NEG_ONE_DOT_E_PLUS_9998, DIVIDE, "-9999999999999999.9");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9998, NINE_TENTH, DIVIDE, "-9999999999999999.1");
//            checkBinaryOperation(NINE_TENTH, NEG_ONE_DOT_E_PLUS_9998, DIVIDE, "-9999999999999999.1");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9998, NINETY_NINE_HUNDREDTH, DIVIDE, "-9999999999999999.01");
//            checkBinaryOperation(NINETY_NINE_HUNDREDTH, NEG_ONE_DOT_E_PLUS_9998, DIVIDE, "-9999999999999999.01");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9998, ZERO_DOT_16_NINES, DIVIDE, "-9999999999999999.0000000000000001");
//            checkBinaryOperation(ZERO_DOT_16_NINES, NEG_ONE_DOT_E_PLUS_9998, DIVIDE, "-9999999999999999.0000000000000001");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_9998, ZERO_DOT_17_NINES, DIVIDE, "-9999999999999999.00000000000000001");
//            checkBinaryOperation(ZERO_DOT_17_NINES, NEG_ONE_DOT_E_PLUS_9998, DIVIDE, "-9999999999999999.00000000000000001");
//
//            //first is 1.E+9998 (and vice versa)
//            checkBinaryOperation(ONE_DOT_E_PLUS_9998, NEG_ZERO_DOT_17_NINES, DIVIDE, "9999999999999999.00000000000000001");
//            checkBinaryOperation(NEG_ZERO_DOT_17_NINES, ONE_DOT_E_PLUS_9998, DIVIDE, "9999999999999999.00000000000000001");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_9998, NEG_ZERO_DOT_16_NINES, DIVIDE, "9999999999999999.0000000000000001");
//            checkBinaryOperation(NEG_ZERO_DOT_16_NINES, ONE_DOT_E_PLUS_9998, DIVIDE, "9999999999999999.0000000000000001");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_9998, NEG_NINETY_NINE_HUNDREDTH, DIVIDE, "9999999999999999.01");
//            checkBinaryOperation(NEG_NINETY_NINE_HUNDREDTH, ONE_DOT_E_PLUS_9998, DIVIDE, "9999999999999999.01");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_9998, NEG_NINE_TENTH, DIVIDE, "9999999999999999.1");
//            checkBinaryOperation(NEG_NINE_TENTH, ONE_DOT_E_PLUS_9998, DIVIDE, "9999999999999999.1");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_9998, NEG_ONE_TENTH, DIVIDE, "9999999999999999.9");
//            checkBinaryOperation(NEG_ONE_TENTH, ONE_DOT_E_PLUS_9998, DIVIDE, "9999999999999999.9");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_9998, NEG_NINE_HUNDREDTH, DIVIDE, "9999999999999999.91");
//            checkBinaryOperation(NEG_NINE_HUNDREDTH, ONE_DOT_E_PLUS_9998, DIVIDE, "9999999999999999.91");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_9998, NEG_ONE_HUNDREDTH, DIVIDE, "9999999999999999.99");
//            checkBinaryOperation(NEG_ONE_HUNDREDTH, ONE_DOT_E_PLUS_9998, DIVIDE, "9999999999999999.99");
//
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_9998, ONE_HUNDREDTH, DIVIDE, "10000000000000000.01");
//            checkBinaryOperation(ONE_HUNDREDTH, ONE_DOT_E_PLUS_9998, DIVIDE, "10000000000000000.01");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_9998, NINE_HUNDREDTH, DIVIDE, "10000000000000000.09");
//            checkBinaryOperation(NINE_HUNDREDTH, ONE_DOT_E_PLUS_9998, DIVIDE, "10000000000000000.09");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_9998, ONE_TENTH, DIVIDE, "10000000000000000.1");
//            checkBinaryOperation(ONE_TENTH, ONE_DOT_E_PLUS_9998, DIVIDE, "10000000000000000.1");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_9998, NINE_TENTH, DIVIDE, "10000000000000000.9");
//            checkBinaryOperation(NINE_TENTH, ONE_DOT_E_PLUS_9998, DIVIDE, "10000000000000000.9");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_9998, NINETY_NINE_HUNDREDTH, DIVIDE, "10000000000000000.99");
//            checkBinaryOperation(NINETY_NINE_HUNDREDTH, ONE_DOT_E_PLUS_9998, DIVIDE, "10000000000000000.99");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_9998, ZERO_DOT_16_NINES, DIVIDE, "10000000000000000.9999999999999999");
//            checkBinaryOperation(ZERO_DOT_16_NINES, ONE_DOT_E_PLUS_9998, DIVIDE, "10000000000000000.9999999999999999");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_9998, ZERO_DOT_17_NINES, DIVIDE, "10000000000000000.99999999999999999");
//            checkBinaryOperation(ZERO_DOT_17_NINES, ONE_DOT_E_PLUS_9998, DIVIDE, "10000000000000000.99999999999999999");
//
//
//            //first is 1.E+9999 (and vice versa)
//            checkBinaryOperation(ONE_DOT_E_PLUS_9999, NEG_ZERO_DOT_17_NINES, DIVIDE, "99999999999999999.00000000000000001");
//            checkBinaryOperation(NEG_ZERO_DOT_17_NINES, ONE_DOT_E_PLUS_9999, DIVIDE, "99999999999999999.00000000000000001");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_9999, NEG_ZERO_DOT_16_NINES, DIVIDE, "99999999999999999.0000000000000001");
//            checkBinaryOperation(NEG_ZERO_DOT_16_NINES, ONE_DOT_E_PLUS_9999, DIVIDE, "99999999999999999.0000000000000001");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_9999, NEG_NINETY_NINE_HUNDREDTH, DIVIDE, "99999999999999999.01");
//            checkBinaryOperation(NEG_NINETY_NINE_HUNDREDTH, ONE_DOT_E_PLUS_9999, DIVIDE, "99999999999999999.01");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_9999, NEG_NINE_TENTH, DIVIDE, "99999999999999999.1");
//            checkBinaryOperation(NEG_NINE_TENTH, ONE_DOT_E_PLUS_9999, DIVIDE, "99999999999999999.1");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_9999, NEG_ONE_TENTH, DIVIDE, "99999999999999999.9");
//            checkBinaryOperation(NEG_ONE_TENTH, ONE_DOT_E_PLUS_9999, DIVIDE, "99999999999999999.9");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_9999, NEG_NINE_HUNDREDTH, DIVIDE, "99999999999999999.91");
//            checkBinaryOperation(NEG_NINE_HUNDREDTH, ONE_DOT_E_PLUS_9999, DIVIDE, "99999999999999999.91");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_9999, NEG_ONE_HUNDREDTH, DIVIDE, "99999999999999999.99");
//            checkBinaryOperation(NEG_ONE_HUNDREDTH, ONE_DOT_E_PLUS_9999, DIVIDE, "99999999999999999.99");
//
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_9999, ONE_HUNDREDTH, DIVIDE, "100000000000000000.01");
//            checkBinaryOperation(ONE_HUNDREDTH, ONE_DOT_E_PLUS_9999, DIVIDE, "100000000000000000.01");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_9999, NINE_HUNDREDTH, DIVIDE, "100000000000000000.09");
//            checkBinaryOperation(NINE_HUNDREDTH, ONE_DOT_E_PLUS_9999, DIVIDE, "100000000000000000.09");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_9999, ONE_TENTH, DIVIDE, "100000000000000000.1");
//            checkBinaryOperation(ONE_TENTH, ONE_DOT_E_PLUS_9999, DIVIDE, "100000000000000000.1");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_9999, NINE_TENTH, DIVIDE, "100000000000000000.9");
//            checkBinaryOperation(NINE_TENTH, ONE_DOT_E_PLUS_9999, DIVIDE, "100000000000000000.9");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_9999, NINETY_NINE_HUNDREDTH, DIVIDE, "100000000000000000.99");
//            checkBinaryOperation(NINETY_NINE_HUNDREDTH, ONE_DOT_E_PLUS_9999, DIVIDE, "100000000000000000.99");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_9999, ZERO_DOT_16_NINES, DIVIDE, "100000000000000000.9999999999999999");
//            checkBinaryOperation(ZERO_DOT_16_NINES, ONE_DOT_E_PLUS_9999, DIVIDE, "100000000000000000.9999999999999999");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_9999, ZERO_DOT_17_NINES, DIVIDE, "100000000000000000.99999999999999999");
//            checkBinaryOperation(ZERO_DOT_17_NINES, ONE_DOT_E_PLUS_9999, DIVIDE, "100000000000000000.99999999999999999");
//
//            //first is -1.E-9999 (and vice versa)
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9999, NEG_ZERO_DOT_17_NINES, DIVIDE, "-1.00000000000000000");
//            checkBinaryOperation(NEG_ZERO_DOT_17_NINES, NEG_ONE_DOT_E_MINUS_9999, DIVIDE, "-1.00000000000000000");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9999, NEG_ZERO_DOT_16_NINES, DIVIDE, "-0.99999999999999991");
//            checkBinaryOperation(NEG_ZERO_DOT_16_NINES, NEG_ONE_DOT_E_MINUS_9999, DIVIDE, "-0.99999999999999991");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9999, NEG_NINETY_NINE_HUNDREDTH, DIVIDE, "-0.99000000000000001");
//            checkBinaryOperation(NEG_NINETY_NINE_HUNDREDTH, NEG_ONE_DOT_E_MINUS_9999, DIVIDE, "-0.99000000000000001");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9999, NEG_NINE_TENTH, DIVIDE, "-0.90000000000000001");
//            checkBinaryOperation(NEG_NINE_TENTH, NEG_ONE_DOT_E_MINUS_9999, DIVIDE, "-0.90000000000000001");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9999, NEG_ONE_TENTH, DIVIDE, "-0.10000000000000001");
//            checkBinaryOperation(NEG_ONE_TENTH, NEG_ONE_DOT_E_MINUS_9999, DIVIDE, "-0.10000000000000001");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9999, NEG_NINE_HUNDREDTH, DIVIDE, "-0.09000000000000001");
//            checkBinaryOperation(NEG_NINE_HUNDREDTH, NEG_ONE_DOT_E_MINUS_9999, DIVIDE, "-0.09000000000000001");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9999, NEG_ONE_HUNDREDTH, DIVIDE, "-0.01000000000000001");
//            checkBinaryOperation(NEG_ONE_HUNDREDTH, NEG_ONE_DOT_E_MINUS_9999, DIVIDE, "-0.01000000000000001");
//
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9999, ONE_HUNDREDTH, DIVIDE, "0.00999999999999999");
//            checkBinaryOperation(ONE_HUNDREDTH, NEG_ONE_DOT_E_MINUS_9999, DIVIDE, "0.00999999999999999");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9999, NINE_HUNDREDTH, DIVIDE, "0.08999999999999999");
//            checkBinaryOperation(NINE_HUNDREDTH, NEG_ONE_DOT_E_MINUS_9999, DIVIDE, "0.08999999999999999");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9999, ONE_TENTH, DIVIDE, "0.09999999999999999");
//            checkBinaryOperation(ONE_TENTH, NEG_ONE_DOT_E_MINUS_9999, DIVIDE, "0.09999999999999999");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9999, NINE_TENTH, DIVIDE, "0.89999999999999999");
//            checkBinaryOperation(NINE_TENTH, NEG_ONE_DOT_E_MINUS_9999, DIVIDE, "0.89999999999999999");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9999, NINETY_NINE_HUNDREDTH, DIVIDE, "0.98999999999999999");
//            checkBinaryOperation(NINETY_NINE_HUNDREDTH, NEG_ONE_DOT_E_MINUS_9999, DIVIDE, "0.98999999999999999");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9999, ZERO_DOT_16_NINES, DIVIDE, "0.99999999999999989");
//            checkBinaryOperation(ZERO_DOT_16_NINES, NEG_ONE_DOT_E_MINUS_9999, DIVIDE, "0.99999999999999989");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9999, ZERO_DOT_17_NINES, DIVIDE, "0.99999999999999998");
//            checkBinaryOperation(ZERO_DOT_17_NINES, NEG_ONE_DOT_E_MINUS_9999, DIVIDE, "0.99999999999999998");
//
//            //first is -1.E-9998 (and vice versa)
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9998, NEG_ZERO_DOT_17_NINES, DIVIDE, "-1.00000000000000009");
//            checkBinaryOperation(NEG_ZERO_DOT_17_NINES, NEG_ONE_DOT_E_MINUS_9998, DIVIDE, "-1.00000000000000009");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9998, NEG_ZERO_DOT_16_NINES, DIVIDE, "-1.0000000000000000");
//            checkBinaryOperation(NEG_ZERO_DOT_16_NINES, NEG_ONE_DOT_E_MINUS_9998, DIVIDE, "-1.0000000000000000");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9998, NEG_NINETY_NINE_HUNDREDTH, DIVIDE, "-0.9900000000000001");
//            checkBinaryOperation(NEG_NINETY_NINE_HUNDREDTH, NEG_ONE_DOT_E_MINUS_9998, DIVIDE, "-0.9900000000000001");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9998, NEG_NINE_TENTH, DIVIDE, "-0.9000000000000001");
//            checkBinaryOperation(NEG_NINE_TENTH, NEG_ONE_DOT_E_MINUS_9998, DIVIDE, "-0.9000000000000001");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9998, NEG_ONE_TENTH, DIVIDE, "-0.1000000000000001");
//            checkBinaryOperation(NEG_ONE_TENTH, NEG_ONE_DOT_E_MINUS_9998, DIVIDE, "-0.1000000000000001");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9998, NEG_NINE_HUNDREDTH, DIVIDE, "-0.0900000000000001");
//            checkBinaryOperation(NEG_NINE_HUNDREDTH, NEG_ONE_DOT_E_MINUS_9998, DIVIDE, "-0.0900000000000001");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9998, NEG_ONE_HUNDREDTH, DIVIDE, "-0.0100000000000001");
//            checkBinaryOperation(NEG_ONE_HUNDREDTH, NEG_ONE_DOT_E_MINUS_9998, DIVIDE, "-0.0100000000000001");
//
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9998, ONE_HUNDREDTH, DIVIDE, "0.0099999999999999");
//            checkBinaryOperation(ONE_HUNDREDTH, NEG_ONE_DOT_E_MINUS_9998, DIVIDE, "0.0099999999999999");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9998, NINE_HUNDREDTH, DIVIDE, "0.0899999999999999");
//            checkBinaryOperation(NINE_HUNDREDTH, NEG_ONE_DOT_E_MINUS_9998, DIVIDE, "0.0899999999999999");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9998, ONE_TENTH, DIVIDE, "0.0999999999999999");
//            checkBinaryOperation(ONE_TENTH, NEG_ONE_DOT_E_MINUS_9998, DIVIDE, "0.0999999999999999");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9998, NINE_TENTH, DIVIDE, "0.8999999999999999");
//            checkBinaryOperation(NINE_TENTH, NEG_ONE_DOT_E_MINUS_9998, DIVIDE, "0.8999999999999999");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9998, NINETY_NINE_HUNDREDTH, DIVIDE, "0.9899999999999999");
//            checkBinaryOperation(NINETY_NINE_HUNDREDTH, NEG_ONE_DOT_E_MINUS_9998, DIVIDE, "0.9899999999999999");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9998, ZERO_DOT_16_NINES, DIVIDE, "0.9999999999999998");
//            checkBinaryOperation(ZERO_DOT_16_NINES, NEG_ONE_DOT_E_MINUS_9998, DIVIDE, "0.9999999999999998");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_9998, ZERO_DOT_17_NINES, DIVIDE, "0.99999999999999989");
//            checkBinaryOperation(ZERO_DOT_17_NINES, NEG_ONE_DOT_E_MINUS_9998, DIVIDE, "0.99999999999999989");
//
//            //first is 1.E-9998 (and vice versa)
//            checkBinaryOperation(ONE_DOT_E_MINUS_9998, NEG_ZERO_DOT_17_NINES, DIVIDE, "-0.99999999999999989");
//            checkBinaryOperation(NEG_ZERO_DOT_17_NINES, ONE_DOT_E_MINUS_9998, DIVIDE, "-0.99999999999999989");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_9998, NEG_ZERO_DOT_16_NINES, DIVIDE, "-0.9999999999999998");
//            checkBinaryOperation(NEG_ZERO_DOT_16_NINES, ONE_DOT_E_MINUS_9998, DIVIDE, "-0.9999999999999998");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_9998, NEG_NINETY_NINE_HUNDREDTH, DIVIDE, "-0.9899999999999999");
//            checkBinaryOperation(NEG_NINETY_NINE_HUNDREDTH, ONE_DOT_E_MINUS_9998, DIVIDE, "-0.9899999999999999");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_9998, NEG_NINE_TENTH, DIVIDE, "-0.8999999999999999");
//            checkBinaryOperation(NEG_NINE_TENTH, ONE_DOT_E_MINUS_9998, DIVIDE, "-0.8999999999999999");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_9998, NEG_ONE_TENTH, DIVIDE, "-0.0999999999999999");
//            checkBinaryOperation(NEG_ONE_TENTH, ONE_DOT_E_MINUS_9998, DIVIDE, "-0.0999999999999999");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_9998, NEG_NINE_HUNDREDTH, DIVIDE, "-0.0899999999999999");
//            checkBinaryOperation(NEG_NINE_HUNDREDTH, ONE_DOT_E_MINUS_9998, DIVIDE, "-0.0899999999999999");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_9998, NEG_ONE_HUNDREDTH, DIVIDE, "-0.0099999999999999");
//            checkBinaryOperation(NEG_ONE_HUNDREDTH, ONE_DOT_E_MINUS_9998, DIVIDE, "-0.0099999999999999");
//
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_9998, ONE_HUNDREDTH, DIVIDE, "0.0100000000000001");
//            checkBinaryOperation(ONE_HUNDREDTH, ONE_DOT_E_MINUS_9998, DIVIDE, "0.0100000000000001");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_9998, NINE_HUNDREDTH, DIVIDE, "0.0900000000000001");
//            checkBinaryOperation(NINE_HUNDREDTH, ONE_DOT_E_MINUS_9998, DIVIDE, "0.0900000000000001");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_9998, ONE_TENTH, DIVIDE, "0.1000000000000001");
//            checkBinaryOperation(ONE_TENTH, ONE_DOT_E_MINUS_9998, DIVIDE, "0.1000000000000001");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_9998, NINE_TENTH, DIVIDE, "0.9000000000000001");
//            checkBinaryOperation(NINE_TENTH, ONE_DOT_E_MINUS_9998, DIVIDE, "0.9000000000000001");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_9998, NINETY_NINE_HUNDREDTH, DIVIDE, "0.9900000000000001");
//            checkBinaryOperation(NINETY_NINE_HUNDREDTH, ONE_DOT_E_MINUS_9998, DIVIDE, "0.9900000000000001");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_9998, ZERO_DOT_16_NINES, DIVIDE, "1.0000000000000000");
//            checkBinaryOperation(ZERO_DOT_16_NINES, ONE_DOT_E_MINUS_9998, DIVIDE, "1.0000000000000000");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_9998, ZERO_DOT_17_NINES, DIVIDE, "1.00000000000000009");
//            checkBinaryOperation(ZERO_DOT_17_NINES, ONE_DOT_E_MINUS_9998, DIVIDE, "1.00000000000000009");
//
//            //first is 1.E-9999 (and vice versa)
//            checkBinaryOperation(ONE_DOT_E_MINUS_9999, NEG_ZERO_DOT_17_NINES, DIVIDE, "-0.99999999999999998");
//            checkBinaryOperation(NEG_ZERO_DOT_17_NINES, ONE_DOT_E_MINUS_9999, DIVIDE, "-0.99999999999999998");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_9999, NEG_ZERO_DOT_16_NINES, DIVIDE, "-0.99999999999999989");
//            checkBinaryOperation(NEG_ZERO_DOT_16_NINES, ONE_DOT_E_MINUS_9999, DIVIDE, "-0.99999999999999989");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_9999, NEG_NINETY_NINE_HUNDREDTH, DIVIDE, "-0.98999999999999999");
//            checkBinaryOperation(NEG_NINETY_NINE_HUNDREDTH, ONE_DOT_E_MINUS_9999, DIVIDE, "-0.98999999999999999");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_9999, NEG_NINE_TENTH, DIVIDE, "-0.89999999999999999");
//            checkBinaryOperation(NEG_NINE_TENTH, ONE_DOT_E_MINUS_9999, DIVIDE, "-0.89999999999999999");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_9999, NEG_ONE_TENTH, DIVIDE, "-0.09999999999999999");
//            checkBinaryOperation(NEG_ONE_TENTH, ONE_DOT_E_MINUS_9999, DIVIDE, "-0.09999999999999999");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_9999, NEG_NINE_HUNDREDTH, DIVIDE, "-0.08999999999999999");
//            checkBinaryOperation(NEG_NINE_HUNDREDTH, ONE_DOT_E_MINUS_9999, DIVIDE, "-0.08999999999999999");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_9999, NEG_ONE_HUNDREDTH, DIVIDE, "-0.00999999999999999");
//            checkBinaryOperation(NEG_ONE_HUNDREDTH, ONE_DOT_E_MINUS_9999, DIVIDE, "-0.00999999999999999");
//
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_9999, ONE_HUNDREDTH, DIVIDE, "0.01000000000000001");
//            checkBinaryOperation(ONE_HUNDREDTH, ONE_DOT_E_MINUS_9999, DIVIDE, "0.01000000000000001");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_9999, NINE_HUNDREDTH, DIVIDE, "0.09000000000000001");
//            checkBinaryOperation(NINE_HUNDREDTH, ONE_DOT_E_MINUS_9999, DIVIDE, "0.09000000000000001");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_9999, ONE_TENTH, DIVIDE, "0.10000000000000001");
//            checkBinaryOperation(ONE_TENTH, ONE_DOT_E_MINUS_9999, DIVIDE, "0.10000000000000001");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_9999, NINE_TENTH, DIVIDE, "0.90000000000000001");
//            checkBinaryOperation(NINE_TENTH, ONE_DOT_E_MINUS_9999, DIVIDE, "0.90000000000000001");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_9999, NINETY_NINE_HUNDREDTH, DIVIDE, "0.99000000000000001");
//            checkBinaryOperation(NINETY_NINE_HUNDREDTH, ONE_DOT_E_MINUS_9999, DIVIDE, "0.99000000000000001");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_9999, ZERO_DOT_16_NINES, DIVIDE, "0.99999999999999991");
//            checkBinaryOperation(ZERO_DOT_16_NINES, ONE_DOT_E_MINUS_9999, DIVIDE, "0.99999999999999991");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_9999, ZERO_DOT_17_NINES, DIVIDE, "1.00000000000000000");
//            checkBinaryOperation(ZERO_DOT_17_NINES, ONE_DOT_E_MINUS_9999, DIVIDE, "1.00000000000000000");
//
//            //first is -1.E+17 (and vice versa)
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_17, NEG_ZERO_DOT_17_NINES, DIVIDE, "-100000000000000000.99999999999999999");
//            checkBinaryOperation(NEG_ZERO_DOT_17_NINES, NEG_ONE_DOT_E_PLUS_17, DIVIDE, "-100000000000000000.99999999999999999");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_17, NEG_ZERO_DOT_16_NINES, DIVIDE, "-100000000000000000.9999999999999999");
//            checkBinaryOperation(NEG_ZERO_DOT_16_NINES, NEG_ONE_DOT_E_PLUS_17, DIVIDE, "-100000000000000000.9999999999999999");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_17, NEG_NINETY_NINE_HUNDREDTH, DIVIDE, "-100000000000000000.99");
//            checkBinaryOperation(NEG_NINETY_NINE_HUNDREDTH, NEG_ONE_DOT_E_PLUS_17, DIVIDE, "-100000000000000000.99");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_17, NEG_NINE_TENTH, DIVIDE, "-100000000000000000.9");
//            checkBinaryOperation(NEG_NINE_TENTH, NEG_ONE_DOT_E_PLUS_17, DIVIDE, "-100000000000000000.9");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_17, NEG_ONE_TENTH, DIVIDE, "-100000000000000000.1");
//            checkBinaryOperation(NEG_ONE_TENTH, NEG_ONE_DOT_E_PLUS_17, DIVIDE, "-100000000000000000.1");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_17, NEG_NINE_HUNDREDTH, DIVIDE, "-100000000000000000.09");
//            checkBinaryOperation(NEG_NINE_HUNDREDTH, NEG_ONE_DOT_E_PLUS_17, DIVIDE, "-100000000000000000.09");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_17, NEG_ONE_HUNDREDTH, DIVIDE, "-100000000000000000.01");
//            checkBinaryOperation(NEG_ONE_HUNDREDTH, NEG_ONE_DOT_E_PLUS_17, DIVIDE, "-100000000000000000.01");
//
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_17, ONE_HUNDREDTH, DIVIDE, "-99999999999999999.99");
//            checkBinaryOperation(ONE_HUNDREDTH, NEG_ONE_DOT_E_PLUS_17, DIVIDE, "-99999999999999999.99");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_17, NINE_HUNDREDTH, DIVIDE, "-99999999999999999.91");
//            checkBinaryOperation(NINE_HUNDREDTH, NEG_ONE_DOT_E_PLUS_17, DIVIDE, "-99999999999999999.91");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_17, ONE_TENTH, DIVIDE, "-99999999999999999.9");
//            checkBinaryOperation(ONE_TENTH, NEG_ONE_DOT_E_PLUS_17, DIVIDE, "-99999999999999999.9");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_17, NINE_TENTH, DIVIDE, "-99999999999999999.1");
//            checkBinaryOperation(NINE_TENTH, NEG_ONE_DOT_E_PLUS_17, DIVIDE, "-99999999999999999.1");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_17, NINETY_NINE_HUNDREDTH, DIVIDE, "-99999999999999999.01");
//            checkBinaryOperation(NINETY_NINE_HUNDREDTH, NEG_ONE_DOT_E_PLUS_17, DIVIDE, "-99999999999999999.01");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_17, ZERO_DOT_16_NINES, DIVIDE, "-99999999999999999.0000000000000001");
//            checkBinaryOperation(ZERO_DOT_16_NINES, NEG_ONE_DOT_E_PLUS_17, DIVIDE, "-99999999999999999.0000000000000001");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_17, ZERO_DOT_17_NINES, DIVIDE, "-99999999999999999.00000000000000001");
//            checkBinaryOperation(ZERO_DOT_17_NINES, NEG_ONE_DOT_E_PLUS_17, DIVIDE, "-99999999999999999.00000000000000001");
//
//            //first is -1.E+16 (and vice versa)
//            checkBinaryOperation(NEG_ZERO_DOT_17_NINES, NEG_ONE_DOT_E_PLUS_16, DIVIDE, "-10000000000000000.99999999999999999");
//            checkBinaryOperation(NEG_ZERO_DOT_17_NINES, NEG_ONE_DOT_E_PLUS_16, DIVIDE, "-10000000000000000.99999999999999999");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_16, NEG_ZERO_DOT_16_NINES, DIVIDE, "-10000000000000000.9999999999999999");
//            checkBinaryOperation(NEG_ZERO_DOT_16_NINES, NEG_ONE_DOT_E_PLUS_16, DIVIDE, "-10000000000000000.9999999999999999");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_16, NEG_NINETY_NINE_HUNDREDTH, DIVIDE, "-10000000000000000.99");
//            checkBinaryOperation(NEG_NINETY_NINE_HUNDREDTH, NEG_ONE_DOT_E_PLUS_16, DIVIDE, "-10000000000000000.99");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_16, NEG_NINE_TENTH, DIVIDE, "-10000000000000000.9");
//            checkBinaryOperation(NEG_NINE_TENTH, NEG_ONE_DOT_E_PLUS_16, DIVIDE, "-10000000000000000.9");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_16, NEG_ONE_TENTH, DIVIDE, "-10000000000000000.1");
//            checkBinaryOperation(NEG_ONE_TENTH, NEG_ONE_DOT_E_PLUS_16, DIVIDE, "-10000000000000000.1");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_16, NEG_NINE_HUNDREDTH, DIVIDE, "-10000000000000000.09");
//            checkBinaryOperation(NEG_NINE_HUNDREDTH, NEG_ONE_DOT_E_PLUS_16, DIVIDE, "-10000000000000000.09");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_16, NEG_ONE_HUNDREDTH, DIVIDE, "-10000000000000000.01");
//            checkBinaryOperation(NEG_ONE_HUNDREDTH, NEG_ONE_DOT_E_PLUS_16, DIVIDE, "-10000000000000000.01");
//
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_16, ONE_HUNDREDTH, DIVIDE, "-9999999999999999.99");
//            checkBinaryOperation(ONE_HUNDREDTH, NEG_ONE_DOT_E_PLUS_16, DIVIDE, "-9999999999999999.99");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_16, NINE_HUNDREDTH, DIVIDE, "-9999999999999999.91");
//            checkBinaryOperation(NINE_HUNDREDTH, NEG_ONE_DOT_E_PLUS_16, DIVIDE, "-9999999999999999.91");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_16, ONE_TENTH, DIVIDE, "-9999999999999999.9");
//            checkBinaryOperation(ONE_TENTH, NEG_ONE_DOT_E_PLUS_16, DIVIDE, "-9999999999999999.9");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_16, NINE_TENTH, DIVIDE, "-9999999999999999.1");
//            checkBinaryOperation(NINE_TENTH, NEG_ONE_DOT_E_PLUS_16, DIVIDE, "-9999999999999999.1");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_16, NINETY_NINE_HUNDREDTH, DIVIDE, "-9999999999999999.01");
//            checkBinaryOperation(NINETY_NINE_HUNDREDTH, NEG_ONE_DOT_E_PLUS_16, DIVIDE, "-9999999999999999.01");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_16, ZERO_DOT_16_NINES, DIVIDE, "-9999999999999999.0000000000000001");
//            checkBinaryOperation(ZERO_DOT_16_NINES, NEG_ONE_DOT_E_PLUS_16, DIVIDE, "-9999999999999999.0000000000000001");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_PLUS_16, ZERO_DOT_17_NINES, DIVIDE, "-9999999999999999.00000000000000001");
//            checkBinaryOperation(ZERO_DOT_17_NINES, NEG_ONE_DOT_E_PLUS_16, DIVIDE, "-9999999999999999.00000000000000001");
//
//            //first is 1.E+16 (and vice versa)
//            checkBinaryOperation(ONE_DOT_E_PLUS_16, NEG_ZERO_DOT_17_NINES, DIVIDE, "9999999999999999.00000000000000001");
//            checkBinaryOperation(NEG_ZERO_DOT_17_NINES, ONE_DOT_E_PLUS_16, DIVIDE, "9999999999999999.00000000000000001");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_16, NEG_ZERO_DOT_16_NINES, DIVIDE, "9999999999999999.0000000000000001");
//            checkBinaryOperation(NEG_ZERO_DOT_16_NINES, ONE_DOT_E_PLUS_16, DIVIDE, "9999999999999999.0000000000000001");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_16, NEG_NINETY_NINE_HUNDREDTH, DIVIDE, "9999999999999999.01");
//            checkBinaryOperation(NEG_NINETY_NINE_HUNDREDTH, ONE_DOT_E_PLUS_16, DIVIDE, "9999999999999999.01");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_16, NEG_NINE_TENTH, DIVIDE, "9999999999999999.1");
//            checkBinaryOperation(NEG_NINE_TENTH, ONE_DOT_E_PLUS_16, DIVIDE, "9999999999999999.1");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_16, NEG_ONE_TENTH, DIVIDE, "9999999999999999.9");
//            checkBinaryOperation(NEG_ONE_TENTH, ONE_DOT_E_PLUS_16, DIVIDE, "9999999999999999.9");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_16, NEG_NINE_HUNDREDTH, DIVIDE, "9999999999999999.91");
//            checkBinaryOperation(NEG_NINE_HUNDREDTH, ONE_DOT_E_PLUS_16, DIVIDE, "9999999999999999.91");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_16, NEG_ONE_HUNDREDTH, DIVIDE, "9999999999999999.99");
//            checkBinaryOperation(NEG_ONE_HUNDREDTH, ONE_DOT_E_PLUS_16, DIVIDE, "9999999999999999.99");
//
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_16, ONE_HUNDREDTH, DIVIDE, "10000000000000000.01");
//            checkBinaryOperation(ONE_HUNDREDTH, ONE_DOT_E_PLUS_16, DIVIDE, "10000000000000000.01");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_16, NINE_HUNDREDTH, DIVIDE, "10000000000000000.09");
//            checkBinaryOperation(NINE_HUNDREDTH, ONE_DOT_E_PLUS_16, DIVIDE, "10000000000000000.09");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_16, ONE_TENTH, DIVIDE, "10000000000000000.1");
//            checkBinaryOperation(ONE_TENTH, ONE_DOT_E_PLUS_16, DIVIDE, "10000000000000000.1");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_16, NINE_TENTH, DIVIDE, "10000000000000000.9");
//            checkBinaryOperation(NINE_TENTH, ONE_DOT_E_PLUS_16, DIVIDE, "10000000000000000.9");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_16, NINETY_NINE_HUNDREDTH, DIVIDE, "10000000000000000.99");
//            checkBinaryOperation(NINETY_NINE_HUNDREDTH, ONE_DOT_E_PLUS_16, DIVIDE, "10000000000000000.99");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_16, ZERO_DOT_16_NINES, DIVIDE, "10000000000000000.9999999999999999");
//            checkBinaryOperation(ZERO_DOT_16_NINES, ONE_DOT_E_PLUS_16, DIVIDE, "10000000000000000.9999999999999999");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_16, ZERO_DOT_17_NINES, DIVIDE, "10000000000000000.99999999999999999");
//            checkBinaryOperation(ZERO_DOT_17_NINES, ONE_DOT_E_PLUS_16, DIVIDE, "10000000000000000.99999999999999999");
//
//            //first is 1.E+17 (and vice versa)
//            checkBinaryOperation(ONE_DOT_E_PLUS_17, NEG_ZERO_DOT_17_NINES, DIVIDE, "99999999999999999.00000000000000001");
//            checkBinaryOperation(NEG_ZERO_DOT_17_NINES, ONE_DOT_E_PLUS_17, DIVIDE, "99999999999999999.00000000000000001");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_17, NEG_ZERO_DOT_16_NINES, DIVIDE, "99999999999999999.0000000000000001");
//            checkBinaryOperation(NEG_ZERO_DOT_16_NINES, ONE_DOT_E_PLUS_17, DIVIDE, "99999999999999999.0000000000000001");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_17, NEG_NINETY_NINE_HUNDREDTH, DIVIDE, "99999999999999999.01");
//            checkBinaryOperation(NEG_NINETY_NINE_HUNDREDTH, ONE_DOT_E_PLUS_17, DIVIDE, "99999999999999999.01");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_17, NEG_NINE_TENTH, DIVIDE, "99999999999999999.1");
//            checkBinaryOperation(NEG_NINE_TENTH, ONE_DOT_E_PLUS_17, DIVIDE, "99999999999999999.1");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_17, NEG_ONE_TENTH, DIVIDE, "99999999999999999.9");
//            checkBinaryOperation(NEG_ONE_TENTH, ONE_DOT_E_PLUS_17, DIVIDE, "99999999999999999.9");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_17, NEG_NINE_HUNDREDTH, DIVIDE, "99999999999999999.91");
//            checkBinaryOperation(NEG_NINE_HUNDREDTH, ONE_DOT_E_PLUS_17, DIVIDE, "99999999999999999.91");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_17, NEG_ONE_HUNDREDTH, DIVIDE, "99999999999999999.99");
//            checkBinaryOperation(NEG_ONE_HUNDREDTH, ONE_DOT_E_PLUS_17, DIVIDE, "99999999999999999.99");
//
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_17, ONE_HUNDREDTH, DIVIDE, "100000000000000000.01");
//            checkBinaryOperation(ONE_HUNDREDTH, ONE_DOT_E_PLUS_17, DIVIDE, "100000000000000000.01");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_17, NINE_HUNDREDTH, DIVIDE, "100000000000000000.09");
//            checkBinaryOperation(NINE_HUNDREDTH, ONE_DOT_E_PLUS_17, DIVIDE, "100000000000000000.09");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_17, ONE_TENTH, DIVIDE, "100000000000000000.1");
//            checkBinaryOperation(ONE_TENTH, ONE_DOT_E_PLUS_17, DIVIDE, "100000000000000000.1");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_17, NINE_TENTH, DIVIDE, "100000000000000000.9");
//            checkBinaryOperation(NINE_TENTH, ONE_DOT_E_PLUS_17, DIVIDE, "100000000000000000.9");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_17, NINETY_NINE_HUNDREDTH, DIVIDE, "100000000000000000.99");
//            checkBinaryOperation(NINETY_NINE_HUNDREDTH, ONE_DOT_E_PLUS_17, DIVIDE, "100000000000000000.99");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_17, ZERO_DOT_16_NINES, DIVIDE, "100000000000000000.9999999999999999");
//            checkBinaryOperation(ZERO_DOT_16_NINES, ONE_DOT_E_PLUS_17, DIVIDE, "100000000000000000.9999999999999999");
//
//            checkBinaryOperation(ONE_DOT_E_PLUS_17, ZERO_DOT_17_NINES, DIVIDE, "100000000000000000.99999999999999999");
//            checkBinaryOperation(ZERO_DOT_17_NINES, ONE_DOT_E_PLUS_17, DIVIDE, "100000000000000000.99999999999999999");
//
//            //first is -1.E-17 (and vice versa)
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_17, NEG_ZERO_DOT_17_NINES, DIVIDE, "-1.00000000000000000");
//            checkBinaryOperation(NEG_ZERO_DOT_17_NINES, NEG_ONE_DOT_E_MINUS_17, DIVIDE, "-1.00000000000000000");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_17, NEG_ZERO_DOT_16_NINES, DIVIDE, "-0.99999999999999991");
//            checkBinaryOperation(NEG_ZERO_DOT_16_NINES, NEG_ONE_DOT_E_MINUS_17, DIVIDE, "-0.99999999999999991");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_17, NEG_NINETY_NINE_HUNDREDTH, DIVIDE, "-0.99000000000000001");
//            checkBinaryOperation(NEG_NINETY_NINE_HUNDREDTH, NEG_ONE_DOT_E_MINUS_17, DIVIDE, "-0.99000000000000001");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_17, NEG_NINE_TENTH, DIVIDE, "-0.90000000000000001");
//            checkBinaryOperation(NEG_NINE_TENTH, NEG_ONE_DOT_E_MINUS_17, DIVIDE, "-0.90000000000000001");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_17, NEG_ONE_TENTH, DIVIDE, "-0.10000000000000001");
//            checkBinaryOperation(NEG_ONE_TENTH, NEG_ONE_DOT_E_MINUS_17, DIVIDE, "-0.10000000000000001");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_17, NEG_NINE_HUNDREDTH, DIVIDE, "-0.09000000000000001");
//            checkBinaryOperation(NEG_NINE_HUNDREDTH, NEG_ONE_DOT_E_MINUS_17, DIVIDE, "-0.09000000000000001");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_17, NEG_ONE_HUNDREDTH, DIVIDE, "-0.01000000000000001");
//            checkBinaryOperation(NEG_ONE_HUNDREDTH, NEG_ONE_DOT_E_MINUS_17, DIVIDE, "-0.01000000000000001");
//
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_17, ONE_HUNDREDTH, DIVIDE, "0.00999999999999999");
//            checkBinaryOperation(ONE_HUNDREDTH, NEG_ONE_DOT_E_MINUS_17, DIVIDE, "0.00999999999999999");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_17, NINE_HUNDREDTH, DIVIDE, "0.08999999999999999");
//            checkBinaryOperation(NINE_HUNDREDTH, NEG_ONE_DOT_E_MINUS_17, DIVIDE, "0.08999999999999999");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_17, ONE_TENTH, DIVIDE, "0.09999999999999999");
//            checkBinaryOperation(ONE_TENTH, NEG_ONE_DOT_E_MINUS_17, DIVIDE, "0.09999999999999999");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_17, NINE_TENTH, DIVIDE, "0.89999999999999999");
//            checkBinaryOperation(NINE_TENTH, NEG_ONE_DOT_E_MINUS_17, DIVIDE, "0.89999999999999999");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_17, NINETY_NINE_HUNDREDTH, DIVIDE, "0.98999999999999999");
//            checkBinaryOperation(NINETY_NINE_HUNDREDTH, NEG_ONE_DOT_E_MINUS_17, DIVIDE, "0.98999999999999999");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_17, ZERO_DOT_16_NINES, DIVIDE, "0.99999999999999989");
//            checkBinaryOperation(ZERO_DOT_16_NINES, NEG_ONE_DOT_E_MINUS_17, DIVIDE, "0.99999999999999989");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_17, ZERO_DOT_17_NINES, DIVIDE, "0.99999999999999998");
//            checkBinaryOperation(ZERO_DOT_17_NINES, NEG_ONE_DOT_E_MINUS_17, DIVIDE, "0.99999999999999998");
//
//            //first is -1.E-16 (and vice versa)
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_16, NEG_ZERO_DOT_17_NINES, DIVIDE, "-1.00000000000000009");
//            checkBinaryOperation(NEG_ZERO_DOT_17_NINES, NEG_ONE_DOT_E_MINUS_16, DIVIDE, "-1.00000000000000009");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_16, NEG_ZERO_DOT_16_NINES, DIVIDE, "-1.0000000000000000");
//            checkBinaryOperation(NEG_ZERO_DOT_16_NINES, NEG_ONE_DOT_E_MINUS_16, DIVIDE, "-1.0000000000000000");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_16, NEG_NINETY_NINE_HUNDREDTH, DIVIDE, "-0.9900000000000001");
//            checkBinaryOperation(NEG_NINETY_NINE_HUNDREDTH, NEG_ONE_DOT_E_MINUS_16, DIVIDE, "-0.9900000000000001");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_16, NEG_NINE_TENTH, DIVIDE, "-0.9000000000000001");
//            checkBinaryOperation(NEG_NINE_TENTH, NEG_ONE_DOT_E_MINUS_16, DIVIDE, "-0.9000000000000001");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_16, NEG_ONE_TENTH, DIVIDE, "-0.1000000000000001");
//            checkBinaryOperation(NEG_ONE_TENTH, NEG_ONE_DOT_E_MINUS_16, DIVIDE, "-0.1000000000000001");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_16, NEG_NINE_HUNDREDTH, DIVIDE, "-0.0900000000000001");
//            checkBinaryOperation(NEG_NINE_HUNDREDTH, NEG_ONE_DOT_E_MINUS_16, DIVIDE, "-0.0900000000000001");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_16, NEG_ONE_HUNDREDTH, DIVIDE, "-0.0100000000000001");
//            checkBinaryOperation(NEG_ONE_HUNDREDTH, NEG_ONE_DOT_E_MINUS_16, DIVIDE, "-0.0100000000000001");
//
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_16, ONE_HUNDREDTH, DIVIDE, "0.0099999999999999");
//            checkBinaryOperation(ONE_HUNDREDTH, NEG_ONE_DOT_E_MINUS_16, DIVIDE, "0.0099999999999999");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_16, NINE_HUNDREDTH, DIVIDE, "0.0899999999999999");
//            checkBinaryOperation(NINE_HUNDREDTH, NEG_ONE_DOT_E_MINUS_16, DIVIDE, "0.0899999999999999");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_16, ONE_TENTH, DIVIDE, "0.0999999999999999");
//            checkBinaryOperation(ONE_TENTH, NEG_ONE_DOT_E_MINUS_16, DIVIDE, "0.0999999999999999");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_16, NINE_TENTH, DIVIDE, "0.8999999999999999");
//            checkBinaryOperation(NINE_TENTH, NEG_ONE_DOT_E_MINUS_16, DIVIDE, "0.8999999999999999");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_16, NINETY_NINE_HUNDREDTH, DIVIDE, "0.9899999999999999");
//            checkBinaryOperation(NINETY_NINE_HUNDREDTH, NEG_ONE_DOT_E_MINUS_16, DIVIDE, "0.9899999999999999");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_16, ZERO_DOT_16_NINES, DIVIDE, "0.9999999999999998");
//            checkBinaryOperation(ZERO_DOT_16_NINES, NEG_ONE_DOT_E_MINUS_16, DIVIDE, "0.9999999999999998");
//
//            checkBinaryOperation(NEG_ONE_DOT_E_MINUS_16, ZERO_DOT_17_NINES, DIVIDE, "0.99999999999999989");
//            checkBinaryOperation(ZERO_DOT_17_NINES, NEG_ONE_DOT_E_MINUS_16, DIVIDE, "0.99999999999999989");
//
//            //first is 1.E-16 (and vice versa)
//            checkBinaryOperation(ONE_DOT_E_MINUS_16, NEG_ZERO_DOT_17_NINES, DIVIDE, "-0.99999999999999989");
//            checkBinaryOperation(NEG_ZERO_DOT_17_NINES, ONE_DOT_E_MINUS_16, DIVIDE, "-0.99999999999999989");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_16, NEG_ZERO_DOT_16_NINES, DIVIDE, "-0.9999999999999998");
//            checkBinaryOperation(NEG_ZERO_DOT_16_NINES, ONE_DOT_E_MINUS_16, DIVIDE, "-0.9999999999999998");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_16, NEG_NINETY_NINE_HUNDREDTH, DIVIDE, "-0.9899999999999999");
//            checkBinaryOperation(NEG_NINETY_NINE_HUNDREDTH, ONE_DOT_E_MINUS_16, DIVIDE, "-0.9899999999999999");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_16, NEG_NINE_TENTH, DIVIDE, "-0.8999999999999999");
//            checkBinaryOperation(NEG_NINE_TENTH, ONE_DOT_E_MINUS_16, DIVIDE, "-0.8999999999999999");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_16, NEG_ONE_TENTH, DIVIDE, "-0.0999999999999999");
//            checkBinaryOperation(NEG_ONE_TENTH, ONE_DOT_E_MINUS_16, DIVIDE, "-0.0999999999999999");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_16, NEG_NINE_HUNDREDTH, DIVIDE, "-0.0899999999999999");
//            checkBinaryOperation(NEG_NINE_HUNDREDTH, ONE_DOT_E_MINUS_16, DIVIDE, "-0.0899999999999999");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_16, NEG_ONE_HUNDREDTH, DIVIDE, "-0.0099999999999999");
//            checkBinaryOperation(NEG_ONE_HUNDREDTH, ONE_DOT_E_MINUS_16, DIVIDE, "-0.0099999999999999");
//
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_16, ONE_HUNDREDTH, DIVIDE, "0.0100000000000001");
//            checkBinaryOperation(ONE_HUNDREDTH, ONE_DOT_E_MINUS_16, DIVIDE, "0.0100000000000001");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_16, NINE_HUNDREDTH, DIVIDE, "0.0900000000000001");
//            checkBinaryOperation(NINE_HUNDREDTH, ONE_DOT_E_MINUS_16, DIVIDE, "0.0900000000000001");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_16, ONE_TENTH, DIVIDE, "0.1000000000000001");
//            checkBinaryOperation(ONE_TENTH, ONE_DOT_E_MINUS_16, DIVIDE, "0.1000000000000001");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_16, NINE_TENTH, DIVIDE, "0.9000000000000001");
//            checkBinaryOperation(NINE_TENTH, ONE_DOT_E_MINUS_16, DIVIDE, "0.9000000000000001");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_16, NINETY_NINE_HUNDREDTH, DIVIDE, "0.9900000000000001");
//            checkBinaryOperation(NINETY_NINE_HUNDREDTH, ONE_DOT_E_MINUS_16, DIVIDE, "0.9900000000000001");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_16, ZERO_DOT_16_NINES, DIVIDE, "1.0000000000000000");
//            checkBinaryOperation(ZERO_DOT_16_NINES, ONE_DOT_E_MINUS_16, DIVIDE, "1.0000000000000000");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_16, ZERO_DOT_17_NINES, DIVIDE, "1.00000000000000009");
//            checkBinaryOperation(ZERO_DOT_17_NINES, ONE_DOT_E_MINUS_16, DIVIDE, "1.00000000000000009");
//
//
//            //first is 1.E-17 (and vice versa)
//            checkBinaryOperation(ONE_DOT_E_MINUS_17, NEG_ZERO_DOT_17_NINES, DIVIDE, "-0.99999999999999998");
//            checkBinaryOperation(NEG_ZERO_DOT_17_NINES, ONE_DOT_E_MINUS_17, DIVIDE, "-0.99999999999999998");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_17, NEG_ZERO_DOT_16_NINES, DIVIDE, "-0.99999999999999989");
//            checkBinaryOperation(NEG_ZERO_DOT_16_NINES, ONE_DOT_E_MINUS_17, DIVIDE, "-0.99999999999999989");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_17, NEG_NINETY_NINE_HUNDREDTH, DIVIDE, "-0.98999999999999999");
//            checkBinaryOperation(NEG_NINETY_NINE_HUNDREDTH, ONE_DOT_E_MINUS_17, DIVIDE, "-0.98999999999999999");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_17, NEG_NINE_TENTH, DIVIDE, "-0.89999999999999999");
//            checkBinaryOperation(NEG_NINE_TENTH, ONE_DOT_E_MINUS_17, DIVIDE, "-0.89999999999999999");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_17, NEG_ONE_TENTH, DIVIDE, "-0.09999999999999999");
//            checkBinaryOperation(NEG_ONE_TENTH, ONE_DOT_E_MINUS_17, DIVIDE, "-0.09999999999999999");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_17, NEG_NINE_HUNDREDTH, DIVIDE, "-0.08999999999999999");
//            checkBinaryOperation(NEG_NINE_HUNDREDTH, ONE_DOT_E_MINUS_17, DIVIDE, "-0.08999999999999999");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_17, NEG_ONE_HUNDREDTH, DIVIDE, "-0.00999999999999999");
//            checkBinaryOperation(NEG_ONE_HUNDREDTH, ONE_DOT_E_MINUS_17, DIVIDE, "-0.00999999999999999");
//
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_17, ONE_HUNDREDTH, DIVIDE, "0.01000000000000001");
//            checkBinaryOperation(ONE_HUNDREDTH, ONE_DOT_E_MINUS_17, DIVIDE, "0.01000000000000001");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_17, NINE_HUNDREDTH, DIVIDE, "0.09000000000000001");
//            checkBinaryOperation(NINE_HUNDREDTH, ONE_DOT_E_MINUS_17, DIVIDE, "0.09000000000000001");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_17, ONE_TENTH, DIVIDE, "0.10000000000000001");
//            checkBinaryOperation(ONE_TENTH, ONE_DOT_E_MINUS_17, DIVIDE, "0.10000000000000001");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_17, NINE_TENTH, DIVIDE, "0.90000000000000001");
//            checkBinaryOperation(NINE_TENTH, ONE_DOT_E_MINUS_17, DIVIDE, "0.90000000000000001");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_17, NINETY_NINE_HUNDREDTH, DIVIDE, "0.99000000000000001");
//            checkBinaryOperation(NINETY_NINE_HUNDREDTH, ONE_DOT_E_MINUS_17, DIVIDE, "0.99000000000000001");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_17, ZERO_DOT_16_NINES, DIVIDE, "0.99999999999999991");
//            checkBinaryOperation(ZERO_DOT_16_NINES, ONE_DOT_E_MINUS_17, DIVIDE, "0.99999999999999991");
//
//            checkBinaryOperation(ONE_DOT_E_MINUS_17, ZERO_DOT_17_NINES, DIVIDE, "1.00000000000000000");
//            checkBinaryOperation(ZERO_DOT_17_NINES, ONE_DOT_E_MINUS_17, DIVIDE, "1.00000000000000000");
//        }
//
//        //several random values
//        {
//            checkBinaryOperation(new BigDecimal("523"), new BigDecimal("876"), DIVIDE, "8960");
//            checkBinaryOperation(new BigDecimal("876"), new BigDecimal("523"), DIVIDE, "36408");
//            checkBinaryOperation(new BigDecimal("34"), new BigDecimal("65"), DIVIDE, "8960");
//            checkBinaryOperation(new BigDecimal("65"), new BigDecimal("34"), DIVIDE, "36408");
//
//            checkBinaryOperation(new BigDecimal("724"), new BigDecimal("-652"), DIVIDE, "-480");
//            checkBinaryOperation(new BigDecimal("-652"), new BigDecimal("724"), DIVIDE, "7592");
//            checkBinaryOperation(new BigDecimal("763"), new BigDecimal("-865"), DIVIDE, "-480");
//            checkBinaryOperation(new BigDecimal("865"), new BigDecimal("763"), DIVIDE, "7592");
//
//            checkBinaryOperation(new BigDecimal("-6521"), new BigDecimal("-41"), DIVIDE, "-53304");
//            checkBinaryOperation(new BigDecimal("-41"), new BigDecimal("-6521"), DIVIDE, "-1308");
//            checkBinaryOperation(new BigDecimal("-7624"), new BigDecimal("-7245"), DIVIDE, "-53304");
//            checkBinaryOperation(new BigDecimal("-7245"), new BigDecimal("-7624"), DIVIDE, "-1308");
//
//            checkBinaryOperation(new BigDecimal("763"), new BigDecimal("245.876"), DIVIDE, "747.123");
//            checkBinaryOperation(new BigDecimal("245.876"), new BigDecimal("763"), DIVIDE, "977.523");
//            checkBinaryOperation(new BigDecimal("9876"), new BigDecimal("123.87"), DIVIDE, "747.123");
//            checkBinaryOperation(new BigDecimal("123.87"), new BigDecimal("9876"), DIVIDE, "977.523");
//
//            checkBinaryOperation(new BigDecimal("6425"), new BigDecimal("-123.65"), DIVIDE, "7628.402");
//            checkBinaryOperation(new BigDecimal("-123.65"), new BigDecimal("6425"), DIVIDE, "2307.876");
//            checkBinaryOperation(new BigDecimal("987"), new BigDecimal("-12.65"), DIVIDE, "7628.402");
//            checkBinaryOperation(new BigDecimal("-12.65"), new BigDecimal("987"), DIVIDE, "2307.876");
//
//            checkBinaryOperation(new BigDecimal("-6"), new BigDecimal("76.123"), DIVIDE, "14.43");
//            checkBinaryOperation(new BigDecimal("76.123"), new BigDecimal("-6"), DIVIDE, "789.1");
//            checkBinaryOperation(new BigDecimal("-6543"), new BigDecimal("12.43"), DIVIDE, "14.43");
//            checkBinaryOperation(new BigDecimal("12.43"), new BigDecimal("-6543"), DIVIDE, "789.1");
//
//            checkBinaryOperation(new BigDecimal("-876"), new BigDecimal("-21.41"), DIVIDE, "-63.234");
//            checkBinaryOperation(new BigDecimal("-21.41"), new BigDecimal("-876"), DIVIDE, "-1989.76");
//            checkBinaryOperation(new BigDecimal("-987"), new BigDecimal("-12.21"), DIVIDE, "-63.234");
//            checkBinaryOperation(new BigDecimal("-12.21"), new BigDecimal("-987"), DIVIDE, "-1989.76");
//
//            checkBinaryOperation(new BigDecimal("12.11"), new BigDecimal("87.0765"), DIVIDE, "104.79");
//            checkBinaryOperation(new BigDecimal("87.0765"), new BigDecimal("12.11"), DIVIDE, "150.468");
//            checkBinaryOperation(new BigDecimal("123.66"), new BigDecimal("1111.09"), DIVIDE, "104.79");
//            checkBinaryOperation(new BigDecimal("1111.09"), new BigDecimal("123.66"), DIVIDE, "150.468");
//
//            checkBinaryOperation(new BigDecimal("123.65"), new BigDecimal("-1.2"), DIVIDE, "38.56");
//            checkBinaryOperation(new BigDecimal("-1.2"), new BigDecimal("123.65"), DIVIDE, "548.1");
//            checkBinaryOperation(new BigDecimal("5.1"), new BigDecimal("-12.7"), DIVIDE, "38.56");
//            checkBinaryOperation(new BigDecimal("-12.7"), new BigDecimal("5.1"), DIVIDE, "548.1");
//
//            checkBinaryOperation(new BigDecimal("-0.112"), new BigDecimal("-3.2"), DIVIDE, "-534.3");
//            checkBinaryOperation(new BigDecimal("-3.2"), new BigDecimal("-0.112"), DIVIDE, "-647.8");
//            checkBinaryOperation(new BigDecimal("-9.1"), new BigDecimal("-1.224"), DIVIDE, "-534.3");
//            checkBinaryOperation(new BigDecimal("-1.224"), new BigDecimal("-9.1"), DIVIDE, "-647.8");
//        }
//    }
    ...
    private void checkBinaryOperation(BigDecimal first, BigDecimal second, BinaryOperations operation, String result) {
        ...
        assertEquals(first, calculation.getFirst());
        assertEquals(second, calculation.getSecond());
        assertEquals(operation, calculation.getBinaryOperation());
        ...
        if (operation == ADD || operation == MULTIPLY) {
            ...
            assertEquals(new BigDecimal(result), calculation.getResult());
            assertEquals(second, calculation.getFirst());
            assertEquals(first, calculation.getSecond());
            assertEquals(operation, calculation.getBinaryOperation());
        }
    }
}